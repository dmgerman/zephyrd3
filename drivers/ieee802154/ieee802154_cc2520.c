...
DECL|_cc2520_read_ram|function|static bool _cc2520_read_ram(struct cc2520_spi *spi, u16_t addr, u8_t *data_buf, u8_t len)
DECL|_cc2520_read_reg|function|u8_t _cc2520_read_reg(struct cc2520_spi *spi, bool freg, u8_t addr)
DECL|_cc2520_status|function|static u8_t _cc2520_status(struct cc2520_spi *spi)
DECL|_cc2520_write_ram|function|bool _cc2520_write_ram(struct cc2520_spi *spi, u16_t addr, u8_t *data_buf, u8_t len)
DECL|_cc2520_write_reg|function|bool _cc2520_write_reg(struct cc2520_spi *spi, bool freg, u8_t addr, u8_t value)
...
DECL|read_rxfifo_content|function|static inline bool read_rxfifo_content(struct cc2520_spi *spi, struct net_buf *frag, u8_t len)
DECL|read_rxfifo_length|function|static inline u8_t read_rxfifo_length(struct cc2520_spi *spi)
...
DECL|verify_crc|function|static inline bool verify_crc(struct cc2520_context *cc2520, struct net_pkt *pkt)
DECL|verify_osc_stabilization|function|static bool verify_osc_stabilization(struct cc2520_context *cc2520)
DECL|verify_rxfifo_validity|function|static inline bool verify_rxfifo_validity(struct cc2520_spi *spi, u8_t pkt_len)
...
DECL|write_txfifo_content|function|static inline bool write_txfifo_content(struct cc2520_spi *spi,u8_t *frame, u8_t len)
DECL|write_txfifo_length|function|static inline bool write_txfifo_length(struct cc2520_spi *spi, u8_t len)
