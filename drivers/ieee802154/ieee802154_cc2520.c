...
DECL|read_rxfifo_content|function|static inline bool read_rxfifo_content(struct cc2520_spi *spi, struct net_buf *frag, uint8_t len)
...
DECL|verify_txfifo_status|function|static inline bool verify_txfifo_status(struct cc2520_context *cc2520,uint8_t len)
DECL|write_txfifo_content|function|static inline bool write_txfifo_content(struct cc2520_spi *spi,uint8_t *frame, uint8_t len)
DECL|write_txfifo_length|function|static inline bool write_txfifo_length(struct cc2520_spi *spi, uint8_t len)
