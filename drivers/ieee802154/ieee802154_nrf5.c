...
DECL|nrf5_get_eui64|function|static void nrf5_get_eui64(uint8_t *mac)
DECL|nrf5_get_lqi|function|static uint8_t nrf5_get_lqi(struct device *dev)
...
DECL|nrf5_set_channel|function|static int nrf5_set_channel(struct device *dev, uint16_t channel)
DECL|nrf5_set_ieee_addr|function|static int nrf5_set_ieee_addr(struct device *dev, const uint8_t *ieee_addr)
DECL|nrf5_set_pan_id|function|static int nrf5_set_pan_id(struct device *dev, uint16_t pan_id)
DECL|nrf5_set_short_addr|function|static int nrf5_set_short_addr(struct device *dev, uint16_t short_addr)
