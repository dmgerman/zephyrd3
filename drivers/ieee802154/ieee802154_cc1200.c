...
DECL|_cc1200_access_reg|function|bool _cc1200_access_reg(struct spi_config *spi, bool read, u8_t addr,void *data, size_t length, bool extended, bool burst)
...
DECL|get_lo_divider|function|static u8_t get_lo_divider(struct spi_config *spi)
DECL|get_mac|function|static inline u8_t *get_mac(struct device *dev)
DECL|get_packet_length|function|static inline u8_t get_packet_length(struct spi_config *spi)
DECL|get_status|function|static u8_t get_status(struct spi_config *spi)
...
DECL|read_rxfifo_content|function|static inline bool read_rxfifo_content(struct spi_config *spi, struct net_buf *frag, u8_t len)
DECL|read_rxfifo|function|static inline bool read_rxfifo(struct spi_config *spi, void *data, size_t length)
DECL|rf_calibrate|function|static int rf_calibrate(struct spi_config *spi)
DECL|rf_evaluate_freq_setting|function|static u32_t rf_evaluate_freq_setting(struct cc1200_context *cc1200, u32_t chan)
...
DECL|verify_crc|function|static inline bool verify_crc(struct spi_config *spi, struct net_pkt *pkt)
DECL|verify_rxfifo_validity|function|static inline bool verify_rxfifo_validity(struct spi_config *spi, u8_t pkt_len)
DECL|write_reg_freq|function|static bool write_reg_freq(struct spi_config *spi, u32_t freq)
DECL|write_txfifo|function|static inline bool write_txfifo(struct spi_config *spi,void *data, size_t length)
