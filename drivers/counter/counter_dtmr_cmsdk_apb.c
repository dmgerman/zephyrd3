...
DECL|counter_dtmr_cmsdk_apb_read|function|static uint32_t counter_dtmr_cmsdk_apb_read(struct device *dev)
DECL|counter_dtmr_cmsdk_apb_set_alarm|function|static int counter_dtmr_cmsdk_apb_set_alarm(struct device *dev, counter_callback_t callback, uint32_t count, void *user_data)
