...
DECL|timer_dtmr_cmsdk_apb_get_pending_int|function|static u32_t timer_dtmr_cmsdk_apb_get_pending_int(struct device *dev)
...
DECL|timer_dtmr_cmsdk_apb_read|function|static u32_t timer_dtmr_cmsdk_apb_read(struct device *dev)
DECL|timer_dtmr_cmsdk_apb_set_alarm|function|static int timer_dtmr_cmsdk_apb_set_alarm(struct device *dev, counter_callback_t callback, u32_t count, void *user_data)
