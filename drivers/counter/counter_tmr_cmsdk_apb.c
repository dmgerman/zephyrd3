...
DECL|counter_tmr_cmsdk_apb_read|function|static u32_t counter_tmr_cmsdk_apb_read(struct device *dev)
DECL|counter_tmr_cmsdk_apb_set_alarm|function|static int counter_tmr_cmsdk_apb_set_alarm(struct device *dev, counter_callback_t callback, u32_t count, void *user_data)
