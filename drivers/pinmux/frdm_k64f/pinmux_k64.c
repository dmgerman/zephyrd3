...
DECL|_fsl_k64_get_pin|function|int _fsl_k64_get_pin(uint32_t pin_id, uint32_t *func)
DECL|_fsl_k64_get_port_addr|function|static int _fsl_k64_get_port_addr(uint8_t pin_id, mem_addr_t *port_addr_ptr)
DECL|_fsl_k64_set_pin|function|int _fsl_k64_set_pin(uint32_t pin_id, uint32_t func)
