...
DECL|stm32f10x_clock_control_get_subsys_rate|function|static int stm32f10x_clock_control_get_subsys_rate(struct device *clock, clock_control_subsys_t sub_system, u32_t *rate)
