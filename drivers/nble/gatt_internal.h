...
DECL|ble_gatt_attr_idx_entry|struct|struct ble_gatt_attr_idx_entry {
...
DECL|ble_gatt_register|struct|struct ble_gatt_register {
...
DECL|handle|member|uint16_t handle; /* handle from ble contr should be sufficient */
...
DECL|service_idx|member|uint8_t service_idx;
