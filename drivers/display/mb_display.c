...
DECL|cur_img|member|u8_t cur_img; /* Current image or character to show */
DECL|current_img|function|static const struct mb_image *current_img(struct mb_display *disp)
DECL|cur|member|u8_t cur; /* Currently rendered row */
DECL|dev|member|struct device *dev; /* GPIO device */
DECL|display|variable|display
DECL|duration|member|s32_t duration; /* Duration for each shown image */
DECL|expiry|member|s64_t expiry; /* When to stop showing current image */
...
DECL|img_count|member|u8_t img_count; /* Image count */
...
DECL|mb_display_image|function|void mb_display_image(struct mb_display *disp, u32_t mode, s32_t duration, const struct mb_image *img, u8_t img_count)
DECL|mb_display_init|function|static int mb_display_init(struct device *dev)
DECL|mb_display_print|function|void mb_display_print(struct mb_display *disp, u32_t mode, s32_t duration, const char *fmt, ...)
...
DECL|row|member|u32_t row[3]; /* Content (columns) for each row */
DECL|scroll_steps|function|static inline u8_t scroll_steps(struct mb_display *disp)
DECL|scroll|member|u8_t scroll:3, /* Scroll shift */
...
DECL|start_scroll|function|static void start_scroll(struct mb_display *disp, s32_t duration)
DECL|start_single|function|static void start_single(struct mb_display *disp, s32_t duration)
...
DECL|update_pins|function|static inline void update_pins(struct mb_display *disp, u32_t val)
DECL|update_scroll|function|static void update_scroll(struct mb_display *disp)
DECL|x_y|struct|struct x_y {
DECL|x|member|u8_t x:4,
DECL|y|member|y:4;
