...
DECL|__set_one_port|function|static int __set_one_port(qm_pwm_t id, uint32_t pwm, uint32_t on, uint32_t off)
...
DECL|pwm_qmsi_resume|function|static int pwm_qmsi_resume(struct device *dev)
