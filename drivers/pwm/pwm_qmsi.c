...
DECL|pwm_qmsi_resume|function|static int pwm_qmsi_resume(struct device *dev, int pm_policy)
...
DECL|pwm_qmsi_suspend|function|static int pwm_qmsi_suspend(struct device *dev, int pm_policy)
