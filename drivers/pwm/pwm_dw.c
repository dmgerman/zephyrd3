DECL|REG_COMP_VER|macro|REG_COMP_VER
DECL|REG_OFFSET_LOAD_CNT2|macro|REG_OFFSET_LOAD_CNT2
DECL|REG_OFFSET|macro|REG_OFFSET
DECL|REG_TMR_CTRL|macro|REG_TMR_CTRL
DECL|REG_TMR_LOAD_CNT2|macro|REG_TMR_LOAD_CNT2
DECL|REG_TMR_LOAD_CNT|macro|REG_TMR_LOAD_CNT
DECL|TIMER_INIT_CTRL|macro|TIMER_INIT_CTRL
DECL|__set_one_port|function|static int __set_one_port(struct device *dev, uint32_t pwm, uint32_t on, uint32_t off)
DECL|addr|member|uint32_t addr;
DECL|num_ports|member|uint32_t num_ports;
DECL|pwm_dw_cfg|variable|pwm_dw_cfg
DECL|pwm_dw_configure|function|static int pwm_dw_configure(struct device *dev, int access_op, uint32_t pwm, int flags)
