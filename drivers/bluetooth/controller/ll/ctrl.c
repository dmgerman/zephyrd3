...
DECL|event_conn_update_st_init|function|static inline void event_conn_update_st_init(struct connection *conn,uint16_t event_counter, struct pdu_data *pdu_ctrl_tx, uint32_t ticks_at_expire, struct work *work_sched_offset, work_fp fp_work_select_or_use)
