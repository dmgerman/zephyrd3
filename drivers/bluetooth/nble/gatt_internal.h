...
DECL|attr_base|member|struct bt_gatt_attr *attr_base;
DECL|attr_count|member|u8_t attr_count;
DECL|attr_count|member|u8_t attr_count;
DECL|attr_size|member|u8_t attr_size;
...
DECL|handle|member|u16_t handle;
DECL|handle|member|u16_t handle;
DECL|nble_att_func_t|typedef|typedef void (*nble_att_func_t)(struct bt_conn *conn, u8_t err,
...
DECL|nble_gatts_value_change_param|struct|struct nble_gatts_value_change_param {
...
DECL|offset|member|u16_t offset;
DECL|offset|member|u16_t offset;
DECL|params|member|struct nble_gatts_value_change_param params;
DECL|params|member|struct nble_gatts_value_change_param params;
DECL|perm|member|u16_t perm;
DECL|prop|member|u8_t prop;
...
DECL|with_resp|member|u8_t with_resp;
DECL|wr_params|member|struct nble_gattc_write_param wr_params;
DECL|wr_params|member|struct nble_gattc_write_param wr_params;
