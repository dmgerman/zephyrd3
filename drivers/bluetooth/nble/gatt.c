...
DECL|attr_read|function|static int attr_read(struct bt_gatt_attr *attr, u8_t *data, size_t len)
...
DECL|bt_gatt_uuid_memcpy|function|static u8_t bt_gatt_uuid_memcpy(u8_t *buf, const struct bt_uuid *uuid)
...
DECL|gatt_write_ccc_rsp|function|static void gatt_write_ccc_rsp(struct bt_conn *conn, u8_t err, struct bt_gatt_write_params *params)
...
DECL|on_nble_gattc_discover_rsp|function|void on_nble_gattc_discover_rsp(const struct nble_gattc_discover_rsp *rsp,const u8_t *data, u8_t data_len)
DECL|on_nble_gattc_read_multi_rsp|function|void on_nble_gattc_read_multi_rsp(const struct nble_gattc_read_rsp *rsp, u8_t *data, u8_t len)
DECL|on_nble_gattc_read_rsp|function|void on_nble_gattc_read_rsp(const struct nble_gattc_read_rsp *rsp, u8_t *data, u8_t len)
DECL|on_nble_gattc_value_evt|function|void on_nble_gattc_value_evt(const struct nble_gattc_value_evt *ev, u8_t *data, u8_t length)
...
DECL|on_nble_gatts_register_rsp|function|void on_nble_gatts_register_rsp(const struct nble_gatts_register_rsp *rsp, const struct nble_gatt_attr_handles *handles, u8_t len)
DECL|on_nble_gatts_write_evt|function|void on_nble_gatts_write_evt(const struct nble_gatts_write_evt *ev, const u8_t *buf, u8_t buflen)
...
DECL|parse_characteristic|function|static u16_t parse_characteristic(struct bt_conn *conn, struct bt_gatt_discover_params *params, const u8_t *data, u8_t len)
DECL|parse_descriptor|function|static u16_t parse_descriptor(struct bt_conn *conn, struct bt_gatt_discover_params *params, const u8_t *data, u8_t len)
DECL|parse_include|function|static u16_t parse_include(struct bt_conn *conn, struct bt_gatt_discover_params *params, const u8_t *data, u8_t len)
DECL|parse_service|function|static u16_t parse_service(struct bt_conn *conn, struct bt_gatt_discover_params *params, const u8_t *data, u8_t len)
DECL|prep_write_evt|function|static s32_t prep_write_evt(const struct nble_gatts_write_evt *ev, const u8_t *data, u8_t len)
...
DECL|write_evt|function|static s32_t write_evt(struct bt_conn *conn, const struct bt_gatt_attr *attr, u16_t offset, const u8_t *data, u8_t len)
