...
DECL|legacy_pairing_req|function|static u8_t legacy_pairing_req(struct bt_smp *smp, const struct nble_sec_param *par)
...
DECL|sm_error|function|static int sm_error(struct bt_conn *conn, u8_t reason)
