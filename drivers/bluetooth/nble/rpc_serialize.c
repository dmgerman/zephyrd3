...
DECL|rpc_serialize_s_b_p|function|void rpc_serialize_s_b_p(uint8_t fn_index, const void *struct_data, uint8_t struct_length, const void *vbuf, uint16_t vbuf_length, void *priv)
...
DECL|rpc_serialize_s_p|function|void rpc_serialize_s_p(uint8_t fn_index, const void *struct_data, uint8_t struct_length, void *priv)
DECL|rpc_serialize_s|function|void rpc_serialize_s(uint8_t fn_index, const void *struct_data, uint8_t struct_length)
DECL|serialize_buf|function|static void serialize_buf(struct net_buf *buf, const uint8_t *data, uint16_t len)
DECL|serialize_p|function|static void serialize_p(struct net_buf *buf, void *ptr)
DECL|serialize_struct|function|static void serialize_struct(struct net_buf *buf, const uint8_t *struct_data, uint8_t struct_length)
