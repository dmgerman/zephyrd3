...
DECL|bt_uart_acl_recv|function|static int bt_uart_acl_recv(struct bt_buf *buf)
DECL|bt_uart_evt_recv|function|static int bt_uart_evt_recv(struct bt_buf *buf)
