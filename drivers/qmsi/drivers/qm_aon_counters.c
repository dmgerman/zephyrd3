...
DECL|qm_aonpt_reset|function|int qm_aonpt_reset(const qm_scss_aon_t aonc)
DECL|qm_aonpt_set_config|function|int qm_aonpt_set_config(const qm_scss_aon_t aonc,const qm_aonpt_config_t *const cfg)
