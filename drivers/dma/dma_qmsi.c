...
DECL|dma_drv_callback|function|static void dma_drv_callback(void *callback_context, uint32_t len, int error_code)
DECL|dma_funcs|variable|dma_funcs
DECL|dma_qmsi_chan_config|function|static int dma_qmsi_chan_config(struct device *dev, uint32_t channel,struct dma_config *config)
...
DECL|dma_qmsi_start|function|static int dma_qmsi_start(struct device *dev, uint32_t channel)
DECL|dma_qmsi_stop|function|static int dma_qmsi_stop(struct device *dev, uint32_t channel)
...
DECL|width_index|function|static int width_index(uint32_t num_bytes, uint32_t *index)
