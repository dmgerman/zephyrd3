...
DECL|quark_se_ipm_max_id_val_get|function|static u32_t quark_se_ipm_max_id_val_get(struct device *d)
...
DECL|quark_se_ipm_send|function|static int quark_se_ipm_send(struct device *d, int wait, u32_t id,const void *data, int size)
DECL|quark_se_ipm_set_enabled|function|static int quark_se_ipm_set_enabled(struct device *d, int enable)
DECL|quark_se_ipm_sts_get|function|static u32_t quark_se_ipm_sts_get(void)
