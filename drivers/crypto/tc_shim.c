...
DECL|do_cbc_decrypt|function|static int do_cbc_decrypt(struct cipher_ctx *ctx, struct cipher_pkt *op, uint8_t *iv)
DECL|do_cbc_encrypt|function|static int do_cbc_encrypt(struct cipher_ctx *ctx, struct cipher_pkt *op, uint8_t *iv)
...
DECL|do_ctr_op|function|static int do_ctr_op(struct cipher_ctx *ctx, struct cipher_pkt *op, uint8_t *iv)
