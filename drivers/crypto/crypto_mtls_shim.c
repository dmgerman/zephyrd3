...
DECL|mtls_query_caps|function|int mtls_query_caps(struct device *dev)
DECL|mtls_session_free|function|int mtls_session_free(struct device *dev, struct cipher_ctx *ctx)
DECL|mtls_session_setup|function|int mtls_session_setup(struct device *dev, struct cipher_ctx *ctx, enum cipher_algo algo, enum cipher_mode mode, enum cipher_op op_type)
