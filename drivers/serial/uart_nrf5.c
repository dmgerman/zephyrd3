DECL|BAUDRATE|member|__IO u32_t BAUDRATE;
DECL|CONFIG|member|__IO u32_t CONFIG;
DECL|DEV_CFG|macro|DEV_CFG
DECL|DEV_DATA|macro|DEV_DATA
DECL|ENABLE|member|__IO u32_t ENABLE;
DECL|ERRORSRC|member|__IO u32_t ERRORSRC;
DECL|EVENTS_CTS|member|__IO u32_t EVENTS_CTS;
DECL|EVENTS_ERROR|member|__IO u32_t EVENTS_ERROR;
DECL|EVENTS_NCTS|member|__IO u32_t EVENTS_NCTS;
DECL|EVENTS_RXDRDY|member|__IO u32_t EVENTS_RXDRDY;
DECL|EVENTS_RXTO|member|__IO u32_t EVENTS_RXTO;
DECL|EVENTS_TXDRDY|member|__IO u32_t EVENTS_TXDRDY;
DECL|INTENCLR|member|__IO u32_t INTENCLR;
DECL|INTENSET|member|__IO u32_t INTENSET;
DECL|PSELCTS|macro|PSELCTS
DECL|PSELCTS|member|__IO u32_t PSELCTS;
DECL|PSELRTS|macro|PSELRTS
DECL|PSELRTS|member|__IO u32_t PSELRTS;
DECL|PSELRXD|macro|PSELRXD
DECL|PSELRXD|member|__IO u32_t PSELRXD;
DECL|PSELTXD|macro|PSELTXD
DECL|PSELTXD|member|__IO u32_t PSELTXD;
DECL|RESERVED0|member|__I u32_t RESERVED0[3];
DECL|RESERVED10|member|__I u32_t RESERVED10;
DECL|RESERVED11|member|__I u32_t RESERVED11[17];
DECL|RESERVED1|member|__I u32_t RESERVED1[56];
DECL|RESERVED2|member|__I u32_t RESERVED2[4];
DECL|RESERVED3|member|__I u32_t RESERVED3;
DECL|RESERVED4|member|__I u32_t RESERVED4[7];
DECL|RESERVED5|member|__I u32_t RESERVED5[46];
DECL|RESERVED6|member|__I u32_t RESERVED6[64];
DECL|RESERVED7|member|__I u32_t RESERVED7[93];
DECL|RESERVED8|member|__I u32_t RESERVED8[31];
DECL|RESERVED9|member|__I u32_t RESERVED9;
DECL|RXD|member|__I u32_t RXD;
DECL|SHORTS|member|__IO u32_t SHORTS;
DECL|TASKS_STARTRX|member|__O u32_t TASKS_STARTRX;
DECL|TASKS_STARTTX|member|__O u32_t TASKS_STARTTX;
DECL|TASKS_STOPRX|member|__O u32_t TASKS_STOPRX;
DECL|TASKS_STOPTX|member|__O u32_t TASKS_STOPTX;
DECL|TASKS_SUSPEND|member|__O u32_t TASKS_SUSPEND;
DECL|TXD|member|__O u32_t TXD;
...
DECL|baudrate_set|function|static int baudrate_set(struct device *dev, u32_t baudrate, u32_t sys_clk_freq_hz)
