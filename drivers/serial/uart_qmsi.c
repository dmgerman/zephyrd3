...
DECL|cfg_save|member|qm_uart_config_t cfg_save;
...
DECL|uart_qmsi_pm_save_config|function|void uart_qmsi_pm_save_config(struct device *dev, qm_uart_config_t *cfg)
DECL|uart_qmsi_pm_save_config|macro|uart_qmsi_pm_save_config
