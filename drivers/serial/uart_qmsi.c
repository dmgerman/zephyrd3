...
DECL|uart_qmsi_device_ctrl|function|static int uart_qmsi_device_ctrl(struct device *dev, uint32_t ctrl_command, void *context)
...
DECL|uart_qmsi_get_power_state|function|static uint32_t uart_qmsi_get_power_state(struct device *dev)
...
DECL|uart_qmsi_set_power_state|function|static void uart_qmsi_set_power_state(struct device *dev, uint32_t power_state)
