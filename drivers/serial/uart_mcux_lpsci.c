...
DECL|mcux_lpsci_irq_callback_set|function|static void mcux_lpsci_irq_callback_set(struct device *dev, uart_irq_callback_t cb)
...
DECL|mcux_lpsci_irq_tx_empty|function|static int mcux_lpsci_irq_tx_empty(struct device *dev)
