...
DECL|k20_uart_driver_api|variable|k20_uart_driver_api
DECL|k20_uart_fifo_fill|function|static int k20_uart_fifo_fill(struct device *dev, const uint8_t *tx_data, int len)
DECL|k20_uart_fifo_read|function|static int k20_uart_fifo_read(struct device *dev, uint8_t *rx_data, const int size)
...
DECL|k20_uart_poll_in|function|static int k20_uart_poll_in(struct device *dev, unsigned char *c)
DECL|k20_uart_poll_out|function|static unsigned char k20_uart_poll_out(struct device *dev, unsigned char c)
