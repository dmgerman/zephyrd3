...
DECL|uart_nrfx_irq_tx_complete|function|static int uart_nrfx_irq_tx_complete(struct device *dev)
...
DECL|uart_nrfx_irq_tx_ready|function|static int uart_nrfx_irq_tx_ready(struct device *dev)
