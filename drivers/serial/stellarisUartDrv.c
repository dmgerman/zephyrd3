...
DECL|uart_int_connect|function|void uart_int_connect(int port, /* UART port to connect to */ void (*isr)(void *), /* interrupt handler */ void *arg, /* argument to pass to handler */ void *stub /* ptr to interrupt stub code */ )
