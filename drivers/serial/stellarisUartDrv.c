...
DECL|stellaris_uart_irq_is_pending|function|static int stellaris_uart_irq_is_pending(struct device *dev)
DECL|stellaris_uart_irq_rx_disable|function|static void stellaris_uart_irq_rx_disable(struct device *dev)
DECL|stellaris_uart_irq_rx_enable|function|static void stellaris_uart_irq_rx_enable(struct device *dev)
DECL|stellaris_uart_irq_rx_ready|function|static int stellaris_uart_irq_rx_ready(struct device *dev)
DECL|stellaris_uart_irq_tx_disable|function|static void stellaris_uart_irq_tx_disable(struct device *dev)
