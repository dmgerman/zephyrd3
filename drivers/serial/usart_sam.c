...
DECL|irq_cb|member|uart_irq_callback_t irq_cb; /* Interrupt Callback */
...
DECL|usart_sam_irq_callback_set|function|static void usart_sam_irq_callback_set(struct device *dev, uart_irq_callback_t cb)
