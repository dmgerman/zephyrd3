...
DECL|i2c_stm32lx_runtime_configure|function|static int i2c_stm32lx_runtime_configure(struct device *dev, u32_t config)
DECL|i2c_stm32lx_transfer|function|static int i2c_stm32lx_transfer(struct device *dev,struct i2c_msg *msgs, u8_t num_msgs, u16_t slave_address)
...
DECL|transfer_setup|function|static inline void transfer_setup(struct device *dev, u16_t slave_address, unsigned int read_transfer)
