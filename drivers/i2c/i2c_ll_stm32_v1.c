...
DECL|stm32_i2c_msg_read|function|s32_t stm32_i2c_msg_read(struct device *dev, struct i2c_msg *msg, u8_t *next_msg_flags, u16_t saddr)
DECL|stm32_i2c_msg_read|function|s32_t stm32_i2c_msg_read(struct device *dev, struct i2c_msg *msg, u8_t *next_msg_flags, u16_t saddr)
DECL|stm32_i2c_msg_write|function|s32_t stm32_i2c_msg_write(struct device *dev, struct i2c_msg *msg, u8_t *next_msg_flags, u16_t saddr)
DECL|stm32_i2c_msg_write|function|s32_t stm32_i2c_msg_write(struct device *dev, struct i2c_msg *msg, u8_t *next_msg_flags, u16_t saddr)
