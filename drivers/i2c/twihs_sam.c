...
DECL|clk_div_calc|function|static uint32_t clk_div_calc(uint32_t speed)
...
DECL|read_msg_start|function|static void read_msg_start(Twihs *const twihs, struct twihs_msg *msg, uint8_t daddr)
DECL|regs|member|Twihs *regs;
DECL|sem|member|struct k_sem sem;
DECL|twihs_msg|struct|struct twihs_msg {
DECL|twihs_sam_configure|function|static int twihs_sam_configure(struct device *dev, uint32_t config)
...
DECL|twihs_sam_transfer|function|static int twihs_sam_transfer(struct device *dev, struct i2c_msg *msgs, uint8_t num_msgs, uint16_t addr)
DECL|twihs_sr|member|uint32_t twihs_sr;
DECL|write_msg_start|function|static void write_msg_start(Twihs *const twihs, struct twihs_msg *msg, uint8_t daddr)
