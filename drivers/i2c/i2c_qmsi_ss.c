...
DECL|ss_i2c_device_ctrl|function|static int ss_i2c_device_ctrl(struct device *dev, uint32_t ctrl_command, void *context)
DECL|ss_i2c_qmsi_get_power_state|function|static uint32_t ss_i2c_qmsi_get_power_state(struct device *dev)
DECL|ss_i2c_qmsi_set_power_state|function|static void ss_i2c_qmsi_set_power_state(struct device *dev,uint32_t power_state)
