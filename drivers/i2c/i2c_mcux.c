...
DECL|i2c_mcux_configure|function|static int i2c_mcux_configure(struct device *dev, uint32_t dev_config_raw)
DECL|i2c_mcux_config|struct|struct i2c_mcux_config {
DECL|i2c_mcux_convert_flags|function|static uint32_t i2c_mcux_convert_flags(int msg_flags)
...
DECL|i2c_mcux_transfer|function|static int i2c_mcux_transfer(struct device *dev, struct i2c_msg *msgs,uint8_t num_msgs, uint16_t addr)
