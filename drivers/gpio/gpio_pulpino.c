...
DECL|gpio_pulpino_config|function|static int gpio_pulpino_config(struct device *dev, int access_op, uint32_t pin, int flags)
...
DECL|gpio_pulpino_disable_callback|function|static int gpio_pulpino_disable_callback(struct device *dev, int access_op, uint32_t pin)
DECL|gpio_pulpino_driver|variable|gpio_pulpino_driver
DECL|gpio_pulpino_enable_callback|function|static int gpio_pulpino_enable_callback(struct device *dev,int access_op, uint32_t pin)
...
DECL|gpio_pulpino_read|function|static int gpio_pulpino_read(struct device *dev, int access_op, uint32_t pin, uint32_t *value)
DECL|gpio_pulpino_t|struct|struct gpio_pulpino_t {
DECL|gpio_pulpino_write|function|static int gpio_pulpino_write(struct device *dev, int access_op, uint32_t pin, uint32_t value)
DECL|inten|member|uint32_t inten;
DECL|intstatus|member|uint32_t intstatus;
DECL|inttype0|member|uint32_t inttype0;
DECL|inttype1|member|uint32_t inttype1;
DECL|paddir|member|uint32_t paddir;
DECL|padin|member|uint32_t padin;
DECL|padout|member|uint32_t padout;
