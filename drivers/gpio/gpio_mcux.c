...
DECL|gpio_mcux_disable_callback|function|static int gpio_mcux_disable_callback(struct device *dev, int access_op, uint32_t pin)
DECL|gpio_mcux_driver_api|variable|gpio_mcux_driver_api
DECL|gpio_mcux_enable_callback|function|static int gpio_mcux_enable_callback(struct device *dev, int access_op, uint32_t pin)
...
DECL|gpio_mcux_read|function|static int gpio_mcux_read(struct device *dev, int access_op, uint32_t pin, uint32_t *value)
DECL|gpio_mcux_write|function|static int gpio_mcux_write(struct device *dev, int access_op, uint32_t pin, uint32_t value)
