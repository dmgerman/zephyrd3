DECL|cmsdk_ahb_gpio_config|function|static void cmsdk_ahb_gpio_config(struct device *dev, u32_t mask, int flags)
...
DECL|gpio_cmsdk_ahb_config|function|static int gpio_cmsdk_ahb_config(struct device *dev, int access_op, u32_t pin, int flags)
DECL|gpio_cmsdk_ahb_dev_data|struct|struct gpio_cmsdk_ahb_dev_data {
DECL|gpio_cmsdk_ahb_disable_callback|function|static int gpio_cmsdk_ahb_disable_callback(struct device *dev, int access_op, u32_t pin)
DECL|gpio_cmsdk_ahb_drv_api_funcs|variable|gpio_cmsdk_ahb_drv_api_funcs
DECL|gpio_cmsdk_ahb_enable_callback|function|static int gpio_cmsdk_ahb_enable_callback(struct device *dev, int access_op, u32_t pin)
...
DECL|gpio_cmsdk_ahb_read|function|static int gpio_cmsdk_ahb_read(struct device *dev, int access_op, u32_t pin, u32_t *value)
DECL|gpio_cmsdk_ahb_write|function|static int gpio_cmsdk_ahb_write(struct device *dev, int access_op,u32_t pin, u32_t value)
