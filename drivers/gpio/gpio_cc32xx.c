...
DECL|gpio_cc32xx_config|function|static inline int gpio_cc32xx_config(struct device *port, int access_op, u32_t pin, int flags)
DECL|gpio_cc32xx_config|struct|struct gpio_cc32xx_config {
DECL|gpio_cc32xx_data|struct|struct gpio_cc32xx_data {
DECL|gpio_cc32xx_disable_callback|function|static int gpio_cc32xx_disable_callback(struct device *dev, int access_op, u32_t pin)
DECL|gpio_cc32xx_enable_callback|function|static int gpio_cc32xx_enable_callback(struct device *dev, int access_op, u32_t pin)
...
DECL|gpio_cc32xx_read|function|static inline int gpio_cc32xx_read(struct device *port, int access_op, u32_t pin, u32_t *value)
DECL|gpio_cc32xx_write|function|static inline int gpio_cc32xx_write(struct device *port, int access_op, u32_t pin, u32_t value)
