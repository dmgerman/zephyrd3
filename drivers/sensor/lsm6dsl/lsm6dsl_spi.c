...
DECL|lsm6dsl_raw_read|function|static int lsm6dsl_raw_read(struct spi_config *spi_cfg, u8_t reg_addr, u8_t *value, u8_t len)
DECL|lsm6dsl_raw_write|function|static int lsm6dsl_raw_write(struct spi_config *spi_cfg, u8_t reg_addr, u8_t *value, u8_t len)
