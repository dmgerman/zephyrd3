...
DECL|mpu6050_convert_accel|function|static void mpu6050_convert_accel(struct sensor_value *val, s16_t raw_val, u16_t sensitivity_shift)
DECL|mpu6050_convert_gyro|function|static void mpu6050_convert_gyro(struct sensor_value *val, s16_t raw_val, u16_t sensitivity_x10)
DECL|mpu6050_convert_temp|function|static inline void mpu6050_convert_temp(struct sensor_value *val,s16_t raw_val)
