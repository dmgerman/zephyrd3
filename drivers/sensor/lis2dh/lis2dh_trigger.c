...
DECL|lis2dh_start_trigger_int1|function|static int lis2dh_start_trigger_int1(const struct lis2dh_data *lis2dh)
DECL|lis2dh_start_trigger_int2|function|static int lis2dh_start_trigger_int2(const struct lis2dh_data *lis2dh)
