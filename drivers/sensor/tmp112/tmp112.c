...
DECL|tmp112_reg_read|function|static int tmp112_reg_read(struct tmp112_data *drv_data, u8_t reg, u16_t *val)
DECL|tmp112_reg_update|function|static int tmp112_reg_update(struct tmp112_data *drv_data, u8_t reg, u16_t mask, u16_t val)
DECL|tmp112_reg_write|function|static int tmp112_reg_write(struct tmp112_data *drv_data, u8_t reg, u16_t val)
