...
DECL|apds9960_device_ctrl|function|static int apds9960_device_ctrl(struct device *dev, u32_t ctrl_command,void *context)
DECL|apds9960_driver_api|variable|apds9960_driver_api
DECL|apds9960_gpio_callback|function|static void apds9960_gpio_callback(struct device *dev, struct gpio_callback *cb, u32_t pins)
DECL|apds9960_init_interrupt|function|static int apds9960_init_interrupt(struct device *dev)
...
DECL|apds9960_sensor_setup|function|static int apds9960_sensor_setup(struct device *dev)
