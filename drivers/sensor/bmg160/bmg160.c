...
DECL|bmg160_is_val_valid|function|static int bmg160_is_val_valid(s16_t val, const s16_t *val_map, u16_t map_size)
DECL|bmg160_read_byte|function|int bmg160_read_byte(struct device *dev, u8_t reg_addr, u8_t *byte)
DECL|bmg160_read|function|int bmg160_read(struct device *dev, u8_t reg_addr, u8_t *data,u8_t len)
...
DECL|bmg160_to_fixed_point|function|static void bmg160_to_fixed_point(struct bmg160_device_data *bmg160, enum sensor_channel chan, s16_t raw, struct sensor_value *val)
DECL|bmg160_update_byte|function|int bmg160_update_byte(struct device *dev, u8_t reg_addr, u8_t mask, u8_t value)
DECL|bmg160_write_byte|function|int bmg160_write_byte(struct device *dev, u8_t reg_addr, u8_t byte)
DECL|bmg160_write|function|static int bmg160_write(struct device *dev, u8_t reg_addr, u8_t *data,u8_t len)
