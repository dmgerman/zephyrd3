...
DECL|isl29035_gpio_callback|function|static void isl29035_gpio_callback(struct device *dev, struct gpio_callback *cb, u32_t pins)
DECL|isl29035_init_interrupt|function|int isl29035_init_interrupt(struct device *dev)
DECL|isl29035_lux_processed_to_raw|function|static u16_t isl29035_lux_processed_to_raw(struct sensor_value const *val)
DECL|isl29035_thread_cb|function|static void isl29035_thread_cb(struct device *dev)
DECL|isl29035_thread|function|static void isl29035_thread(int ptr, int unused)
