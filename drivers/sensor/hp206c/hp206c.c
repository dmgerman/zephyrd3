...
DECL|hp206c_altitude_offs_set|function|static int hp206c_altitude_offs_set(struct device *dev, s16_t offs)
...
DECL|hp206c_buf_convert|function|static s32_t hp206c_buf_convert(u8_t *buf, bool signed_val)
...
DECL|hp206c_cmd_send|function|static int hp206c_cmd_send(struct device *dev, u8_t cmd)
DECL|hp206c_data|variable|hp206c_data
DECL|hp206c_init|function|static int hp206c_init(struct device *dev)
DECL|hp206c_osr_set|function|static int hp206c_osr_set(struct device *dev, u16_t osr)
DECL|hp206c_pressure_get|function|static inline int hp206c_pressure_get(struct device *dev, struct sensor_value *val)
DECL|hp206c_read_reg|function|static int hp206c_read_reg(struct device *dev, u8_t reg_addr, u8_t *reg_val)
DECL|hp206c_read|function|static int hp206c_read(struct device *dev, u8_t cmd, u8_t *data, u8_t len)
DECL|hp206c_temperature_get|function|static inline int hp206c_temperature_get(struct device *dev, struct sensor_value *val)
DECL|hp206c_val_get|function|static int hp206c_val_get(struct device *dev, u8_t cmd, struct sensor_value *val)
DECL|hp206c_wait_dev_ready|function|static int hp206c_wait_dev_ready(struct device *dev, u32_t timeout_ms)
DECL|hp206c_write_reg|function|static int hp206c_write_reg(struct device *dev, u8_t reg_addr, u8_t reg_val)
DECL|hp206c_write|function|static int hp206c_write(struct device *dev, u8_t cmd, u8_t *data,u8_t len)
