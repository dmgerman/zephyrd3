...
DECL|pulse_cfg|member|u8_t pulse_cfg;
DECL|pulse_ltcy|member|u8_t pulse_ltcy;
DECL|pulse_ths|member|u8_t pulse_ths[3];
DECL|pulse_tmlt|member|u8_t pulse_tmlt;
DECL|pulse_wind|member|u8_t pulse_wind;
DECL|range|member|enum fxos8700_range range;
DECL|raw|member|s16_t raw[FXOS8700_MAX_NUM_CHANNELS];
DECL|sem|member|struct k_sem sem;
DECL|start_addr|member|u8_t start_addr;
