...
DECL|adxl362_get_reg|function|static int adxl362_get_reg(struct device *dev, u8_t *read_buf, u8_t register_address, u8_t count)
...
DECL|adxl362_set_reg|function|static int adxl362_set_reg(struct device *dev, u16_t register_value, u8_t register_address, u8_t count)
