...
DECL|lis3dh_convert|function|static void lis3dh_convert(struct sensor_value *val, s64_t raw_val)
...
DECL|lis3dh_sample_fetch|function|int lis3dh_sample_fetch(struct device *dev, enum sensor_channel chan)
