...
DECL|eth_enc28j60_iface_init_0|function|static void eth_enc28j60_iface_init_0(struct net_if *iface)
...
DECL|eth_enc28j60_read_mem|function|static void eth_enc28j60_read_mem(struct device *dev, uint8_t *data_buffer, uint16_t buf_len)
...
DECL|eth_enc28j60_tx|function|static int eth_enc28j60_tx(struct device *dev, struct net_buf *buf, uint16_t len)
DECL|eth_enc28j60_write_mem|function|static void eth_enc28j60_write_mem(struct device *dev, uint8_t *data_buffer, uint16_t buf_len)
...
DECL|eth_net_tx|function|static int eth_net_tx(struct net_if *iface, struct net_buf *buf)
