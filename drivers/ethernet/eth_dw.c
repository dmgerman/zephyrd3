...
DECL|eth_read|function|static inline uint32_t eth_read(uint32_t base_addr, uint32_t offset)
...
DECL|eth_write|function|static inline void eth_write(uint32_t base_addr, uint32_t offset, uint32_t val)
