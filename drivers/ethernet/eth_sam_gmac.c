...
DECL|eth_sam_gmac_get_bandwidth|function|static u32_t eth_sam_gmac_get_bandwidth(Gmac *gmac)
...
DECL|eth_sam_gmac_get_qav_delta_bandwidth|function|static int eth_sam_gmac_get_qav_delta_bandwidth(Gmac *gmac, int queue_id,unsigned int *delta_bandwidth)
DECL|eth_sam_gmac_get_qav_idle_slope|function|static int eth_sam_gmac_get_qav_idle_slope(Gmac *gmac, int queue_id, unsigned int *idle_slope)
DECL|eth_sam_gmac_get_qav_param|function|static int eth_sam_gmac_get_qav_param(struct device *dev, enum ethernet_config_type type, struct ethernet_config *config)
DECL|eth_sam_gmac_get_qav_status|function|static int eth_sam_gmac_get_qav_status(Gmac *gmac, int queue_id, bool *enabled)
DECL|eth_sam_gmac_set_config|function|static int eth_sam_gmac_set_config(struct device *dev, enum ethernet_config_type type, const struct ethernet_config *config)
DECL|eth_sam_gmac_set_qav_param|function|static int eth_sam_gmac_set_qav_param(struct device *dev, enum ethernet_config_type type, const struct ethernet_config *config)
DECL|eth_sam_gmac_setup_qav_delta_bandwidth|function|static int eth_sam_gmac_setup_qav_delta_bandwidth(Gmac *gmac, int queue_id, int queue_share)
DECL|eth_sam_gmac_setup_qav_idle_slope|function|static int eth_sam_gmac_setup_qav_idle_slope(Gmac *gmac, int queue_id, unsigned int idle_slope)
DECL|eth_sam_gmac_setup_qav|function|static int eth_sam_gmac_setup_qav(Gmac *gmac, int queue_id, bool enable)
...
DECL|generate_mac|function|static void generate_mac(u8_t mac_addr[6])
DECL|generate_random_mac|function|static void generate_random_mac(u8_t mac_addr[6])
...
DECL|get_mac_addr_from_i2c_eeprom|function|static void get_mac_addr_from_i2c_eeprom(u8_t mac_addr[6])
