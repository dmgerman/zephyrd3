...
DECL|eth_start_device|function|static int eth_start_device(struct device *dev)
DECL|eth_stop_device|function|static int eth_stop_device(struct device *dev)
