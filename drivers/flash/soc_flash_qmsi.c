...
DECL|flash_qmsi_device_ctrl|function|static int flash_qmsi_device_ctrl(struct device *dev, u32_t ctrl_command, void *context)
DECL|flash_qmsi_erase|function|static int flash_qmsi_erase(struct device *dev, off_t addr, size_t size)
DECL|flash_qmsi_get_power_state|function|static u32_t flash_qmsi_get_power_state(struct device *dev)
...
DECL|flash_qmsi_set_power_state|function|static void flash_qmsi_set_power_state(struct device *dev, u32_t power_state)
...
DECL|flash_region|function|static qm_flash_region_t flash_region(u32_t addr)
DECL|get_page_num|function|static u32_t get_page_num(u32_t addr)
