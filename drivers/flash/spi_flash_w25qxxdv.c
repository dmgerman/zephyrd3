...
DECL|spi_flash_wb_read|function|static int spi_flash_wb_read(struct device *dev, size_t offset, void *data, size_t len)
...
DECL|spi_flash_wb_write|function|static int spi_flash_wb_write(struct device *dev, size_t offset, const void *data, size_t len)
