...
DECL|spi_flash_wb_erase_internal|function|static inline int spi_flash_wb_erase_internal(struct device *dev, uint32_t offset, uint32_t size)
DECL|spi_flash_wb_erase|function|static int spi_flash_wb_erase(struct device *dev, uint32_t offset, uint32_t size)
DECL|spi_flash_wb_id|function|static inline int spi_flash_wb_id(struct device *dev)
DECL|spi_flash_wb_read|function|static int spi_flash_wb_read(struct device *dev, uint32_t offset, unsigned int len, uint8_t *data)
...
DECL|spi_flash_wb_write|function|static int spi_flash_wb_write(struct device *dev, uint32_t offset, unsigned int len, uint8_t *data)
