...
DECL|aio_cmp_qmsi_get_pending_int|function|static u32_t aio_cmp_qmsi_get_pending_int(struct device *dev)
DECL|aio_qmsi_cmp_cb|struct|struct aio_qmsi_cmp_cb {
DECL|aio_qmsi_cmp_configure|function|static int aio_qmsi_cmp_configure(struct device *dev, u8_t index, enum aio_cmp_polarity polarity, enum aio_cmp_ref refsel, aio_cmp_cb cb, void *param)
...
DECL|aio_qmsi_cmp_disable|function|static int aio_qmsi_cmp_disable(struct device *dev, u8_t index)
...
DECL|num_cmp|member|u8_t num_cmp;
