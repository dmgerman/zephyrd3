...
DECL|spi_sam0_configure|function|static int spi_sam0_configure(const struct spi_config *config)
...
DECL|spi_sam0_fast_transceive|function|static void spi_sam0_fast_transceive(const struct spi_config *config, const struct spi_buf *tx_bufs, size_t tx_count, struct spi_buf *rx_bufs, size_t rx_count)
...
DECL|spi_sam0_release|function|static int spi_sam0_release(const struct spi_config *config)
DECL|spi_sam0_shift_master|function|static void spi_sam0_shift_master(SercomSpi *regs, struct spi_sam0_data *data)
DECL|spi_sam0_transceive_async|function|static int spi_sam0_transceive_async(const struct spi_config *config, const struct spi_buf *tx_bufs, size_t tx_count, struct spi_buf *rx_bufs, size_t rx_count, struct k_poll_signal *async)
DECL|spi_sam0_transceive|function|static int spi_sam0_transceive(const struct spi_config *config, const struct spi_buf *tx_bufs, size_t tx_count, struct spi_buf *rx_bufs, size_t rx_count)
