...
DECL|spi_sam0_transceive_async|function|static int spi_sam0_transceive_async(struct spi_config *config, const struct spi_buf *tx_bufs, size_t tx_count, struct spi_buf *rx_bufs, size_t rx_count, struct k_poll_signal *async)
