DECL|CHIP_SELECT_COUNT|macro|CHIP_SELECT_COUNT
DECL|MAX_DATA_WIDTH|macro|MAX_DATA_WIDTH
DECL|SYS_LOG_LEVEL|macro|SYS_LOG_LEVEL
DECL|base|member|LPSPI_Type *base;
...
DECL|handle|member|lpspi_master_handle_t handle;
...
DECL|spi_mcux_config_3|variable|spi_mcux_config_3
...
DECL|spi_mcux_config_func_3|function|static void spi_mcux_config_func_3(struct device *dev)
...
DECL|spi_mcux_data_3|variable|spi_mcux_data_3
...
DECL|spi_mcux_master_transfer_callback|function|static void spi_mcux_master_transfer_callback(LPSPI_Type *base,lpspi_master_handle_t *handle, status_t status, void *userData)
