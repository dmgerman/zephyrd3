...
DECL|spi_stm32_configure|function|static int spi_stm32_configure(const struct spi_config *config)
...
DECL|spi_stm32_release|function|static int spi_stm32_release(const struct spi_config *config)
...
DECL|spi_stm32_transceive_async|function|static int spi_stm32_transceive_async(const struct spi_config *config, const struct spi_buf *tx_bufs, size_t tx_count, struct spi_buf *rx_bufs, size_t rx_count,
DECL|spi_stm32_transceive|function|static int spi_stm32_transceive(const struct spi_config *config,const struct spi_buf *tx_bufs, u32_t tx_count, struct spi_buf *rx_bufs, u32_t rx_count)
DECL|spi_stm32_transfer_ongoing|function|static bool spi_stm32_transfer_ongoing(struct spi_stm32_data *data)
DECL|transceive|function|static int transceive(const struct spi_config *config, const struct spi_buf *tx_bufs, u32_t tx_count, struct spi_buf *rx_bufs, u32_t rx_count, bool asynchronous, struct k_poll_signal *signal)
