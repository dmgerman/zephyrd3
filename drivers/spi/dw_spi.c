...
DECL|spi_dw_suspend|function|static int spi_dw_suspend(struct device *dev)
DECL|spi_dw_transceive|function|static int spi_dw_transceive(struct device *dev, uint8_t *tx_buf, uint32_t tx_buf_len, uint8_t *rx_buf, uint32_t rx_buf_len)
