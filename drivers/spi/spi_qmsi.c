...
DECL|config_to_bmode|function|static inline qm_spi_bmode_t config_to_bmode(u8_t mode)
...
DECL|frame_size_to_dfs|function|static inline u8_t frame_size_to_dfs(qm_spi_frame_size_t frame_size)
...
DECL|spi_master_get_power_state|function|static u32_t spi_master_get_power_state(struct device *dev)
DECL|spi_master_qmsi_device_ctrl|function|static int spi_master_qmsi_device_ctrl(struct device *port, u32_t ctrl_command, void *context)
DECL|spi_master_resume_device_from_suspend|function|static int spi_master_resume_device_from_suspend(struct device *dev)
DECL|spi_master_set_power_state|function|static void spi_master_set_power_state(struct device *dev, u32_t power_state)
...
DECL|spi_qmsi_slave_select|function|static int spi_qmsi_slave_select(struct device *dev, u32_t slave)
DECL|spi_qmsi_transceive|function|static int spi_qmsi_transceive(struct device *dev, const void *tx_buf, u32_t tx_buf_len, void *rx_buf, u32_t rx_buf_len)
DECL|spi|member|qm_spi_t spi;
DECL|transfer_complete|function|static void transfer_complete(void *data, int error, qm_spi_status_t status, u16_t len)
