...
DECL|usb_dc_ep_read_continue|function|int usb_dc_ep_read_continue(uint8_t ep)
DECL|usb_dc_ep_read_wait|function|int usb_dc_ep_read_wait(uint8_t ep, uint8_t *data, uint32_t max_data_len,uint32_t *read_bytes)
