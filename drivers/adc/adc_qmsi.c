...
DECL|adc_context|variable|adc_context
...
DECL|adc_qmsi_disable|function|static void adc_qmsi_disable(struct device *dev)
DECL|adc_qmsi_enable|function|static void adc_qmsi_enable(struct device *dev)
DECL|adc_qmsi_enable|function|static void adc_qmsi_enable(struct device *dev)
DECL|adc_qmsi_init|function|static int adc_qmsi_init(struct device *dev)
