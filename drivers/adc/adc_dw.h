...
DECL|IO_ADC0_INT_ERR|macro|IO_ADC0_INT_ERR
DECL|IO_ADC0_INT_IRQ|macro|IO_ADC0_INT_IRQ
...
DECL|fifo_tld|member|uint16_t fifo_tld;
...
DECL|rx_buf|member|uint32_t *rx_buf[BUFS_NUM];
DECL|rx_len|member|uint32_t rx_len[BUFS_NUM];
...
DECL|seq_size|member|uint32_t seq_size;
