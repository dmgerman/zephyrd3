...
DECL|adc_qmsi_ss_device_ctrl|function|static int adc_qmsi_ss_device_ctrl(struct device *dev, u32_t ctrl_command, void *context)
...
DECL|adc_qmsi_ss_enable|function|static void adc_qmsi_ss_enable(struct device *dev)
DECL|adc_qmsi_ss_err_isr|function|static void adc_qmsi_ss_err_isr(void *arg)
DECL|adc_qmsi_ss_get_power_state|function|static u32_t adc_qmsi_ss_get_power_state(struct device *dev)
DECL|adc_qmsi_ss_init|function|static int adc_qmsi_ss_init(struct device *dev)
...
DECL|adc_qmsi_ss_rx_isr|function|static void adc_qmsi_ss_rx_isr(void *arg)
DECL|adc_qmsi_ss_set_power_state|function|static void adc_qmsi_ss_set_power_state(struct device *dev,u32_t power_state)
