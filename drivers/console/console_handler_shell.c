...
DECL|shell_init|function|void shell_init(const char *str, const struct shell_cmd *cmds)
...
DECL|show_cmd_help|function|static int show_cmd_help(int argc, char *argv[])
