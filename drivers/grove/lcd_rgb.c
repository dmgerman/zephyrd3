...
DECL|_rgb_reg_set|function|static void _rgb_reg_set(struct device * const i2c, u8_t addr, u8_t dta)
DECL|_sleep|function|static inline void _sleep(u32_t sleep_in_ms)
...
DECL|display_switch|member|u8_t display_switch;
DECL|function|member|u8_t function;
DECL|glcd_clear|function|void glcd_clear(struct device *port)
DECL|glcd_color_select|function|void glcd_color_select(struct device *port, u8_t color)
DECL|glcd_color_set|function|void glcd_color_set(struct device *port, u8_t r, u8_t g, u8_t b)
DECL|glcd_cursor_pos_set|function|void glcd_cursor_pos_set(struct device *port, u8_t col, u8_t row)
DECL|glcd_data|struct|struct glcd_data {
DECL|glcd_display_state_get|function|u8_t glcd_display_state_get(struct device *port)
DECL|glcd_display_state_set|function|void glcd_display_state_set(struct device *port, u8_t opt)
DECL|glcd_driver|struct|struct glcd_driver {
DECL|glcd_function_get|function|u8_t glcd_function_get(struct device *port)
DECL|glcd_function_set|function|void glcd_function_set(struct device *port, u8_t opt)
DECL|glcd_initialize|function|int glcd_initialize(struct device *port)
DECL|glcd_input_state_get|function|u8_t glcd_input_state_get(struct device *port)
DECL|glcd_input_state_set|function|void glcd_input_state_set(struct device *port, u8_t opt)
DECL|glcd_print|function|void glcd_print(struct device *port, char *data, u32_t size)
...
DECL|input_set|member|u8_t input_set;
DECL|lcd_addr|member|u16_t lcd_addr;
DECL|rgb_addr|member|u16_t rgb_addr;
