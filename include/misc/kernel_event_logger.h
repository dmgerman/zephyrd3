...
DECL|KERNEL_EVENT_LOGGER_TASK_MON_CMD_PACKET_EVENT_ID|macro|KERNEL_EVENT_LOGGER_TASK_MON_CMD_PACKET_EVENT_ID
DECL|KERNEL_EVENT_LOGGER_TASK_MON_KEVENT_EVENT_ID|macro|KERNEL_EVENT_LOGGER_TASK_MON_KEVENT_EVENT_ID
DECL|KERNEL_EVENT_LOGGER_TASK_MON_TASK_STATE_CHANGE_EVENT_ID|macro|KERNEL_EVENT_LOGGER_TASK_MON_TASK_STATE_CHANGE_EVENT_ID
...
DECL|sys_k_timer_func|typedef|typedef uint32_t (*sys_k_timer_func)(void);
