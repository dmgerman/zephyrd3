...
DECL|sys_dlist_has_multiple_nodes|function|static inline bool sys_dlist_has_multiple_nodes(sys_dlist_t *list)
...
DECL|sys_dlist_is_empty|function|static inline bool sys_dlist_is_empty(sys_dlist_t *list)
DECL|sys_dlist_is_head|function|static inline bool sys_dlist_is_head(sys_dlist_t *list, sys_dnode_t *node)
DECL|sys_dlist_is_tail|function|static inline bool sys_dlist_is_tail(sys_dlist_t *list, sys_dnode_t *node)
