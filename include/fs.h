DECL|DIR_ENTRY_DIR|enumerator|DIR_ENTRY_DIR
DECL|DIR_ENTRY_FILE|enumerator|DIR_ENTRY_FILE,
DECL|SEEK_CUR|macro|SEEK_CUR
DECL|SEEK_END|macro|SEEK_END
DECL|SEEK_SET|macro|SEEK_SET
DECL|ZDIR|typedef|typedef struct _zdir_object ZDIR;
...
DECL|zfs_statvfs|struct|struct zfs_statvfs {
