...
DECL|GPIO_OPEN_DRAIN|macro|GPIO_OPEN_DRAIN
...
DECL|GPIO_PP_OD_MASK|macro|GPIO_PP_OD_MASK
DECL|GPIO_PP_OD_POS|macro|GPIO_PP_OD_POS
...
DECL|GPIO_PUSH_PULL|macro|GPIO_PUSH_PULL
...
DECL|gpio_api_get_pending_int|typedef|typedef uint32_t (*gpio_api_get_pending_int)(struct device *dev);
