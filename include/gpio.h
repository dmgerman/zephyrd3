...
DECL|gpio_resume|function|static inline int gpio_resume(struct device *port)
...
DECL|gpio_suspend|function|static inline int gpio_suspend(struct device *port)
