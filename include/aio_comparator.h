...
DECL|aio_cmp_api_get_pending_int|typedef|typedef uint32_t (*aio_cmp_api_get_pending_int)(struct device *dev);
...
DECL|aio_cmp_get_pending_int|function|static inline int aio_cmp_get_pending_int(struct device *dev)
