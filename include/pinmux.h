...
DECL|pinmux_pin_get|function|static inline uint32_t pinmux_pin_get(struct device *dev, uint32_t pin, uint32_t *func)
...
DECL|pinmux_pin_set|function|static inline uint32_t pinmux_pin_set(struct device *dev, uint32_t pin, uint32_t func)
DECL|pmux_get|typedef|typedef uint32_t (*pmux_get)(struct device *dev, uint32_t pin, uint32_t *func);
...
DECL|pmux_set|typedef|typedef uint32_t (*pmux_set)(struct device *dev, uint32_t pin, uint32_t func);
