...
DECL|cb_receive|member|spi_callback cb_receive;
DECL|cb_transmit|member|spi_callback cb_transmit;
...
DECL|read|member|spi_api_io read;
...
DECL|spi_api_io|typedef|typedef int (*spi_api_io)(struct device *dev, uint8_t *buf, uint32_t len);
...
DECL|write|member|spi_api_io write;
