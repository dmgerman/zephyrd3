...
DECL|pwm_all_period|function|static inline int __deprecated pwm_all_period(struct device *dev, u32_t period)
DECL|pwm_all_set_duty_cycle|function|static inline int __deprecated pwm_all_set_duty_cycle(struct device *dev, u8_t duty)
DECL|pwm_all_set_phase|function|static inline int __deprecated pwm_all_set_phase(struct device *dev, u8_t phase)
DECL|pwm_all_set_values|function|static inline int __deprecated pwm_all_set_values(struct device *dev, u32_t on, u32_t off)
...
DECL|pwm_get_cycles_per_sec|function|static inline int pwm_get_cycles_per_sec(struct device *dev, u32_t pwm, u64_t *cycles)
DECL|pwm_pin_configure|function|static inline int __deprecated pwm_pin_configure(struct device *dev, u8_t pwm, int flags)
DECL|pwm_pin_set_cycles|function|static inline int pwm_pin_set_cycles(struct device *dev, u32_t pwm, u32_t period, u32_t pulse)
DECL|pwm_pin_set_duty_cycle|function|static inline int __deprecated pwm_pin_set_duty_cycle(struct device *dev, u32_t pwm, u8_t duty)
DECL|pwm_pin_set_period|function|static inline int __deprecated pwm_pin_set_period(struct device *dev, u32_t pwm, u32_t period)
DECL|pwm_pin_set_phase|function|static inline int __deprecated pwm_pin_set_phase(struct device *dev, u32_t pwm, u8_t phase)
...
DECL|pwm_pin_set_values|function|static inline int __deprecated pwm_pin_set_values(struct device *dev, u32_t pwm, u32_t on, u32_t off)
