...
DECL|pwm_all_period|function|static inline int pwm_all_period(struct device *dev, uint32_t period)
DECL|pwm_all_set_duty_cycle|function|static inline int pwm_all_set_duty_cycle(struct device *dev, uint8_t duty)
DECL|pwm_all_set_phase|function|static inline int pwm_all_set_phase(struct device *dev, uint8_t phase)
