...
DECL|ipm_callback_t|typedef|typedef void (*ipm_callback_t)(void *context, u32_t id, volatile void *data);
...
DECL|ipm_max_id_val_get_t|typedef|typedef u32_t (*ipm_max_id_val_get_t)(struct device *ipmdev);
DECL|ipm_max_id_val_get|function|static inline u32_t ipm_max_id_val_get(struct device *ipmdev)
...
DECL|ipm_send_t|typedef|typedef int (*ipm_send_t)(struct device *ipmdev, int wait, u32_t id,
DECL|ipm_send|function|static inline int ipm_send(struct device *ipmdev, int wait, u32_t id, const void *data, int size)
