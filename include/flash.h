...
DECL|flash_read|function|static inline int flash_read(struct device *dev, off_t offset, void *data, size_t len)
DECL|flash_write_protection_set|function|static inline int flash_write_protection_set(struct device *dev, bool enable)
DECL|flash_write|function|static inline int flash_write(struct device *dev, off_t offset, const void *data, size_t len)
