...
DECL|cb_fn|member|void (*cb_fn)(void);
...
DECL|rtc_api_disable|typedef|typedef void (*rtc_api_disable)(void);
DECL|rtc_api_enable|typedef|typedef void (*rtc_api_enable)(void);
DECL|rtc_api_read|typedef|typedef uint32_t (*rtc_api_read)(void);
DECL|rtc_api_set_alarm|typedef|typedef int (*rtc_api_set_alarm)(const uint32_t alarm_val);
DECL|rtc_api_set_config|typedef|typedef int (*rtc_api_set_config)(struct rtc_config *config);
