...
DECL|NET_REQUEST_STATS_CMD_GET_ETHERNET|enumerator|NET_REQUEST_STATS_CMD_GET_ETHERNET,
...
DECL|NET_REQUEST_STATS_GET_ALL|variable|NET_REQUEST_STATS_GET_ALL
DECL|NET_REQUEST_STATS_GET_BYTES|macro|NET_REQUEST_STATS_GET_BYTES
DECL|NET_REQUEST_STATS_GET_BYTES|variable|NET_REQUEST_STATS_GET_BYTES
DECL|NET_REQUEST_STATS_GET_ETHERNET|macro|NET_REQUEST_STATS_GET_ETHERNET
DECL|NET_REQUEST_STATS_GET_ETHERNET|variable|NET_REQUEST_STATS_GET_ETHERNET
...
DECL|NET_REQUEST_STATS_GET_IP_ERRORS|variable|NET_REQUEST_STATS_GET_IP_ERRORS
DECL|NET_REQUEST_STATS_GET_PROCESSING_ERROR|macro|NET_REQUEST_STATS_GET_PROCESSING_ERROR
DECL|NET_REQUEST_STATS_GET_PROCESSING_ERROR|variable|NET_REQUEST_STATS_GET_PROCESSING_ERROR
...
DECL|broadcast|member|struct net_stats_pkts broadcast;
...
DECL|chkerr|member|net_stats_t chkerr;
DECL|chkerr|member|net_stats_t chkerr;
DECL|collisions|member|net_stats_t collisions;
DECL|conndrop|member|net_stats_t conndrop;
DECL|connrst|member|net_stats_t connrst;
DECL|corr_ecc_errors|member|net_stats_t corr_ecc_errors;
DECL|csum|member|struct net_stats_eth_csum csum;
...
DECL|drop|member|net_stats_t drop;
DECL|drop|member|net_stats_t drop;
DECL|error_details|member|struct net_stats_eth_errors error_details;
DECL|errors|member|struct net_stats_pkts errors;
DECL|flow_control|member|struct net_stats_eth_flow flow_control;
...
DECL|hw_timestamp|member|struct net_stats_eth_hw_timestamp hw_timestamp;
...
DECL|multicast|member|struct net_stats_pkts multicast;
DECL|net_request_stats_cmd|enum|enum net_request_stats_cmd {
DECL|net_stats_bytes|struct|struct net_stats_bytes {
DECL|net_stats_eth_csum|struct|struct net_stats_eth_csum {
...
DECL|net_stats_pkts|struct|struct net_stats_pkts {
...
DECL|pkts|member|net_stats_t pkts;
DECL|pkts|member|struct net_stats_pkts pkts;
...
DECL|received|member|net_stats_t received;
...
DECL|rx_align_errors|member|net_stats_t rx_align_errors;
DECL|rx_buf_alloc_failed|member|net_stats_t rx_buf_alloc_failed;
DECL|rx_crc_errors|member|net_stats_t rx_crc_errors;
DECL|rx_csum_offload_errors|member|net_stats_t rx_csum_offload_errors;
DECL|rx_csum_offload_good|member|net_stats_t rx_csum_offload_good;
DECL|rx_dma_failed|member|net_stats_t rx_dma_failed;
DECL|rx_flow_control_xoff|member|net_stats_t rx_flow_control_xoff;
DECL|rx_flow_control_xon|member|net_stats_t rx_flow_control_xon;
DECL|rx_frame_errors|member|net_stats_t rx_frame_errors;
DECL|rx_hwtstamp_cleared|member|net_stats_t rx_hwtstamp_cleared;
DECL|rx_length_errors|member|net_stats_t rx_length_errors;
DECL|rx_long_length_errors|member|net_stats_t rx_long_length_errors;
DECL|rx_missed_errors|member|net_stats_t rx_missed_errors;
DECL|rx_no_buffer_count|member|net_stats_t rx_no_buffer_count;
DECL|rx_over_errors|member|net_stats_t rx_over_errors;
DECL|rx_short_length_errors|member|net_stats_t rx_short_length_errors;
DECL|rx|member|net_stats_t rx;
...
DECL|tx_aborted_errors|member|net_stats_t tx_aborted_errors;
DECL|tx_carrier_errors|member|net_stats_t tx_carrier_errors;
DECL|tx_dma_failed|member|net_stats_t tx_dma_failed;
DECL|tx_dropped|member|net_stats_t tx_dropped;
DECL|tx_fifo_errors|member|net_stats_t tx_fifo_errors;
DECL|tx_flow_control_xoff|member|net_stats_t tx_flow_control_xoff;
DECL|tx_flow_control_xon|member|net_stats_t tx_flow_control_xon;
DECL|tx_heartbeat_errors|member|net_stats_t tx_heartbeat_errors;
DECL|tx_hwtstamp_skipped|member|net_stats_t tx_hwtstamp_skipped;
DECL|tx_hwtstamp_timeouts|member|net_stats_t tx_hwtstamp_timeouts;
DECL|tx_restart_queue|member|net_stats_t tx_restart_queue;
DECL|tx_timeout_count|member|net_stats_t tx_timeout_count;
DECL|tx_window_errors|member|net_stats_t tx_window_errors;
DECL|tx|member|net_stats_t tx;
