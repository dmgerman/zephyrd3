...
DECL|ETH_AUTO_NEGOTIATION_SET|enumerator|ETH_AUTO_NEGOTIATION_SET = BIT(3),
DECL|ETH_DUPLEX_SET|enumerator|ETH_DUPLEX_SET = BIT(7),
...
DECL|ETH_LINK_1000BASE_T|enumerator|ETH_LINK_1000BASE_T = BIT(6),
DECL|ETH_LINK_100BASE_T|enumerator|ETH_LINK_100BASE_T = BIT(5),
DECL|ETH_LINK_10BASE_T|enumerator|ETH_LINK_10BASE_T = BIT(4),
