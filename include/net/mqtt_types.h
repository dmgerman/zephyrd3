...
DECL|msg_len|member|uint16_t msg_len;
DECL|msg|member|uint8_t *msg;
DECL|password_len|member|uint16_t password_len;
DECL|password|member|uint8_t *password;
...
DECL|will_msg|member|uint8_t *will_msg;
DECL|will_qos|member|enum mqtt_qos will_qos;
DECL|will_retain|member|uint8_t will_retain:1;
DECL|will_topic_len|member|uint16_t will_topic_len;
