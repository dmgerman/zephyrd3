...
DECL|INADDR_ANY_INIT|macro|INADDR_ANY_INIT
DECL|INADDR_ANY|macro|INADDR_ANY
DECL|INET6_ADDRSTRLEN|macro|INET6_ADDRSTRLEN
DECL|INET_ADDRSTRLEN|macro|INET_ADDRSTRLEN
DECL|IPPROTO_DTLS_1_0|enumerator|IPPROTO_DTLS_1_0 = 272,
DECL|IPPROTO_DTLS_1_2|enumerator|IPPROTO_DTLS_1_2 = 273,
...
DECL|NET_ADDR_OVERRIDABLE|enumerator|NET_ADDR_OVERRIDABLE,
...
DECL|NET_IPV4_ADDR_LEN|macro|NET_IPV4_ADDR_LEN
DECL|NET_IPV4_MTU|macro|NET_IPV4_MTU
...
DECL|NET_IPV6_ADDR_LEN|macro|NET_IPV6_ADDR_LEN
DECL|NET_IPV6_FRAGH_LEN|macro|NET_IPV6_FRAGH_LEN
DECL|NET_IPV6_MTU|macro|NET_IPV6_MTU
DECL|NET_IPV6_NEXTHDR_DESTO|macro|NET_IPV6_NEXTHDR_DESTO
DECL|NET_IPV6_NEXTHDR_FRAG|macro|NET_IPV6_NEXTHDR_FRAG
...
DECL|NET_VLAN_TAG_UNSPEC|macro|NET_VLAN_TAG_UNSPEC
...
DECL|net_ipv6_addr_create|function|static inline void net_ipv6_addr_create(struct in6_addr *addr,u16_t addr0, u16_t addr1, u16_t addr2, u16_t addr3, u16_t addr4, u16_t addr5, u16_t addr6, u16_t addr7)
...
DECL|net_is_ipv6_prefix|function|static inline bool net_is_ipv6_prefix(const u8_t *addr1, const u8_t *addr2, u8_t length)
...
DECL|offset|member|u8_t offset;
DECL|offset|member|u8_t offset[2];
DECL|optdata|member|u8_t optdata[0];
...
DECL|sin6_family|member|sa_family_t sin6_family; /* AF_INET6 */
DECL|sin6_port|member|u16_t sin6_port; /* Port number */
DECL|sin6_port|member|u16_t sin6_port; /* Port number */
DECL|sin6_scope_id|member|u8_t sin6_scope_id; /* interfaces for a scope */
DECL|sin6_scope_id|member|u8_t sin6_scope_id; /* interfaces for a scope */
DECL|sin_addr|member|struct in_addr *sin_addr; /* IPv4 address */
DECL|sin_addr|member|struct in_addr sin_addr; /* IPv4 address */
DECL|sin_family|member|sa_family_t sin_family; /* AF_INET */
DECL|sin_family|member|sa_family_t sin_family; /* AF_INET */
DECL|sin_port|member|u16_t sin_port; /* Port number */
DECL|sin_port|member|u16_t sin_port; /* Port number */
