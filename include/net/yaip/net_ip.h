...
DECL|net_is_ipv6_addr_solicited_node|function|static inline bool net_is_ipv6_addr_solicited_node(struct in6_addr *addr)
DECL|net_is_ipv6_addr_unspecified|function|static inline bool net_is_ipv6_addr_unspecified(struct in6_addr *addr)
