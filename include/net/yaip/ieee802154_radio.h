...
DECL|get_lqi|member|uint8_t (*get_lqi)(struct device *dev);
DECL|ieee802154_radio_api|struct|struct ieee802154_radio_api {
DECL|iface_api|member|struct net_if_api iface_api;
DECL|set_channel|member|int (*set_channel)(struct device *dev, uint16_t channel);
DECL|set_ieee_addr|member|int (*set_ieee_addr)(struct device *dev, const uint8_t *ieee_addr);
DECL|set_pan_id|member|int (*set_pan_id)(struct device *dev, uint16_t pan_id);
DECL|set_short_addr|member|int (*set_short_addr)(struct device *dev, uint16_t short_addr);
