DECL|Imax_abs|member|uint32_t Imax_abs; /* Max interval size in ticks (not doublings)
DECL|Imax|member|uint8_t Imax; /* Max number of doublings */
DECL|Imin|member|uint32_t Imin; /* Min interval size in ticks */
DECL|Istart|member|uint32_t Istart; /* Start of the interval in ticks */
...
DECL|timer|member|struct nano_delayed_work timer;
