...
DECL|net_pkt_lladdr_dst|function|static inline struct net_linkaddr *net_pkt_lladdr_dst(struct net_pkt *pkt)
DECL|net_pkt_lladdr_if|function|static inline struct net_linkaddr *net_pkt_lladdr_if(struct net_pkt *pkt)
DECL|net_pkt_lladdr_src|function|static inline struct net_linkaddr *net_pkt_lladdr_src(struct net_pkt *pkt)
DECL|net_pkt_lladdr_swap|function|static inline void net_pkt_lladdr_swap(struct net_pkt *pkt)
