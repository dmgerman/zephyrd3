...
DECL|ipv6_hop_limit|member|u8_t ipv6_hop_limit; /* IPv6 hop limit for this network packet. */
...
DECL|net_pkt_udp_data|function|static inline u8_t *net_pkt_udp_data(struct net_pkt *pkt)
