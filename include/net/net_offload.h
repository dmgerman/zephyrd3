...
DECL|net_offload_accept|function|static inline int net_offload_accept(struct net_if *iface, struct net_context *context, net_tcp_accept_cb_t cb, int32_t timeout, void *user_data)
...
DECL|net_offload_recv|function|static inline int net_offload_recv(struct net_if *iface, struct net_context *context, net_context_recv_cb_t cb, int32_t timeout, void *user_data)
DECL|net_offload_sendto|function|static inline int net_offload_sendto(struct net_if *iface, struct net_buf *buf, const struct sockaddr *dst_addr, socklen_t addrlen, net_context_send_cb_t cb,
DECL|net_offload_send|function|static inline int net_offload_send(struct net_if *iface, struct net_buf *buf, net_context_send_cb_t cb, int32_t timeout, void *token,
