...
DECL|net_offload_send|function|static inline int net_offload_send(struct net_if *iface, struct net_pkt *pkt, net_context_send_cb_t cb, int32_t timeout, void *token,
