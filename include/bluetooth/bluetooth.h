...
DECL|BT_LE_ADV_CONN_DIR_LOW_DUTY|macro|BT_LE_ADV_CONN_DIR_LOW_DUTY
DECL|BT_LE_ADV_CONN_DIR|macro|BT_LE_ADV_CONN_DIR
...
DECL|BT_LE_ADV_OPT_DIR_MODE_LOW_DUTY|enumerator|BT_LE_ADV_OPT_DIR_MODE_LOW_DUTY = BIT(4),
