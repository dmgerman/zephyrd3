...
DECL|BT_LE_SCAN_FILTER_DUP_DISABLE|enumerator|BT_LE_SCAN_FILTER_DUP_DISABLE,
DECL|BT_LE_SCAN_FILTER_DUP_ENABLE|enumerator|BT_LE_SCAN_FILTER_DUP_ENABLE,
...
DECL|bt_le_scan_filter_dup_t|typedef|} bt_le_scan_filter_dup_t;
