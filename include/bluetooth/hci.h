...
DECL|BT_EVT_BIT_AUTH_COMPLETE|macro|BT_EVT_BIT_AUTH_COMPLETE
DECL|BT_EVT_BIT_CONN_COMPLETE|macro|BT_EVT_BIT_CONN_COMPLETE
DECL|BT_EVT_BIT_CONN_REQUEST|macro|BT_EVT_BIT_CONN_REQUEST
DECL|BT_EVT_BIT_DISCONN_COMPLETE|macro|BT_EVT_BIT_DISCONN_COMPLETE
DECL|BT_EVT_BIT_ENCRYPT_CHANGE|macro|BT_EVT_BIT_ENCRYPT_CHANGE
DECL|BT_EVT_BIT_ENCRYPT_KEY_REFRESH_COMPLETE|macro|BT_EVT_BIT_ENCRYPT_KEY_REFRESH_COMPLETE
DECL|BT_EVT_BIT_EXTENDED_INQUIRY_RESULT|macro|BT_EVT_BIT_EXTENDED_INQUIRY_RESULT
DECL|BT_EVT_BIT_INQUIRY_COMPLETE|macro|BT_EVT_BIT_INQUIRY_COMPLETE
DECL|BT_EVT_BIT_INQUIRY_RESULT_WITH_RSSI|macro|BT_EVT_BIT_INQUIRY_RESULT_WITH_RSSI
DECL|BT_EVT_BIT_IO_CAPA_REQ|macro|BT_EVT_BIT_IO_CAPA_REQ
DECL|BT_EVT_BIT_IO_CAPA_RESP|macro|BT_EVT_BIT_IO_CAPA_RESP
DECL|BT_EVT_BIT_LE_ADVERTISING_REPORT|macro|BT_EVT_BIT_LE_ADVERTISING_REPORT
DECL|BT_EVT_BIT_LE_ADV_SET_TERMINATED|macro|BT_EVT_BIT_LE_ADV_SET_TERMINATED
DECL|BT_EVT_BIT_LE_CHAN_SEL_ALGO|macro|BT_EVT_BIT_LE_CHAN_SEL_ALGO
DECL|BT_EVT_BIT_LE_CONN_COMPLETE|macro|BT_EVT_BIT_LE_CONN_COMPLETE
DECL|BT_EVT_BIT_LE_CONN_PARAM_REQ|macro|BT_EVT_BIT_LE_CONN_PARAM_REQ
DECL|BT_EVT_BIT_LE_CONN_UPDATE_COMPLETE|macro|BT_EVT_BIT_LE_CONN_UPDATE_COMPLETE
DECL|BT_EVT_BIT_LE_DATA_LEN_CHANGE|macro|BT_EVT_BIT_LE_DATA_LEN_CHANGE
DECL|BT_EVT_BIT_LE_DIRECT_ADV_REPORT|macro|BT_EVT_BIT_LE_DIRECT_ADV_REPORT
DECL|BT_EVT_BIT_LE_ENH_CONN_COMPLETE|macro|BT_EVT_BIT_LE_ENH_CONN_COMPLETE
DECL|BT_EVT_BIT_LE_EXT_ADVERTISING_REPORT|macro|BT_EVT_BIT_LE_EXT_ADVERTISING_REPORT
DECL|BT_EVT_BIT_LE_GENERATE_DHKEY_COMPLETE|macro|BT_EVT_BIT_LE_GENERATE_DHKEY_COMPLETE
DECL|BT_EVT_BIT_LE_LTK_REQUEST|macro|BT_EVT_BIT_LE_LTK_REQUEST
DECL|BT_EVT_BIT_LE_META_EVENT|macro|BT_EVT_BIT_LE_META_EVENT
DECL|BT_EVT_BIT_LE_P256_PUBLIC_KEY_COMPLETE|macro|BT_EVT_BIT_LE_P256_PUBLIC_KEY_COMPLETE
DECL|BT_EVT_BIT_LE_PER_ADVERTISING_REPORT|macro|BT_EVT_BIT_LE_PER_ADVERTISING_REPORT
DECL|BT_EVT_BIT_LE_PER_ADV_SYNC_ESTABLISHED|macro|BT_EVT_BIT_LE_PER_ADV_SYNC_ESTABLISHED
DECL|BT_EVT_BIT_LE_PER_ADV_SYNC_LOST|macro|BT_EVT_BIT_LE_PER_ADV_SYNC_LOST
DECL|BT_EVT_BIT_LE_PHY_UPDATE_COMPLETE|macro|BT_EVT_BIT_LE_PHY_UPDATE_COMPLETE
DECL|BT_EVT_BIT_LE_REMOTE_FEAT_COMPLETE|macro|BT_EVT_BIT_LE_REMOTE_FEAT_COMPLETE
DECL|BT_EVT_BIT_LE_SCAN_REQ_RECEIVED|macro|BT_EVT_BIT_LE_SCAN_REQ_RECEIVED
DECL|BT_EVT_BIT_LE_SCAN_TIMEOUT|macro|BT_EVT_BIT_LE_SCAN_TIMEOUT
DECL|BT_EVT_BIT_LINK_KEY_NOTIFY|macro|BT_EVT_BIT_LINK_KEY_NOTIFY
DECL|BT_EVT_BIT_LINK_KEY_REQ|macro|BT_EVT_BIT_LINK_KEY_REQ
DECL|BT_EVT_BIT_PIN_CODE_REQ|macro|BT_EVT_BIT_PIN_CODE_REQ
DECL|BT_EVT_BIT_REMOTE_EXT_FEATURES|macro|BT_EVT_BIT_REMOTE_EXT_FEATURES
DECL|BT_EVT_BIT_REMOTE_FEATURES|macro|BT_EVT_BIT_REMOTE_FEATURES
DECL|BT_EVT_BIT_REMOTE_NAME_REQ_COMPLETE|macro|BT_EVT_BIT_REMOTE_NAME_REQ_COMPLETE
DECL|BT_EVT_BIT_REMOTE_VERSION_INFO|macro|BT_EVT_BIT_REMOTE_VERSION_INFO
DECL|BT_EVT_BIT_ROLE_CHANGE|macro|BT_EVT_BIT_ROLE_CHANGE
DECL|BT_EVT_BIT_SSP_COMPLETE|macro|BT_EVT_BIT_SSP_COMPLETE
DECL|BT_EVT_BIT_SYNC_CONN_COMPLETE|macro|BT_EVT_BIT_SYNC_CONN_COMPLETE
DECL|BT_EVT_BIT_USER_CONFIRM_REQ|macro|BT_EVT_BIT_USER_CONFIRM_REQ
DECL|BT_EVT_BIT_USER_PASSKEY_NOTIFY|macro|BT_EVT_BIT_USER_PASSKEY_NOTIFY
DECL|BT_EVT_BIT_USER_PASSKEY_REQ|macro|BT_EVT_BIT_USER_PASSKEY_REQ
