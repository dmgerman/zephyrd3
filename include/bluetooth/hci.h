...
DECL|BT_HCI_OP_LE_READ_ADV_CH_TX_POWER|macro|BT_HCI_OP_LE_READ_ADV_CH_TX_POWER
DECL|BT_HCI_OP_LE_READ_BUFFER_SIZE|macro|BT_HCI_OP_LE_READ_BUFFER_SIZE
DECL|BT_HCI_OP_LE_READ_CH_MAP|macro|BT_HCI_OP_LE_READ_CH_MAP
...
DECL|BT_HCI_OP_LE_SET_HOST_CH_CLASSIF|macro|BT_HCI_OP_LE_SET_HOST_CH_CLASSIF
...
DECL|bt_hci_cp_le_read_ch_map|struct|struct bt_hci_cp_le_read_ch_map {
...
DECL|bt_hci_cp_le_set_host_ch_classif|struct|struct bt_hci_cp_le_set_host_ch_classif {
...
DECL|bt_hci_rp_le_read_ch_tx_power|struct|struct bt_hci_rp_le_read_ch_tx_power {
...
DECL|capability|member|uint8_t capability;
DECL|ch_map|member|uint8_t ch_map[5];
DECL|ch_map|member|uint8_t ch_map[5];
...
DECL|ext_features|member|uint8_t ext_features[8];
...
DECL|le_states|member|uint8_t le_states[8];
...
DECL|local_irk|member|uint8_t local_irk[16];
...
DECL|peer_id_addr|member|bt_addr_le_t peer_id_addr;
DECL|peer_id_addr|member|bt_addr_le_t peer_id_addr;
DECL|peer_irk|member|uint8_t peer_irk[16];
