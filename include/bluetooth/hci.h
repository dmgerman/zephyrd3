...
DECL|adv_handle|member|uint8_t adv_handle;
...
DECL|all_phys|member|uint8_t all_phys;
DECL|all_phys|member|uint8_t all_phys;
...
DECL|data_status|member|uint8_t data_status;
DECL|data|member|uint8_t data[0];
DECL|data|member|uint8_t data[0];
DECL|data|member|uint8_t data[0];
DECL|data|member|uint8_t data[251];
DECL|data|member|uint8_t data[251];
DECL|data|member|uint8_t data[251];
...
DECL|duration|member|uint16_t duration;
DECL|duration|member|uint16_t duration;
...
DECL|filter_policy|member|uint8_t filter_policy;
DECL|filter_policy|member|uint8_t filter_policy;
DECL|frag_pref|member|uint8_t frag_pref;
DECL|frag_pref|member|uint8_t frag_pref;
...
DECL|link_type|member|uint8_t link_type;
DECL|link_type|member|uint8_t link_type;
DECL|list_size|member|uint8_t list_size;
...
DECL|manufacturer|member|uint16_t manufacturer;
DECL|max_adv_data_len|member|uint16_t max_adv_data_len;
DECL|max_ce_len|member|uint16_t max_ce_len;
DECL|max_ce_len|member|uint16_t max_ce_len;
DECL|max_ce_len|member|uint16_t max_ce_len;
DECL|max_ce_len|member|uint16_t max_ce_len;
DECL|max_ext_adv_evts|member|uint8_t max_ext_adv_evts;
...
DECL|max_tx_octets|member|uint16_t max_tx_octets;
DECL|max_tx_octets|member|uint16_t max_tx_octets;
DECL|max_tx_power|member|int8_t max_tx_power;
...
DECL|min_interval|member|uint16_t min_interval;
DECL|min_tx_power|member|int8_t min_tx_power;
DECL|mod_index|member|uint8_t mod_index;
...
DECL|ncmd|member|uint8_t ncmd;
DECL|num_completed_ext_adv_evts|member|uint8_t num_completed_ext_adv_evts;
...
DECL|num_sets|member|uint8_t num_sets;
...
DECL|peer_rpa|member|bt_addr_t peer_rpa;
DECL|period|member|uint16_t period;
DECL|phy_opts|member|uint8_t phy_opts;
DECL|phys|member|uint8_t phys;
DECL|phys|member|uint8_t phys;
DECL|phy|member|uint8_t phy;
DECL|phy|member|uint8_t phy;
DECL|phy|member|uint8_t phy;
...
DECL|prim_adv_phy|member|uint8_t prim_adv_phy;
DECL|prim_channel_map|member|uint8_t prim_channel_map;
DECL|prim_max_interval|member|uint8_t prim_max_interval[3];
DECL|prim_min_interval|member|uint8_t prim_min_interval[3];
DECL|prim_phy|member|uint8_t prim_phy;
DECL|props|member|uint16_t props;
DECL|props|member|uint16_t props;
...
DECL|rx_ch|member|uint8_t rx_ch;
DECL|rx_path_comp|member|int16_t rx_path_comp;
DECL|rx_path_comp|member|int16_t rx_path_comp;
DECL|rx_phys|member|uint8_t rx_phys;
DECL|rx_phys|member|uint8_t rx_phys;
DECL|rx_phy|member|uint8_t rx_phy;
DECL|rx_phy|member|uint8_t rx_phy;
...
DECL|scan_req_notify_enable|member|uint8_t scan_req_notify_enable;
...
DECL|sec_adv_max_skip|member|uint8_t sec_adv_max_skip;
DECL|sec_adv_phy|member|uint8_t sec_adv_phy;
DECL|sec_phy|member|uint8_t sec_phy;
DECL|set_num|member|uint8_t set_num;
DECL|sid|member|uint8_t sid;
DECL|sid|member|uint8_t sid;
DECL|sid|member|uint8_t sid;
DECL|sid|member|uint8_t sid;
DECL|sid|member|uint8_t sid;
...
DECL|skip|member|uint16_t skip;
...
DECL|supv_timeout|member|uint16_t supv_timeout;
DECL|supv_timeout|member|uint16_t supv_timeout;
DECL|sync_timeout|member|uint16_t sync_timeout;
...
DECL|tx_path_comp|member|int16_t tx_path_comp;
DECL|tx_path_comp|member|int16_t tx_path_comp;
DECL|tx_phys|member|uint8_t tx_phys;
DECL|tx_phys|member|uint8_t tx_phys;
DECL|tx_phy|member|uint8_t tx_phy;
DECL|tx_phy|member|uint8_t tx_phy;
...
DECL|type|member|uint8_t type;
DECL|type|member|uint8_t type;
DECL|unused|member|uint8_t unused;
DECL|unused|member|uint8_t unused;
