...
DECL|_arch_irq_disable|function|static ALWAYS_INLINE void _arch_irq_disable(uint32_t irq)
DECL|_arch_irq_enable|function|static ALWAYS_INLINE void _arch_irq_enable(uint32_t irq)
