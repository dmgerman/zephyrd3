...
DECL|ARM_MPU_ENABLE|macro|ARM_MPU_ENABLE
DECL|ARM_MPU_HFNMIENA|macro|ARM_MPU_HFNMIENA
DECL|ARM_MPU_PRIVDEFENA|macro|ARM_MPU_PRIVDEFENA
...
DECL|REGION_BASE_ADDR_MASK|macro|REGION_BASE_ADDR_MASK
...
DECL|REGION_VALID|macro|REGION_VALID
DECL|RO|macro|RO
