...
DECL|rmode|member|uint32_t rmode : 2 __packed;
DECL|rsvd_0_2|member|uint32_t rsvd_0_2 : 3 __packed;
DECL|rsvd_24_27|member|uint32_t rsvd_24_27;
DECL|rsvd_40_63|member|uint32_t rsvd_40_63[6];
DECL|rsvd_4_8|member|uint32_t rsvd_4_8 : 5 __packed;
DECL|rsvd_9_12|member|uint32_t rsvd_9_12;
...
DECL|rsvd__3_14|member|uint32_t rsvd__3_14 : 12 __packed;
...
DECL|rsvd__9_10_11|member|uint32_t rsvd__9_10_11 : 3 __packed;
...
DECL|vectpending|member|uint32_t vectpending : 9 __packed;
