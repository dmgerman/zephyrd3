...
DECL|cipher_cbc_op|function|static inline int cipher_cbc_op(struct cipher_ctx *ctx,struct cipher_pkt *pkt, uint8_t *iv)
DECL|cipher_ccm_op|function|static inline int cipher_ccm_op(struct cipher_ctx *ctx,struct cipher_aead_pkt *pkt, uint8_t *nonce)
DECL|cipher_ctr_op|function|static inline int cipher_ctr_op(struct cipher_ctx *ctx,struct cipher_pkt *pkt, uint8_t *iv)
