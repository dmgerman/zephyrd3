...
DECL|counter_get_pending_int|function|static inline int counter_get_pending_int(struct device *dev)
DECL|counter_read|function|static inline u32_t counter_read(struct device *dev)
