...
DECL|allowupdate|member|uint8_t allowupdate : 1 __attribute__((packed));
DECL|bytesel|member|uint8_t bytesel : 2 __attribute__((packed));
DECL|clksrc|member|uint8_t clksrc : 1 __attribute__((packed));
DECL|dbgen|member|uint8_t dbgen : 1 __attribute__((packed));
DECL|disestwdog|member|uint8_t disestwdog : 1 __attribute__((packed));
DECL|field|member|} field;
DECL|irqrsten|member|uint8_t irqrsten : 1 __attribute__((packed));
DECL|presc|member|uint16_t presc; /* 0x16 */
DECL|refresh|member|uint16_t refresh; /* 0x0C */
DECL|res_15|member|uint8_t res_15 : 1 __attribute__((packed));
DECL|res_8_9|member|uint8_t res_8_9 : 2 __attribute__((packed));
...
DECL|stopen|member|uint8_t stopen : 1 __attribute__((packed));
DECL|testsel|member|uint8_t testsel : 1 __attribute__((packed));
DECL|testwdog|member|uint8_t testwdog : 1 __attribute__((packed));
...
DECL|waiten|member|uint8_t waiten : 1 __attribute__((packed));
...
DECL|wdogen|member|uint8_t wdogen : 1 __attribute__((packed));
DECL|winen|member|uint8_t winen : 1 __attribute__((packed));
