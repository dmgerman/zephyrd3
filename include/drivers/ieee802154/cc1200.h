...
DECL|chan_center_freq0|member|u32_t chan_center_freq0;
DECL|channel_limit|member|u16_t channel_limit;
DECL|channel_spacing|member|u16_t channel_spacing;
DECL|dev|member|struct device *dev;
DECL|pin|member|u32_t pin;
DECL|registers|member|u8_t registers[100];
