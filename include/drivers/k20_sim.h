...
DECL|cmpClkEn|member|uint32_t cmpClkEn : 1 __packed;
DECL|cmtClkEn_0|member|uint32_t cmtClkEn_0 : 1 __packed;
DECL|ewmClkEn_0|member|uint32_t ewmClkEn_0 : 1 __packed;
...
DECL|field|member|} field;
DECL|field|member|} field;
DECL|flexBusSL|member|uint32_t flexBusSL : 2 __packed;
DECL|fllPllClkSel|member|uint32_t fllPllClkSel : 1 __packed;
DECL|ftm0ClkSel|member|uint32_t ftm0ClkSel : 1 __packed;
DECL|ftm0Flt0|member|uint32_t ftm0Flt0 : 1 __packed;
DECL|ftm0Flt1|member|uint32_t ftm0Flt1 : 1 __packed;
DECL|ftm0Flt2|member|uint32_t ftm0Flt2 : 1 __packed;
DECL|ftm0Trg0Src|member|uint32_t ftm0Trg0Src : 1 __packed;
DECL|ftm0Trg1Src|member|uint32_t ftm0Trg1Src : 1 __packed;
DECL|ftm1Ch0Src|member|uint32_t ftm1Ch0Src : 2 __packed;
DECL|ftm1ClkSel|member|uint32_t ftm1ClkSel : 1 __packed;
DECL|ftm1Flt0|member|uint32_t ftm1Flt0 : 1 __packed;
DECL|ftm2Ch0Src|member|uint32_t ftm2Ch0Src : 2 __packed;
DECL|ftm2ClkSel|member|uint32_t ftm2ClkSel : 1 __packed;
DECL|ftm2Flt0|member|uint32_t ftm2Flt0 : 1 __packed;
DECL|i2c0ClkEn|member|uint32_t i2c0ClkEn : 1 __packed;
DECL|i2c1ClkEn|member|uint32_t i2c1ClkEn : 1 __packed;
DECL|lptimer|member|uint32_t lptimer : 1 __packed;
DECL|osc32kSel|member|uint32_t osc32kSel : 2 __packed;
...
DECL|portA_ClkEn|member|uint32_t portA_ClkEn : 1 __packed;
DECL|portB_ClkEn|member|uint32_t portB_ClkEn : 1 __packed;
DECL|portC_ClkEn|member|uint32_t portC_ClkEn : 1 __packed;
DECL|portD_ClkEn|member|uint32_t portD_ClkEn : 1 __packed;
DECL|portE_ClkEn|member|uint32_t portE_ClkEn : 1 __packed;
DECL|ptd7Pad|member|uint32_t ptd7Pad : 1 __packed;
DECL|ramSize|member|uint32_t ramSize : 4 __packed;
...
DECL|rtcClkOutSel|member|uint32_t rtcClkOutSel : 1 __packed;
...
DECL|traceClkSel|member|uint32_t traceClkSel : 1 __packed;
DECL|tsi|member|uint32_t tsi : 1 __packed;
DECL|uart0ClkEn|member|uint32_t uart0ClkEn : 1 __packed;
DECL|uart0RxSrc|member|uint32_t uart0RxSrc : 2 __packed;
DECL|uart0RxSrc|member|uint32_t uart0RxSrc : 2 __packed;
DECL|uart0TxSrc|member|uint32_t uart0TxSrc : 2 __packed;
DECL|uart0TxSrc|member|uint32_t uart0TxSrc : 2 __packed;
DECL|uart1ClkEn|member|uint32_t uart1ClkEn : 1 __packed;
DECL|uart1RxSrc|member|uint32_t uart1RxSrc : 2 __packed;
DECL|uart1RxSrc|member|uint32_t uart1RxSrc : 2 __packed;
DECL|uart1TxSrc|member|uint32_t uart1TxSrc : 2 __packed;
DECL|uart1TxSrc|member|uint32_t uart1TxSrc : 2 __packed;
DECL|uart2ClkEn|member|uint32_t uart2ClkEn : 1 __packed;
DECL|uart3ClkEn|member|uint32_t uart3ClkEn : 1 __packed;
DECL|usbClkEn|member|uint32_t usbClkEn : 1 __packed;
DECL|usbRegEn|member|uint32_t usbRegEn : 1 __packed;
DECL|usbRegWriteEn|member|uint32_t usbRegWriteEn : 1 __packed;
DECL|usbSrc|member|uint32_t usbSrc : 1 __packed;
DECL|usbStopStby|member|uint32_t usbStopStby : 1 __packed;
DECL|usbStopWriteEn|member|uint32_t usbStopWriteEn : 1 __packed;
DECL|usbVoltStby|member|uint32_t usbVoltStby : 1 __packed;
DECL|usbVoltWriteEn|member|uint32_t usbVoltWriteEn : 1 __packed;
...
DECL|vrefClkEn|member|uint32_t vrefClkEn : 1 __packed;
