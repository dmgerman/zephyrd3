...
DECL|stctrlh|member|union WDOG_STCTRLH stctrlh; /* 0x00 */
...
DECL|wdog_disable|function|static ALWAYS_INLINE void wdog_disable(volatile struct K20_WDOG *wdog_p)
DECL|wdog_unlock|function|static ALWAYS_INLINE void wdog_unlock(volatile struct K20_WDOG *wdog_p)
