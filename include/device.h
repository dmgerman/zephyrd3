...
DECL|_DEPRECATION_CHECK|macro|_DEPRECATION_CHECK
DECL|_DEVICE_H_|macro|_DEVICE_H_
DECL|_INIT_LEVEL_APPLICATION|variable|_INIT_LEVEL_APPLICATION
DECL|_INIT_LEVEL_MICROKERNEL|variable|_INIT_LEVEL_MICROKERNEL
DECL|_INIT_LEVEL_NANOKERNEL|variable|_INIT_LEVEL_NANOKERNEL
...
DECL|_INIT_LEVEL_PRIMARY|variable|_INIT_LEVEL_PRIMARY
DECL|_INIT_LEVEL_SECONDARY|variable|_INIT_LEVEL_SECONDARY
