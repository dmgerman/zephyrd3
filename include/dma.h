...
DECL|destination_address|member|u32_t *destination_address;
...
DECL|dma_api_channel_config|typedef|typedef int (*dma_api_channel_config)(struct device *dev, u32_t channel,
...
DECL|dma_api_transfer_config|typedef|typedef int (*dma_api_transfer_config)(struct device *dev, u32_t channel,
DECL|dma_api_transfer_start|typedef|typedef int (*dma_api_transfer_start)(struct device *dev, u32_t channel);
DECL|dma_api_transfer_stop|typedef|typedef int (*dma_api_transfer_stop)(struct device *dev, u32_t channel);
DECL|dma_block_config|struct|struct dma_block_config {
DECL|dma_burst_index|function|static inline enum dma_burst_length dma_burst_index(u32_t burst)
...
DECL|dma_channel_config|function|static inline int __deprecated dma_channel_config(struct device *dev,u32_t channel, struct dma_channel_config *config)
...
DECL|dma_transfer_config|function|static inline int __deprecated dma_transfer_config(struct device *dev,u32_t channel, struct dma_transfer_config *config)
DECL|dma_transfer_config|struct|struct dma_transfer_config {
DECL|dma_transfer_start|function|static inline int __deprecated dma_transfer_start(struct device *dev, u32_t channel)
DECL|dma_transfer_stop|function|static inline int __deprecated dma_transfer_stop(struct device *dev, u32_t channel)
...
DECL|dma_width_index|function|static inline enum dma_burst_length dma_width_index(u32_t size)
...
DECL|handshake_interface|member|u32_t handshake_interface;
