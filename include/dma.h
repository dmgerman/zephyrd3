...
DECL|dest_burst_length|member|uint32_t dest_burst_length : 8;
DECL|dest_chaining_en|member|uint32_t dest_chaining_en : 1;
DECL|dest_data_size|member|uint32_t dest_data_size : 8;
...
DECL|source_burst_length|member|uint32_t source_burst_length : 8;
DECL|source_chaining_en|member|uint32_t source_chaining_en : 1;
DECL|source_data_size|member|uint32_t source_data_size : 8;
