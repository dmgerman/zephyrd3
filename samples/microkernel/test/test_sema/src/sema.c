...
DECL|HighPriTask|function|int HighPriTask(void)
DECL|LowPriTask|function|int LowPriTask(void)
...
DECL|simpleSemaTest|function|int simpleSemaTest(void)
DECL|simpleSemaWaitTest|function|int simpleSemaWaitTest(void)
