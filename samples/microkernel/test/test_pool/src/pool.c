...
DECL|poolBlockGetFunc|function|int poolBlockGetFunc( struct k_block *block, kmemory_pool_t pool, int size,
...
DECL|poolBlockGetWFunc|function|int poolBlockGetWFunc( struct k_block *block, kmemory_pool_t pool, int size,
DECL|poolBlockGetWTFunc|function|int poolBlockGetWTFunc( struct k_block *block, kmemory_pool_t pool, int size,
DECL|poolBlockGetWaitTest|function|int poolBlockGetWaitTest(void)
DECL|poolBlockGetWork|function|int poolBlockGetWork( char *string, poolBlockGetFunc_t func, TEST_CASE *tests,
