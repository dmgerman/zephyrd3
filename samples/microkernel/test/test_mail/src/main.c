...
DECL|msgSenderTask|variable|msgSenderTask
DECL|myMbox|variable|myMbox
DECL|noRcvrMbox|variable|noRcvrMbox
DECL|resultSems|variable|resultSems
DECL|semSync1|variable|semSync1
DECL|semSync2|variable|semSync2
DECL|smallBlkszPool|variable|smallBlkszPool
DECL|testPool|variable|testPool
