...
DECL|context_id|member|uint32_t context_id;
...
DECL|print_context_data|function|void print_context_data(uint32_t context_id, uint32_t count,uint32_t last_time_executed, int indice)
...
DECL|register_context_switch_data|function|void register_context_switch_data(uint32_t timestamp, uint32_t context_id)
