...
DECL|D|macro|D
DECL|UART1_IRQ_PRI|macro|UART1_IRQ_PRI
...
DECL|uart1_dev|variable|uart1_dev
DECL|uart1_init|function|static void uart1_init(void)
DECL|uart1_isr|function|static void uart1_isr(void *x)
