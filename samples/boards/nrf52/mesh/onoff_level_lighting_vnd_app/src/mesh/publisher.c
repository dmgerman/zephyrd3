...
DECL|randomize_publishers_TID|function|void randomize_publishers_TID(void)
DECL|tid_level|variable|tid_level
DECL|tid_onoff|variable|tid_onoff
DECL|tid_vnd|variable|tid_vnd
