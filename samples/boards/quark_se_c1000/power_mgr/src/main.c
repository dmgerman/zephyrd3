...
DECL|check_pm_policy|function|static int check_pm_policy(s32_t ticks)
DECL|create_device_list|function|static void create_device_list(void)
DECL|deep_sleep_entry|function|static int deep_sleep_entry(s32_t ticks)
...
DECL|low_power_state_entry|function|static int low_power_state_entry(s32_t ticks)
