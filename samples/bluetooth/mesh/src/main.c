...
DECL|gen_level_op|variable|gen_level_op
DECL|gen_level_pub|variable|gen_level_pub
...
DECL|gen_onoff_op|variable|gen_onoff_op
DECL|gen_onoff_pub|variable|gen_onoff_pub
