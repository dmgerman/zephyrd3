...
DECL|disc_all_desc_cb|function|static uint8_t disc_all_desc_cb(struct bt_conn *conn,const struct bt_gatt_attr *attr, void *user_data)
...
DECL|disc_chrc_cb|function|static uint8_t disc_chrc_cb(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *user_data)
...
DECL|disc_prim_uuid_cb|function|static uint8_t disc_prim_uuid_cb(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *user_data)
...
DECL|find_included_cb|function|static uint8_t find_included_cb(struct bt_conn *conn,const struct bt_gatt_attr *attr, void *user_data)
