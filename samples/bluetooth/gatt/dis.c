...
DECL|dis_init|function|void dis_init(const char *model, const char *manuf)
DECL|dis_manuf|variable|dis_manuf
DECL|dis_model|variable|dis_model
DECL|dis_svc|variable|dis_svc
