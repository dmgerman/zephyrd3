...
DECL|apds9960_reg_read|function|int apds9960_reg_read(struct device *i2c_dev, uint8_t reg_addr, uint8_t *data, uint8_t data_len)
DECL|apds9960_reg_write|function|int apds9960_reg_write(struct device *i2c_dev,uint8_t reg_addr, uint8_t reg_val)
