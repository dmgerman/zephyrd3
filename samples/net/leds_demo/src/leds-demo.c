...
DECL|dummy_path|variable|dummy_path
...
DECL|led_get|function|static int led_get(struct zoap_resource *resource, struct zoap_packet *request, const struct sockaddr *from)
DECL|led_off|variable|led_off
DECL|led_on|variable|led_on
DECL|led_post|function|static int led_post(struct zoap_resource *resource, struct zoap_packet *request, const struct sockaddr *from)
DECL|led_put|function|static int led_put(struct zoap_resource *resource, struct zoap_packet *request, const struct sockaddr *from)
