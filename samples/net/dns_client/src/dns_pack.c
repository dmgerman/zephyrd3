...
DECL|dns_msg_pack_query|function|int dns_msg_pack_query(uint8_t *buf, size_t *len, size_t size, char *domain_name, uint16_t id, enum dns_rr_type qtype)
DECL|dns_strlen|function|static inline size_t dns_strlen(char *str)
