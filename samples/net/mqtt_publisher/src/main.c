...
DECL|bluemix_publisher|variable|bluemix_publisher
...
DECL|get_payload|function|char *get_payload(enum mqtt_qos qos)
DECL|get_topic|function|char *get_topic(void)
