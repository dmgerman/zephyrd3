...
DECL|PRINT|macro|PRINT
DECL|PROCESS_THREAD|function|PROCESS_THREAD(coap_observe_client_process, ev, data, buf, user_data)
DECL|STACKSIZE|macro|STACKSIZE
DECL|TOGGLE_INTERVAL|macro|TOGGLE_INTERVAL
DECL|WAIT_PEER|macro|WAIT_PEER
...
DECL|get_ecdsa_key|macro|get_ecdsa_key
...
DECL|get_psk_info|macro|get_psk_info
...
DECL|verify_ecdsa_key|macro|verify_ecdsa_key
