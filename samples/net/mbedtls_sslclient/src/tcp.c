...
DECL|set_addr|function|static int set_addr(struct sockaddr *sock_addr, const char *addr, uint16_t server_port)
DECL|tcp_init|function|int tcp_init(struct tcp_context *ctx, const char *server_addr, uint16_t server_port)
