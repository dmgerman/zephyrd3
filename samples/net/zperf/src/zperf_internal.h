...
DECL|__ZPERF_INTERNAL_H|macro|__ZPERF_INTERNAL_H
DECL|datagrams|member|s32_t datagrams;
DECL|error_cnt|member|s32_t error_cnt;
DECL|flags|member|s32_t flags;
DECL|id|member|s32_t id;
DECL|jitter1|member|s32_t jitter1;
DECL|jitter2|member|s32_t jitter2;
DECL|outorder_cnt|member|s32_t outorder_cnt;
DECL|stop_sec|member|s32_t stop_sec;
DECL|stop_usec|member|s32_t stop_usec;
DECL|time_delta|function|static inline u32_t time_delta(u32_t ts, u32_t t)
DECL|total_len1|member|s32_t total_len1;
DECL|total_len2|member|s32_t total_len2;
DECL|tv_sec|member|u32_t tv_sec;
DECL|tv_usec|member|u32_t tv_usec;
