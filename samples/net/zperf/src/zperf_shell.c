...
DECL|shell_tcp_upload_print_stats|function|static void shell_tcp_upload_print_stats(zperf_results *results)
DECL|shell_tcp_upload_usage|function|static void shell_tcp_upload_usage(void)
DECL|shell_udp_upload_print_stats|function|static void shell_udp_upload_print_stats(zperf_results *results)
