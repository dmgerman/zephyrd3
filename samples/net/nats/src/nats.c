...
DECL|copy_pkt_to_buf|function|static int copy_pkt_to_buf(struct net_buf *src, u16_t offset, char *dst, size_t dst_size, size_t n_bytes)
DECL|go|member|const char *go;
DECL|handle_server_cmd|function|static int handle_server_cmd(struct nats *nats, char *cmd, size_t len, struct net_buf *buf, u16_t offset)
DECL|handle_server_info|function|static int handle_server_info(struct nats *nats, char *payload, size_t len, struct net_buf *buf, u16_t offset)
DECL|handle_server_msg|function|static int handle_server_msg(struct nats *nats, char *payload, size_t len, struct net_buf *buf, u16_t offset)
DECL|handle_server_ping|function|static int handle_server_ping(struct nats *nats, char *payload, size_t len, struct net_buf *buf, u16_t offset)
DECL|host|member|const char *host;
DECL|ignore|function|static int ignore(struct nats *nats, char *payload, size_t len, struct net_buf *buf, u16_t offset)
