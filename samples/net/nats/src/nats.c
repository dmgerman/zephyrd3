...
DECL|handle_server_cmd|function|static int handle_server_cmd(struct nats *nats, char *cmd, size_t len)
DECL|handle_server_info|function|static int handle_server_info(struct nats *nats, char *payload, size_t len)
DECL|handle_server_msg|function|static int handle_server_msg(struct nats *nats, char *payload, size_t len)
DECL|handle_server_ping|function|static int handle_server_ping(struct nats *nats, char *payload, size_t len)
DECL|host|member|const char *host;
DECL|ignore|function|static int ignore(struct nats *nats, char *payload, size_t len)
