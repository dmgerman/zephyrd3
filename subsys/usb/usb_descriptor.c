...
DECL|USB_DESC_MANUFACTURER_IDX|macro|USB_DESC_MANUFACTURER_IDX
DECL|USB_DESC_PRODUCT_IDX|macro|USB_DESC_PRODUCT_IDX
DECL|USB_DESC_SERIAL_NUMBER_IDX|macro|USB_DESC_SERIAL_NUMBER_IDX
...
DECL|usb_fix_ascii_sn_string_descriptor|function|usb_fix_ascii_sn_string_descriptor(struct usb_sn_descriptor *sn)
...
DECL|usb_update_sn_string_descriptor|function|__weak u8_t *usb_update_sn_string_descriptor(void)
