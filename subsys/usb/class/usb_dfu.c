DECL|IMAGE_0_DESC_LENGTH|macro|IMAGE_0_DESC_LENGTH
DECL|IMAGE_0_STRING_IDX_MAX|macro|IMAGE_0_STRING_IDX_MAX
DECL|IMAGE_0_UC_IDX_MAX|macro|IMAGE_0_UC_IDX_MAX
DECL|IMAGE_1_DESC_LENGTH|macro|IMAGE_1_DESC_LENGTH
DECL|IMAGE_1_STRING_IDX_MAX|macro|IMAGE_1_STRING_IDX_MAX
DECL|IMAGE_1_UC_IDX_MAX|macro|IMAGE_1_UC_IDX_MAX
...
DECL|bLength|member|u8_t bLength;
DECL|bLength|member|u8_t bLength;
DECL|bString|member|u8_t bString[IMAGE_0_DESC_LENGTH - 2];
DECL|bString|member|u8_t bString[IMAGE_1_DESC_LENGTH - 2];
...
DECL|dfu_mode_desc|variable|dfu_mode_desc
