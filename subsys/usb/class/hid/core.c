DECL|HID_INT_IN_EP_ADDR|macro|HID_INT_IN_EP_ADDR
DECL|HID_INT_IN_EP_IDX|macro|HID_INT_IN_EP_IDX
DECL|HID_INT_OUT_EP_ADDR|macro|HID_INT_OUT_EP_ADDR
...
DECL|hid_int_ep_read|function|int hid_int_ep_read(u8_t *data, u32_t max_data_len, u32_t *ret_bytes)
...
DECL|hid_int_out|function|static void hid_int_out(u8_t ep, enum usb_dc_ep_cb_status_code ep_status)
...
DECL|if0_int_in_ep|member|struct usb_ep_descriptor if0_int_in_ep;
DECL|if0_int_out_ep|member|struct usb_ep_descriptor if0_int_out_ep;
