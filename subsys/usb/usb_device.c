...
DECL|data_buf_len|member|int32_t data_buf_len;
DECL|data_buf_residue|member|int32_t data_buf_residue;
DECL|data_buf|member|uint8_t *data_buf;
DECL|data_store|member|uint8_t *data_store[MAX_NUM_REQ_HANDLERS];
DECL|descriptors|member|const uint8_t *descriptors;
...
DECL|std_req_data|member|uint8_t std_req_data[MAX_STD_REQ_MSG_SIZE];
...
DECL|usb_handle_standard_request|function|static int usb_handle_standard_request(struct usb_setup_packet *setup,int32_t *len, uint8_t **data_buf)
DECL|usb_handle_std_device_req|function|static bool usb_handle_std_device_req(struct usb_setup_packet *setup,int32_t *len, uint8_t **data_buf)
DECL|usb_handle_std_endpoint_req|function|static bool usb_handle_std_endpoint_req(struct usb_setup_packet *setup,int32_t *len, uint8_t **data_buf)
DECL|usb_handle_std_interface_req|function|static bool usb_handle_std_interface_req(struct usb_setup_packet *setup,int32_t *len, uint8_t **data_buf)
DECL|usb_print_setup|function|static void usb_print_setup(struct usb_setup_packet *setup)
DECL|usb_read|function|int usb_read(uint8_t ep, uint8_t *data, uint32_t max_data_len,uint32_t *ret_bytes)
DECL|usb_register_custom_req_handler|function|static void usb_register_custom_req_handler(usb_request_handler handler)
DECL|usb_register_descriptors|function|static void usb_register_descriptors(const uint8_t *usb_descriptors)
DECL|usb_register_request_handler|function|static void usb_register_request_handler(int32_t type,usb_request_handler handler, uint8_t *data_store)
DECL|usb_register_status_callback|function|static void usb_register_status_callback(usb_status_callback cb)
DECL|usb_set_configuration|function|static bool usb_set_configuration(uint8_t config_index, uint8_t alt_setting)
...
DECL|usb_write|function|int usb_write(uint8_t ep, const uint8_t *data, uint32_t data_len,uint32_t *bytes_ret)
