...
DECL|acl|macro|acl
DECL|ad_has_name|function|static inline bool ad_has_name(const struct bt_data *ad, size_t ad_len)
...
DECL|bt_le_adv_start_internal|function|int bt_le_adv_start_internal(const struct bt_le_adv_param *param, const struct bt_data *ad, size_t ad_len, const struct bt_data *sd, size_t sd_len, const bt_addr_le_t *peer)
...
DECL|find_pending_connect|function|static struct bt_conn *find_pending_connect(bt_addr_le_t *peer_addr)
...
DECL|valid_adv_param|function|static bool valid_adv_param(const struct bt_le_adv_param *param, bool dir_adv)
