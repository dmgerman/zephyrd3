...
DECL|at_cmd_get_value|function|static int at_cmd_get_value(struct at_client *at, struct net_buf *buf, const char *prefix, parse_val_t func)
DECL|at_cmd_process_value|function|static int at_cmd_process_value(struct at_client *at, struct net_buf *buf,const char *prefix, parse_val_t func)
DECL|at_cmd_start|function|static int at_cmd_start(struct at_client *at, struct net_buf *buf,const char *prefix, parse_val_t func)
DECL|at_cmd_state_end_lf|function|static int at_cmd_state_end_lf(struct at_client *at, struct net_buf *buf, const char *prefix, parse_val_t func)
