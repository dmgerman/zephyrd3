...
DECL|bt_smp_create_rpa|function|int bt_smp_create_rpa(const u8_t irk[16], bt_addr_t *rpa)
DECL|bt_smp_create_rpa|function|int bt_smp_create_rpa(const u8_t irk[16], bt_addr_t *rpa)
...
DECL|bt_smp_irk_matches|function|bool bt_smp_irk_matches(const u8_t irk[16], const bt_addr_t *addr)
...
DECL|smp_ah|function|static int smp_ah(const u8_t irk[16], const u8_t r[3], u8_t out[3])
