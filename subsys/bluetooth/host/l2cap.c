...
DECL|bt_l2cap_chan_recv_complete|function|int bt_l2cap_chan_recv_complete(struct bt_l2cap_chan *chan, struct net_buf *buf)
...
DECL|l2cap_alloc_frag|function|static struct net_buf *l2cap_alloc_frag(s32_t timeout, void *user_data)
...
DECL|l2cap_chan_le_recv_sdu|function|static void l2cap_chan_le_recv_sdu(struct bt_l2cap_le_chan *chan, struct net_buf *buf, u16_t seg)
DECL|l2cap_chan_le_recv_seg|function|static void l2cap_chan_le_recv_seg(struct bt_l2cap_le_chan *chan, struct net_buf *buf)
...
DECL|l2cap_chan_send_credits|function|static void l2cap_chan_send_credits(struct bt_l2cap_le_chan *chan, struct net_buf *buf, u16_t credits)
