...
DECL|bt_l2cap_create_rsp|function|struct net_buf *bt_l2cap_create_rsp(struct net_buf *buf, size_t reserve)
...
DECL|l2cap_create_le_sig_pdu|function|static struct net_buf *l2cap_create_le_sig_pdu(struct net_buf *buf, uint8_t code, uint8_t ident, uint16_t len)
