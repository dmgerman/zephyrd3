...
DECL|gatt_find_info_rsp|function|static void gatt_find_info_rsp(struct bt_conn *conn, uint8_t err, const void *pdu, uint16_t length, void *user_data)
DECL|gatt_find_info|function|static int gatt_find_info(struct bt_conn *conn, struct bt_gatt_discover_params *params)
DECL|gatt_find_type_rsp|function|static void gatt_find_type_rsp(struct bt_conn *conn, uint8_t err, const void *pdu, uint16_t length, void *user_data)
...
DECL|gatt_notify|function|static int gatt_notify(struct bt_conn *conn, uint16_t handle, const void *data, size_t len)
DECL|gatt_prepare_write_rsp|function|static void gatt_prepare_write_rsp(struct bt_conn *conn, uint8_t err, const void *pdu, uint16_t length, void *user_data)
...
DECL|gatt_read_multiple_rsp|function|static void gatt_read_multiple_rsp(struct bt_conn *conn, uint8_t err, const void *pdu, uint16_t length, void *user_data)
DECL|gatt_read_multiple|function|static int gatt_read_multiple(struct bt_conn *conn, struct bt_gatt_read_params *params)
DECL|gatt_read_rsp|function|static void gatt_read_rsp(struct bt_conn *conn, uint8_t err, const void *pdu, uint16_t length, void *user_data)
DECL|gatt_read_type_rsp|function|static void gatt_read_type_rsp(struct bt_conn *conn, uint8_t err, const void *pdu, uint16_t length, void *user_data)
