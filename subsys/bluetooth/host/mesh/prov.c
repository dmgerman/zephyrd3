...
DECL|ack_complete|function|static void ack_complete(struct net_buf *buf, int err)
...
DECL|bt_mesh_prov_init|function|void bt_mesh_prov_init(const struct bt_mesh_prov *prov_info)
