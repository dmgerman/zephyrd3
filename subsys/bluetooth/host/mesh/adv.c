...
DECL|adv_send_end|function|static inline void adv_send_end(int err, const struct bt_mesh_adv_cb *cb,void *cb_data)
DECL|adv_send_start|function|static inline void adv_send_start(u16_t duration, int err, const struct bt_mesh_adv_cb *cb, void *cb_data)
...
DECL|bt_mesh_adv_send|function|void bt_mesh_adv_send(struct net_buf *buf, const struct bt_mesh_adv_cb *cb, void *cb_data)
