...
DECL|bt_mesh_net_resend|function|int bt_mesh_net_resend(struct bt_mesh_subnet *sub, struct net_buf *buf, bool new_key, bt_mesh_adv_func_t cb, void *user_data)
DECL|bt_mesh_net_revoke_keys|function|void bt_mesh_net_revoke_keys(struct bt_mesh_subnet *sub)
DECL|bt_mesh_net_send|function|int bt_mesh_net_send(struct bt_mesh_net_tx *tx, struct net_buf *buf, bt_mesh_adv_func_t cb, void *user_data)
