...
DECL|friend_req_sent|function|static void friend_req_sent(struct net_buf *buf, u16_t duration, int err, void *user_data)
...
DECL|req_sent|function|static void req_sent(struct net_buf *buf, u16_t duration, int err, void *user_data)
