...
DECL|POLL_TIMEOUT|macro|POLL_TIMEOUT
...
DECL|friend_clear_sent|function|static void friend_clear_sent(struct net_buf *buf, int err)
DECL|friend_req_sent|function|static void friend_req_sent(struct net_buf *buf, int err)
