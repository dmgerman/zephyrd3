...
DECL|POLL_TIMEOUT_INIT|macro|POLL_TIMEOUT_INIT
...
DECL|friend_req_sent_cb|variable|friend_req_sent_cb
DECL|friend_req_sent|function|static void friend_req_sent(u16_t duration, int err, void *user_data)
...
DECL|req_sent_cb|variable|req_sent_cb
DECL|req_sent|function|static void req_sent(u16_t duration, int err, void *user_data)
