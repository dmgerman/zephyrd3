...
DECL|BT_CONN_CONNECT_DIR_ADV|enumerator|BT_CONN_CONNECT_DIR_ADV,
...
DECL|BT_CONN_SLAVE_PARAM_SET|enumerator|BT_CONN_SLAVE_PARAM_SET, /* If slave param were set from app */
DECL|BT_CONN_SLAVE_PARAM_UPDATE|enumerator|BT_CONN_SLAVE_PARAM_UPDATE, /* If slave param update timer fired */
