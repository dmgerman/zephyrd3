...
DECL|cmd_l2cap|function|static void cmd_l2cap(const struct shell *shell, size_t argc, char **argv)
DECL|cmd_metrics|function|static void cmd_metrics(const struct shell *shell, size_t argc, char *argv[])
DECL|cmd_recv|function|static void cmd_recv(const struct shell *shell, size_t argc, char *argv[])
