...
DECL|cmd_bredr_connectable|function|static void cmd_bredr_connectable(const struct shell *shell, size_t argc, char *argv[])
DECL|cmd_bredr_discoverable|function|static void cmd_bredr_discoverable(const struct shell *shell, size_t argc, char *argv[])
DECL|cmd_bredr_discovery|function|static void cmd_bredr_discovery(const struct shell *shell,size_t argc, char *argv[])
DECL|cmd_bredr_l2cap_register|function|static void cmd_bredr_l2cap_register(const struct shell *shell, size_t argc, char *argv[])
DECL|cmd_bredr_oob|function|static void cmd_bredr_oob(const struct shell *shell, size_t argc, char *argv[])
DECL|cmd_bredr_rfcomm_register|function|static void cmd_bredr_rfcomm_register(const struct shell *shell, size_t argc, char *argv[])
DECL|cmd_bredr_sdp_find_record|function|static void cmd_bredr_sdp_find_record(const struct shell *shell, size_t argc, char *argv[])
...
DECL|cmd_connect_bredr|function|static void cmd_connect_bredr(const struct shell *shell, size_t argc, char *argv[])
