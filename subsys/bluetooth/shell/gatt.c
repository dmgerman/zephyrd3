...
DECL|cmd_gatt_write_signed|function|int cmd_gatt_write_signed(int argc, char *argv[])
DECL|cmd_gatt_write_without_rsp_repeated|function|int cmd_gatt_write_without_rsp_repeated(int argc, char *argv[])
