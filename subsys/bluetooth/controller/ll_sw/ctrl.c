...
DECL|ll_tx_power_get|function|void ll_tx_power_get(s8_t *min, s8_t *max)
DECL|ll_tx_power_level_get|function|u32_t ll_tx_power_level_get(u16_t handle, u8_t type, s8_t *tx_power_level)
