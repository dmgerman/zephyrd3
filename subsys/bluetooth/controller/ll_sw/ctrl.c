...
DECL|ll_chm_get|function|uint32_t ll_chm_get(uint16_t handle, uint8_t *chm)
DECL|ll_chm_update|function|uint32_t ll_chm_update(uint8_t *chm)
DECL|ll_conn_update|function|uint32_t ll_conn_update(uint16_t handle, uint8_t cmd, uint8_t status,uint16_t interval, uint16_t latency, uint16_t timeout)
DECL|ll_connect_disable|function|uint32_t ll_connect_disable(void)
DECL|ll_enc_req_send|function|uint32_t ll_enc_req_send(uint16_t handle, uint8_t *rand, uint8_t *ediv, uint8_t *ltk)
DECL|ll_feature_req_send|function|uint32_t ll_feature_req_send(uint16_t handle)
DECL|ll_filter_add|function|uint32_t ll_filter_add(uint8_t addr_type, uint8_t *addr)
DECL|ll_filter_clear|function|void ll_filter_clear(void)
DECL|ll_filter_remove|function|uint32_t ll_filter_remove(uint8_t addr_type, uint8_t *addr)
DECL|ll_irk_add|function|uint32_t ll_irk_add(uint8_t *irk)
DECL|ll_irk_clear|function|void ll_irk_clear(void)
DECL|ll_length_default_get|function|void ll_length_default_get(uint16_t *max_tx_octets, uint16_t *max_tx_time)
DECL|ll_length_default_set|function|uint32_t ll_length_default_set(uint16_t max_tx_octets, uint16_t max_tx_time)
DECL|ll_length_max_get|function|void ll_length_max_get(uint16_t *max_tx_octets, uint16_t *max_tx_time, uint16_t *max_rx_octets, uint16_t *max_rx_time)
DECL|ll_length_req_send|function|uint32_t ll_length_req_send(uint16_t handle, uint16_t tx_octets)
DECL|ll_reset|function|void ll_reset(void)
DECL|ll_start_enc_req_send|function|uint32_t ll_start_enc_req_send(uint16_t handle, uint8_t error_code, uint8_t const *const ltk)
DECL|ll_terminate_ind_send|function|uint32_t ll_terminate_ind_send(uint16_t handle, uint8_t reason)
DECL|ll_version_ind_send|function|uint32_t ll_version_ind_send(uint16_t handle)
