...
DECL|curr_rpa|member|bt_addr_t curr_rpa;
...
DECL|ll_rl_crpa_get|function|u32_t ll_rl_crpa_get(bt_addr_le_t *id_addr, bt_addr_t *crpa)
DECL|ll_rl_crpa_set|function|void ll_rl_crpa_set(u8_t id_addr_type, u8_t *id_addr, u8_t rl_idx, u8_t *crpa)
