...
DECL|adv_type|member|u8_t adv_type:4;
...
DECL|interval|member|u16_t interval;
DECL|ll_address_get|function|void ll_address_get(u8_t addr_type, u8_t *bdaddr)
DECL|ll_address_set|function|void ll_address_set(u8_t addr_type, u8_t const *const bdaddr)
