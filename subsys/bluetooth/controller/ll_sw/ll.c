...
DECL|RAND_ISR_THRESHOLD|macro|RAND_ISR_THRESHOLD
DECL|RAND_THREAD_THRESHOLD|macro|RAND_THREAD_THRESHOLD
...
DECL|ll_timeslice_ticker_id_get|function|void ll_timeslice_ticker_id_get(u8_t * const instance_index, u8_t * const user_id)
