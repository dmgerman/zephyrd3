...
DECL|fcb_flash_read|function|int fcb_flash_read(const struct fcb *fcb, const struct flash_sector *sector, off_t off, void *dst, size_t len)
DECL|fcb_flash_write|function|int fcb_flash_write(const struct fcb *fcb, const struct flash_sector *sector, off_t off, const void *src, size_t len)
...
DECL|fcb_init|function|fcb_init(int f_area_id, struct fcb *fcb)
