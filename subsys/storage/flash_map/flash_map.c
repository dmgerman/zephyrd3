...
DECL|flash_area_get_sectors|function|int flash_area_get_sectors(int idx, uint32_t *cnt, struct flash_sector *ret)
DECL|flash_area_layout|function|static int flash_area_layout(int idx, int *cnt, void *ret,flash_page_cb cb, struct layout_data *cb_data)
