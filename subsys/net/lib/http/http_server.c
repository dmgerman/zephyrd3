...
DECL|http_add_chunk|function|static int http_add_chunk(struct net_pkt *tx, int32_t timeout, const char *str)
DECL|http_add_header|function|static int http_add_header(struct net_pkt *tx, int32_t timeout, const char *str)
