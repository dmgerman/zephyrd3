...
DECL|new_client|function|static inline void new_client(struct http_ctx *ctx, enum http_connection_type type, struct net_app_ctx *app_ctx)
...
DECL|url_connected|function|static void url_connected(struct http_ctx *ctx, enum http_connection_type type)
