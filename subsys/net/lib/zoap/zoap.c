...
DECL|coap_header_get_code|function|uint8_t coap_header_get_code(const struct zoap_packet *zpkt)
DECL|coap_header_get_tkl|function|static uint8_t coap_header_get_tkl(const struct zoap_packet *zpkt)
...
DECL|coap_parse_option|function|static int coap_parse_option(const struct zoap_packet *zpkt, struct option_context *context, uint8_t **value, uint16_t *vlen)
...
DECL|get_block_option|function|static int get_block_option(const struct zoap_packet *zpkt, uint16_t code)
...
DECL|zoap_add_option_int|function|int zoap_add_option_int(struct zoap_packet *zpkt, uint16_t code,unsigned int val)
DECL|zoap_add_option|function|int zoap_add_option(struct zoap_packet *zpkt, uint16_t code, const void *value, uint16_t len)
...
DECL|zoap_find_options|function|int zoap_find_options(const struct zoap_packet *zpkt, uint16_t code, struct zoap_option *options, uint16_t veclen)
...
DECL|zoap_header_get_code|function|uint8_t zoap_header_get_code(const struct zoap_packet *zpkt)
DECL|zoap_header_get_id|function|uint16_t zoap_header_get_id(const struct zoap_packet *zpkt)
DECL|zoap_header_get_token|function|const uint8_t *zoap_header_get_token(const struct zoap_packet *zpkt, uint8_t *len)
DECL|zoap_header_get_type|function|uint8_t zoap_header_get_type(const struct zoap_packet *zpkt)
DECL|zoap_header_get_version|function|uint8_t zoap_header_get_version(const struct zoap_packet *zpkt)
DECL|zoap_header_set_code|function|void zoap_header_set_code(struct zoap_packet *zpkt, uint8_t code)
DECL|zoap_header_set_id|function|void zoap_header_set_id(struct zoap_packet *zpkt, uint16_t id)
DECL|zoap_header_set_token|function|int zoap_header_set_token(struct zoap_packet *zpkt, const uint8_t *token, uint8_t tokenlen)
DECL|zoap_header_set_type|function|void zoap_header_set_type(struct zoap_packet *zpkt, uint8_t type)
DECL|zoap_header_set_version|function|void zoap_header_set_version(struct zoap_packet *zpkt, uint8_t ver)
...
DECL|zoap_packet_get_payload|function|uint8_t *zoap_packet_get_payload(struct zoap_packet *zpkt, uint16_t *len)
...
DECL|zoap_packet_set_used|function|int zoap_packet_set_used(struct zoap_packet *zpkt, uint16_t len)
