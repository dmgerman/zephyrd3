...
DECL|mqtt_pack_subscribe_unsubscribe|function|static int mqtt_pack_subscribe_unsubscribe(uint8_t *buf, uint16_t *length, uint16_t size, uint16_t pkt_id, uint8_t items, const char *topics[], enum mqtt_qos qos[], enum mqtt_packet type)
DECL|mqtt_pack_subscribe|function|int mqtt_pack_subscribe(uint8_t *buf, uint16_t *length, uint16_t size,uint16_t pkt_id, uint8_t items, const char *topics[], enum mqtt_qos qos[])
