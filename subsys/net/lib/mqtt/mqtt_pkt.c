...
DECL|rlen_decode|function|static int rlen_decode(uint32_t *rlen, uint16_t *rlen_size, uint8_t *buf, uint16_t size)
DECL|rlen_encode|function|static int rlen_encode(uint8_t *buf, uint32_t len)
