...
DECL|engine_add_observer|function|static int engine_add_observer(struct net_app_ctx *app_ctx, struct sockaddr *addr, const u8_t *token, u8_t tkl, struct lwm2m_obj_path *path, u16_t format)
...
DECL|handle_request|function|static int handle_request(struct net_app_ctx *app_ctx, struct zoap_packet *request, struct zoap_packet *response, struct sockaddr *from_addr)
...
DECL|lwm2m_udp_sendto|function|int lwm2m_udp_sendto(struct net_app_ctx *app_ctx, struct net_pkt *pkt, const struct sockaddr *dst_addr)
