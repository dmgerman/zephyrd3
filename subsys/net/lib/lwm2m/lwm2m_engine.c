...
DECL|lwm2m_engine_get_bool|function|int lwm2m_engine_get_bool(char *pathstr, bool *value)
...
DECL|lwm2m_engine_get_res_data|function|int lwm2m_engine_get_res_data(char *pathstr, void **data_ptr, u16_t *data_len, u8_t *data_flags)
DECL|lwm2m_engine_get_resource|function|int lwm2m_engine_get_resource(char *pathstr, struct lwm2m_engine_res_inst **res)
DECL|lwm2m_engine_get_s16|function|int lwm2m_engine_get_s16(char *pathstr, s16_t *value)
DECL|lwm2m_engine_get_s32|function|int lwm2m_engine_get_s32(char *pathstr, s32_t *value)
DECL|lwm2m_engine_get_s64|function|int lwm2m_engine_get_s64(char *pathstr, s64_t *value)
DECL|lwm2m_engine_get_s8|function|int lwm2m_engine_get_s8(char *pathstr, s8_t *value)
DECL|lwm2m_engine_get_string|function|int lwm2m_engine_get_string(char *pathstr, void *buf, u16_t buflen)
DECL|lwm2m_engine_get_u16|function|int lwm2m_engine_get_u16(char *pathstr, u16_t *value)
DECL|lwm2m_engine_get_u32|function|int lwm2m_engine_get_u32(char *pathstr, u32_t *value)
DECL|lwm2m_engine_get_u64|function|int lwm2m_engine_get_u64(char *pathstr, u64_t *value)
...
DECL|lwm2m_engine_set_res_data|function|int lwm2m_engine_set_res_data(char *pathstr, void *data_ptr, u16_t data_len, u8_t data_flags)
...
DECL|lwm2m_perform_read_op|function|int lwm2m_perform_read_op(struct lwm2m_engine_obj *obj, struct lwm2m_engine_context *context, u16_t content_format)
