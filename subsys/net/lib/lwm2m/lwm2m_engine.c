...
DECL|engine_add_observer|function|static int engine_add_observer(struct net_app_ctx *app_ctx, const u8_t *token, u8_t tkl, struct lwm2m_obj_path *path, u16_t format)
...
DECL|handle_request|function|static int handle_request(struct net_app_ctx *app_ctx, struct zoap_packet *request, struct zoap_packet *response)
...
DECL|lwm2m_init_message_pending|function|struct zoap_pending *lwm2m_init_message_pending(struct lwm2m_ctx *client_ctx,struct zoap_packet *zpkt)
DECL|lwm2m_init_message|function|int lwm2m_init_message(struct net_app_ctx *app_ctx, struct zoap_packet *zpkt, struct net_pkt **pkt, u8_t type, u8_t code, u16_t mid, const u8_t *token, u8_t tkl)
...
DECL|lwm2m_udp_receive|function|void lwm2m_udp_receive(struct lwm2m_ctx *client_ctx, struct net_pkt *pkt, bool handle_separate_response, int (*udp_request_handler)(struct net_app_ctx *app_ctx, struct zoap_packet *, struct zoap_packet *))
DECL|lwm2m_udp_sendto|function|int lwm2m_udp_sendto(struct net_app_ctx *app_ctx, struct net_pkt *pkt)
