...
DECL|NET_APP_PKT_RX|enumerator|NET_APP_PKT_RX = 2,
DECL|NET_APP_PKT_TX|enumerator|NET_APP_PKT_TX = 1,
DECL|NET_APP_PKT_UNKNOWN|enumerator|NET_APP_PKT_UNKNOWN = 0,
