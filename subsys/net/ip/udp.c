...
DECL|net_udp_append_raw|function|struct net_pkt *net_udp_append_raw(struct net_pkt *pkt, u16_t src_port, u16_t dst_port)
DECL|net_udp_append|function|struct net_pkt *net_udp_append(struct net_context *context, struct net_pkt *pkt, u16_t port)
...
DECL|net_udp_init|function|void net_udp_init(void)
DECL|net_udp_insert_raw|function|struct net_pkt *net_udp_insert_raw(struct net_pkt *pkt, u16_t offset, u16_t src_port, u16_t dst_port)
DECL|net_udp_insert|function|struct net_pkt *net_udp_insert(struct net_context *context, struct net_pkt *pkt, u16_t offset, u16_t port)
