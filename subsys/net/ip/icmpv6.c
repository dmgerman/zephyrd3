...
DECL|net_icmpv6_get_hdr|function|struct net_icmp_hdr *net_icmpv6_get_hdr(struct net_pkt *pkt,struct net_icmp_hdr *hdr)
DECL|net_icmpv6_get_na_hdr|function|struct net_icmpv6_na_hdr *net_icmpv6_get_na_hdr(struct net_pkt *pkt,struct net_icmpv6_na_hdr *hdr)
DECL|net_icmpv6_get_nd_opt_hdr|function|struct net_icmpv6_nd_opt_hdr *net_icmpv6_get_nd_opt_hdr(struct net_pkt *pkt, struct net_icmpv6_nd_opt_hdr *hdr)
DECL|net_icmpv6_get_ns_hdr|function|struct net_icmpv6_ns_hdr *net_icmpv6_get_ns_hdr(struct net_pkt *pkt,struct net_icmpv6_ns_hdr *hdr)
DECL|net_icmpv6_get_ra_hdr|function|struct net_icmpv6_ra_hdr *net_icmpv6_get_ra_hdr(struct net_pkt *pkt,struct net_icmpv6_ra_hdr *hdr)
...
DECL|net_icmpv6_set_chksum|function|struct net_buf *net_icmpv6_set_chksum(struct net_pkt *pkt, struct net_buf *frag)
DECL|net_icmpv6_set_hdr|function|struct net_icmp_hdr *net_icmpv6_set_hdr(struct net_pkt *pkt,struct net_icmp_hdr *hdr)
DECL|net_icmpv6_set_na_hdr|function|struct net_icmpv6_na_hdr *net_icmpv6_set_na_hdr(struct net_pkt *pkt,struct net_icmpv6_na_hdr *hdr)
DECL|net_icmpv6_set_ns_hdr|function|struct net_icmpv6_ns_hdr *net_icmpv6_set_ns_hdr(struct net_pkt *pkt,struct net_icmpv6_ns_hdr *hdr)
