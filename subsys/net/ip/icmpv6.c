...
DECL|net_icmpv6_input|function|enum net_verdict net_icmpv6_input(struct net_pkt *pkt, uint8_t type, uint8_t code)
...
DECL|net_icmpv6_send_error|function|int net_icmpv6_send_error(struct net_pkt *orig, uint8_t type, uint8_t code, uint32_t param)
...
DECL|setup_ipv6_header|function|static inline void setup_ipv6_header(struct net_pkt *pkt, uint16_t extra_len, uint8_t hop_limit, uint8_t icmp_type, uint8_t icmp_code)
