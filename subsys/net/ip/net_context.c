...
DECL|net_context_sendto|function|int net_context_sendto(struct net_pkt *pkt, const struct sockaddr *dst_addr, socklen_t addrlen, net_context_send_cb_t cb, int32_t timeout,
DECL|net_context_send|function|int net_context_send(struct net_pkt *pkt, net_context_send_cb_t cb, int32_t timeout, void *token, void *user_data)
...
DECL|send_data|function|static int send_data(struct net_context *context, struct net_pkt *pkt, net_context_send_cb_t cb, int32_t timeout, void *token,
...
DECL|sendto|function|static int sendto(struct net_pkt *pkt, const struct sockaddr *dst_addr, socklen_t addrlen, net_context_send_cb_t cb, int32_t timeout,
