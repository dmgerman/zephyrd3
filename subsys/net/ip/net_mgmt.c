...
DECL|mgmt_event_wait_call|function|static int mgmt_event_wait_call(struct net_if *iface,u32_t mgmt_event_mask, u32_t *raised_event, struct net_if **event_iface, int timeout)
...
DECL|net_mgmt_event_notify|function|void net_mgmt_event_notify(u32_t mgmt_event, struct net_if *iface)
DECL|net_mgmt_event_wait_on_iface|function|int net_mgmt_event_wait_on_iface(struct net_if *iface, u32_t mgmt_event_mask, u32_t *raised_event, int timeout)
DECL|net_mgmt_event_wait|function|int net_mgmt_event_wait(u32_t mgmt_event_mask,u32_t *raised_event, struct net_if **iface, int timeout)
