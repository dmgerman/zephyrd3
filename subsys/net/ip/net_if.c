...
DECL|net_if_init|function|void net_if_init(struct k_sem *startup_sync)
...
DECL|net_if_tx_thread|function|static void net_if_tx_thread(struct k_sem *startup_sync)
