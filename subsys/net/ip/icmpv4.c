...
DECL|net_icmpv4_input|function|enum net_verdict net_icmpv4_input(struct net_pkt *pkt, uint8_t type, uint8_t code)
...
DECL|net_icmpv4_send_error|function|int net_icmpv4_send_error(struct net_pkt *orig, uint8_t type, uint8_t code)
DECL|net_icmpv4_unregister_handler|function|void net_icmpv4_unregister_handler(struct net_icmpv4_handler *handler)
DECL|setup_ipv4_header|function|static inline void setup_ipv4_header(struct net_pkt *pkt, uint8_t extra_len, uint8_t ttl, uint8_t icmp_type, uint8_t icmp_code)
