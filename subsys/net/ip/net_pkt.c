...
DECL|net_pkt_append_bytes|function|static inline bool net_pkt_append_bytes(struct net_pkt *pkt,const u8_t *value, u16_t len, s32_t timeout)
DECL|net_pkt_append|function|bool net_pkt_append(struct net_pkt *pkt, u16_t len, const u8_t *data, s32_t timeout)
...
DECL|net_pkt_split|function|int net_pkt_split(struct net_pkt *pkt, struct net_buf *orig_frag, u16_t len, struct net_buf **fragA, struct net_buf **fragB, s32_t timeout)
