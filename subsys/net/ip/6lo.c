...
DECL|compress_da_ctx|function|static inline uint8_t compress_da_ctx(struct net_ipv6_hdr *ipv6, struct net_buf *buf, struct net_buf *frag, uint8_t offset, struct net_6lo_context *dst)
DECL|compress_da_mcast|function|static inline uint8_t compress_da_mcast(struct net_ipv6_hdr *ipv6,struct net_buf *buf, struct net_buf *frag, uint8_t offset)
...
DECL|compress_sa_ctx|function|static inline uint8_t compress_sa_ctx(struct net_ipv6_hdr *ipv6, struct net_buf *buf, struct net_buf *frag, uint8_t offset, struct net_6lo_context *src)
...
DECL|is_src_and_dst_addr_ctx_based|function|static inline bool is_src_and_dst_addr_ctx_based(struct net_ipv6_hdr *ipv6, struct net_buf *buf, struct net_buf *frag, struct net_6lo_context **src, struct net_6lo_context **dst)
...
DECL|uncompress_cid|function|static inline bool uncompress_cid(struct net_buf *buf, struct net_6lo_context **src, struct net_6lo_context **dst)
DECL|uncompress_da_ctx|function|static inline uint8_t uncompress_da_ctx(struct net_buf *buf,struct net_ipv6_hdr *ipv6, uint8_t offset, struct net_6lo_context *ctx)
DECL|uncompress_da_mcast|function|static inline uint8_t uncompress_da_mcast(struct net_buf *buf, struct net_ipv6_hdr *ipv6, uint8_t offset)
...
DECL|uncompress_sa_ctx|function|static inline uint8_t uncompress_sa_ctx(struct net_buf *buf,struct net_ipv6_hdr *ipv6, uint8_t offset, struct net_6lo_context *ctx)
