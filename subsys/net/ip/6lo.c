...
DECL|compress_da_ctx|function|static inline uint8_t compress_da_ctx(struct net_ipv6_hdr *ipv6, struct net_pkt *pkt, struct net_buf *frag, uint8_t offset, struct net_6lo_context *dst)
DECL|compress_da_mcast|function|static inline uint8_t compress_da_mcast(struct net_ipv6_hdr *ipv6,struct net_pkt *pkt, struct net_buf *frag, uint8_t offset)
DECL|compress_da|function|static inline uint8_t compress_da(struct net_ipv6_hdr *ipv6, struct net_pkt *pkt, struct net_buf *frag, uint8_t offset)
...
DECL|compress_sa_ctx|function|static inline uint8_t compress_sa_ctx(struct net_ipv6_hdr *ipv6, struct net_pkt *pkt, struct net_buf *frag, uint8_t offset, struct net_6lo_context *src)
DECL|compress_sa|function|static inline uint8_t compress_sa(struct net_ipv6_hdr *ipv6, struct net_pkt *pkt, struct net_buf *frag, uint8_t offset)
...
DECL|get_6lo_context_by_cid|function|get_6lo_context_by_cid(struct net_if *iface, uint8_t cid)
...
DECL|uncompress_da_ctx|function|static inline uint8_t uncompress_da_ctx(struct net_pkt *pkt,struct net_ipv6_hdr *ipv6, uint8_t offset, struct net_6lo_context *ctx)
DECL|uncompress_da_mcast|function|static inline uint8_t uncompress_da_mcast(struct net_pkt *pkt, struct net_ipv6_hdr *ipv6, uint8_t offset)
DECL|uncompress_da|function|static inline uint8_t uncompress_da(struct net_pkt *pkt, struct net_ipv6_hdr *ipv6, uint8_t offset)
DECL|uncompress_hoplimit|function|static inline uint8_t uncompress_hoplimit(struct net_pkt *pkt, struct net_ipv6_hdr *ipv6, uint8_t offset)
DECL|uncompress_ipv6_header|function|static inline bool uncompress_ipv6_header(struct net_pkt *pkt)
DECL|uncompress_nh_udp|function|static inline uint8_t uncompress_nh_udp(struct net_pkt *pkt,struct net_udp_hdr *udp, uint8_t offset)
DECL|uncompress_sa_ctx|function|static inline uint8_t uncompress_sa_ctx(struct net_pkt *pkt,struct net_ipv6_hdr *ipv6, uint8_t offset, struct net_6lo_context *ctx)
DECL|uncompress_sa|function|static inline uint8_t uncompress_sa(struct net_pkt *pkt, struct net_ipv6_hdr *ipv6, uint8_t offset)
DECL|uncompress_tfl|function|static inline uint8_t uncompress_tfl(struct net_pkt *pkt, struct net_ipv6_hdr *ipv6, uint8_t offset)
