DECL|net_calc_chksum_icmpv4|function|static inline uint16_t net_calc_chksum_icmpv4(struct net_pkt *pkt)
DECL|net_calc_chksum_icmpv6|function|static inline uint16_t net_calc_chksum_icmpv6(struct net_pkt *pkt)
DECL|net_calc_chksum_tcp|function|static inline uint16_t net_calc_chksum_tcp(struct net_pkt *pkt)
DECL|net_calc_chksum_udp|function|static inline uint16_t net_calc_chksum_udp(struct net_pkt *pkt)
DECL|net_hexdump_frags|function|static inline void net_hexdump_frags(const char *str, struct net_pkt *pkt)
...
DECL|net_sprint_ipv6_addr|function|static inline char *net_sprint_ipv6_addr(const struct in6_addr *addr)
DECL|net_sprint_ll_addr|function|static inline char *net_sprint_ll_addr(const uint8_t *ll, uint8_t ll_len)
DECL|net_sprint_ll_addr|function|static inline char *net_sprint_ll_addr(const uint8_t *ll, uint8_t ll_len)
