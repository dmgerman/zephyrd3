...
DECL|add_rpl_opt|function|static inline int add_rpl_opt(struct net_pkt *pkt, uint16_t offset)
...
DECL|forwarding_dao|function|static int forwarding_dao(struct net_rpl_instance *instance, struct net_rpl_dag *dag, struct net_pkt *pkt, uint8_t sequence, uint8_t flags,
...
DECL|net_rpl_alloc_instance|function|static struct net_rpl_instance *net_rpl_alloc_instance(uint8_t instance_id)
...
DECL|net_rpl_dao_info|macro|net_rpl_dao_info
DECL|net_rpl_dao_send|function|int net_rpl_dao_send(struct net_if *iface, struct net_rpl_parent *parent, struct in6_addr *prefix, uint8_t lifetime)
...
DECL|net_rpl_revert_header|function|int net_rpl_revert_header(struct net_pkt *pkt, uint16_t offset, uint16_t *pos)
...
DECL|net_rpl_verify_header|function|struct net_buf *net_rpl_verify_header(struct net_pkt *pkt, struct net_buf *frag, uint16_t offset, uint16_t *pos, bool *result)
...
DECL|setup_icmpv6_hdr|function|static inline void setup_icmpv6_hdr(struct net_pkt *pkt, uint8_t type, uint8_t code)
