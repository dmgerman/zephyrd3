...
DECL|forwarding_dao|function|static int forwarding_dao(struct net_rpl_instance *instance, struct net_rpl_dag *dag, struct net_buf *buf, uint8_t sequence, uint8_t flags,
...
DECL|handle_dao_ack|function|static enum net_verdict handle_dao_ack(struct net_buf *buf)
DECL|handle_dao|function|static enum net_verdict handle_dao(struct net_buf *buf)
DECL|handle_dio|function|static enum net_verdict handle_dio(struct net_buf *buf)
DECL|handle_dis|function|static enum net_verdict handle_dis(struct net_buf *buf)
...
DECL|send_mcast_dao|function|static void send_mcast_dao(struct net_route_entry_mcast *route, void *user_data)
