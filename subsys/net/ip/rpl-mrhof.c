...
DECL|net_rpl_mrhof_calc_rank|function|static uint16_t net_rpl_mrhof_calc_rank(struct net_rpl_parent *parent,uint16_t base_rank)
DECL|net_rpl_mrhof_calc_rank|variable|net_rpl_mrhof_calc_rank
DECL|net_rpl_mrhof_find|function|static bool net_rpl_mrhof_find(uint16_t ocp)
DECL|net_rpl_mrhof_find|variable|net_rpl_mrhof_find
DECL|net_rpl_mrhof_get|function|static uint16_t net_rpl_mrhof_get(void)
