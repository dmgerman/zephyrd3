...
DECL|net_rpl_of0_reset|function|static void net_rpl_of0_reset(struct net_rpl_dag *dag)
DECL|net_rpl_of0_reset|variable|net_rpl_of0_reset
DECL|net_rpl_of0_update_mc|function|static int net_rpl_of0_update_mc(struct net_rpl_instance *instance)
DECL|net_rpl_of0_update_mc|variable|net_rpl_of0_update_mc
