...
DECL|cfi|member|uint8_t cfi;
DECL|channel_page|member|uint8_t channel_page; /* Optional */
...
DECL|dev_type|member|uint8_t dev_type : 1;
...
DECL|power_src|member|uint8_t power_src : 1;
