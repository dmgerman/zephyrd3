...
DECL|calc_max_payload|function|static inline uint8_t calc_max_payload(struct net_pkt *pkt, struct net_buf *frag, uint8_t offset)
...
DECL|copy_frag|function|static inline bool copy_frag(struct net_pkt *pkt, struct net_buf *frag, uint16_t offset)
...
DECL|prepare_new_fragment|function|static inline struct net_buf *prepare_new_fragment(struct net_pkt *pkt, uint8_t offset)
...
DECL|set_reass_cache|function|static inline struct frag_cache *set_reass_cache(struct net_pkt *pkt, uint16_t size, uint16_t tag)
DECL|set_up_frag_hdr|function|static inline void set_up_frag_hdr(struct net_buf *frag, uint16_t size, uint8_t offset)
...
DECL|update_protocol_header_lengths|function|static void update_protocol_header_lengths(struct net_pkt *pkt, uint16_t size)
