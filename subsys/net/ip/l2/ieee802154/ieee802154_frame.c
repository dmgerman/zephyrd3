...
DECL|data_addr_to_fs_settings|function|void data_addr_to_fs_settings(struct net_if *iface, struct in6_addr *dst, struct ieee802154_fcf_seq *fs, struct ieee802154_frame_params *params)
...
DECL|get_dst_addr_mode|function|get_dst_addr_mode(struct net_if *iface, struct in6_addr *dst, struct net_nbr **nbr, bool *broadcast)
...
DECL|ieee802154_create_data_frame|function|bool ieee802154_create_data_frame(struct net_if *iface, struct in6_addr *dst, uint8_t *p_buf, uint8_t len)
