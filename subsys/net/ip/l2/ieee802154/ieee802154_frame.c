...
DECL|data_addr_to_fs_settings|function|void data_addr_to_fs_settings(struct net_if *iface, struct net_linkaddr *dst, struct ieee802154_fcf_seq *fs, struct ieee802154_frame_params *params)
