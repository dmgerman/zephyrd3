...
DECL|_printk_dec_ulong|function|static void _printk_dec_ulong(const unsigned long num, int pad_zero, int min_width)
DECL|_printk_hex_ulong|function|static void _printk_hex_ulong(const unsigned long num, int pad_zero, int min_width)
