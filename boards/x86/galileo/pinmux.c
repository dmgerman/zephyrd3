...
DECL|_galileo_pinmux_get_pin|function|int _galileo_pinmux_get_pin(struct device *port, u32_t pin, u32_t *func)
DECL|_galileo_pinmux_set_pin|function|int _galileo_pinmux_set_pin(struct device *port, u8_t pin, u32_t func)
DECL|api_funcs|variable|api_funcs
DECL|cfg|member|u32_t cfg;
DECL|func|member|u8_t func;
DECL|galileo_pinmux_driver|variable|galileo_pinmux_driver
DECL|gpio_chip|enum|enum gpio_chip {
DECL|io_pin|member|u8_t io_pin;
...
DECL|pinmux_input_enable|function|static int pinmux_input_enable(struct device *dev, u32_t pin, u8_t func)
DECL|pinmux_pullup|function|static int pinmux_pullup(struct device *dev, u32_t pin, u8_t func)
DECL|pinmux_set|function|static int pinmux_set(struct device *dev,u32_t pin, u32_t func)
