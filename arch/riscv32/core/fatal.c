...
DECL|_SysFatalErrorHandler|function|FUNC_NORETURN __weak void _SysFatalErrorHandler(unsigned int reason,const NANO_ESF *esf)
DECL|_default_esf|variable|_default_esf
DECL|cause_str|function|static char *cause_str(u32_t cause)
