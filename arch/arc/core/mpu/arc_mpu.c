...
DECL|_region_init|function|static inline void _region_init(u32_t index, u32_t region_addr, u32_t region_attr)
...
DECL|arc_core_mpu_region|function|void arc_core_mpu_region(u32_t index, u32_t base, u32_t region_attr)
