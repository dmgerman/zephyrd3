DECL|_new_thread|function|void _new_thread(struct k_thread *thread, k_thread_stack_t stack, size_t stack_size, _thread_entry_t entry, void *parameter1, void *parameter2, void *parameter3, int priority, unsigned int options)
...
DECL|entry|member|_thread_entry_t entry;
