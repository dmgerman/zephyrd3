DECL|CCFG_SIZE|macro|CCFG_SIZE
DECL|bit_is_set|function|int bit_is_set(u32_t reg, u8_t bit)
DECL|clkloadctl|variable|clkloadctl
...
DECL|uartclkgr|variable|uartclkgr
