...
DECL|__func_to_ospeed|function|static uint32_t __func_to_ospeed(int func)
DECL|__func_to_otype|function|static uint32_t __func_to_otype(int func)
DECL|__func_to_pupd|function|static uint32_t __func_to_pupd(int func)
