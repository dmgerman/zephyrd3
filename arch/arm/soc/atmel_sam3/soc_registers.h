...
DECL|absr|member|u32_t absr; /* 0x70 Peripheral AB Select */
...
DECL|cwgr|member|u32_t cwgr; /* 0x10 Clock Waveform Generator */
...
DECL|iadr|member|u32_t iadr; /* 0x0C Internal Address */
DECL|idr|member|u32_t idr; /* 0x28 Interrupt Disable */
DECL|idr|member|u32_t idr; /* 0x44 Interrupt Disable */
DECL|idr|member|u32_t idr; /* 0x64 Interrupt Disable */
DECL|ier|member|u32_t ier; /* 0x24 Interrupt Enable */
...
DECL|imr|member|u32_t imr; /* 0x2C Interrupt Mask */
...
DECL|mmr|member|u32_t mmr; /* 0x04 Master Mode */
...
DECL|ptcr|member|u32_t ptcr; /* 0x120 Transfer Control */
DECL|ptsr|member|u32_t ptsr; /* 0x124 Transfer Status */
...
DECL|rcr|member|u32_t rcr; /* 0x104 Receive Counter */
...
DECL|res1|member|u32_t res1; /* 0x2C reserved */
...
DECL|res5|member|u32_t res5[3]; /* 0x74-0x7C reserved */
...
DECL|rev0|member|u32_t rev0[3]; /* 0x14-0x1C reserved */
DECL|rev1|member|u32_t rev1[50]; /* 0x38-0xFC Reserved */
DECL|rhr|member|u32_t rhr; /* 0x30 Receive Holding */
DECL|rncr|member|u32_t rncr; /* 0x114 Receive Next Counter */
DECL|rnpr|member|u32_t rnpr; /* 0x110 Receive Next Pointer */
DECL|rpr|member|u32_t rpr; /* 0x100 Receive Pointer */
...
DECL|smr|member|u32_t smr; /* 0x08 Slave Mode */
...
DECL|sr|member|u32_t sr; /* 0x20 Status */
DECL|sr|member|u32_t sr; /* 0x68 Status */
DECL|tcr|member|u32_t tcr; /* 0x10C Transmit Counter */
DECL|thr|member|u32_t thr; /* 0x34 Transmit Holding */
DECL|tncr|member|u32_t tncr; /* 0x11C Transmit Next Counter */
DECL|tnpr|member|u32_t tnpr; /* 0x118 Transmit Next Pointer */
DECL|tpr|member|u32_t tpr; /* 0x108 Transmit Pointer */
