...
DECL|dns_msg_pack_qname|function|int dns_msg_pack_qname(uint16_t *len, uint8_t *buf, uint16_t size, char *domain_name)
...
DECL|dns_strlen|function|uint16_t dns_strlen(char *str)
...
DECL|set_dns_msg_response|function|void set_dns_msg_response(struct dns_msg_t *dns_msg, int type, uint16_t pos, uint16_t len)
