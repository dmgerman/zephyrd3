...
DECL|osSignalSet|function|int32_t osSignalSet(osThreadId thread_id, int32_t signals)
DECL|osSignalWait|function|osEvent osSignalWait(int32_t signals, uint32_t millisec)
