...
DECL|_k_timer_alloc|function|struct k_timer *_k_timer_alloc(void)
DECL|_k_timer_free|function|void _k_timer_free(struct k_timer *timer)
DECL|_k_timer_pool_is_empty|function|bool _k_timer_pool_is_empty(void)
