DECL|ensure_w_xor_x|function|static void ensure_w_xor_x(k_mem_partition_attr_t attrs)
...
DECL|k_mem_domain_init|function|void k_mem_domain_init(struct k_mem_domain *domain, u32_t num_parts,struct k_mem_partition *parts[])
