...
DECL|_nano_timeout_abort|function|static inline void _nano_timeout_abort(struct ccs *ccs)
DECL|_nano_timeout_add|function|static inline void _nano_timeout_add(struct ccs *ccs,struct _nano_queue *wait_q, int32_t timeout)
DECL|_nano_timeout_ccs_init|function|static inline void _nano_timeout_ccs_init(struct ccs *ccs)
