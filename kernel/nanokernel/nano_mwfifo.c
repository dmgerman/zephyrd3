...
DECL|nano_fifo_get_wait|function|void *nano_fifo_get_wait(struct nano_fifo *chan)
DECL|nano_fifo_init|function|void nano_fifo_init(struct nano_fifo *chan /* channel to initialize */ )
DECL|nano_fifo_put|function|void nano_fifo_put(struct nano_fifo *chan, void *data)
