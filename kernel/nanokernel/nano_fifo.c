...
DECL|_fifo_put_list_non_preemptible|function|void _fifo_put_list_non_preemptible(struct nano_fifo *fifo, void *head, void *tail)
DECL|_fifo_put_non_preemptible|function|void _fifo_put_non_preemptible(struct nano_fifo *fifo, void *data)
DECL|_fifo_put_slist_non_preemptible|function|void _fifo_put_slist_non_preemptible(struct nano_fifo *fifo, sys_slist_t *list)
...
DECL|enqueue_list|function|static void enqueue_list(struct nano_fifo *fifo, void *head, void *tail)
...
DECL|nano_fifo_put_list|function|void nano_fifo_put_list(struct nano_fifo *fifo, void *head, void *tail)
DECL|nano_fifo_put_slist|function|void nano_fifo_put_slist(struct nano_fifo *fifo, sys_slist_t *list)
...
DECL|nano_task_fifo_put_list|function|void nano_task_fifo_put_list(struct nano_fifo *fifo, void *head, void *tail)
DECL|nano_task_fifo_put_slist|function|void nano_task_fifo_put_slist(struct nano_fifo *fifo, sys_slist_t *list)
