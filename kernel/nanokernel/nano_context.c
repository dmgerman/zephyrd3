...
DECL|_thread_monitor_exit|function|void _thread_monitor_exit(struct tcs *thread)
DECL|sys_execution_context_type_get|function|nano_context_type_t sys_execution_context_type_get(void)
DECL|sys_thread_busy_wait|function|void sys_thread_busy_wait(uint32_t usec_to_wait)
