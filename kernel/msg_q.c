DECL|_SYSCALL_HANDLER3|function|_SYSCALL_HANDLER3(k_msgq_get, msgq_p, data, timeout)
DECL|_SYSCALL_HANDLER3|function|_SYSCALL_HANDLER3(k_msgq_put, msgq_p, data, timeout)
DECL|_SYSCALL_HANDLER4|function|_SYSCALL_HANDLER4(k_msgq_init, q, buffer, msg_size, max_msgs)
