...
DECL|BuffGetAvailData|function|void BuffGetAvailData(struct _k_pipe_desc *desc, int *piAvailDataTotal, int *available_data_count_ptr, int *piAvailDataAWA)
...
DECL|CalcAvailData|function|int CalcAvailData(struct _k_pipe_desc *desc, int *available_data_count_ptr, int *piAvailDataAWA)
