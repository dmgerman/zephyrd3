...
DECL|BuffGetFreeSpace|function|void BuffGetFreeSpace(struct _k_pipe_desc *desc, int *piFreeSpaceTotal, int *free_space_count_ptr, int *piFreeSpaceAWA)
...
DECL|CalcFreeSpace|function|int CalcFreeSpace(struct _k_pipe_desc *desc, int *free_space_count_ptr, int *piFreeSpaceAWA)
