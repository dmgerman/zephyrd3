DECL|K_recvack|function|void K_recvack(struct k_args *pCopyReader)
...
DECL|K_sendack|function|void K_sendack(struct k_args *pCopyWriter)
DECL|K_senddata|function|void K_senddata(struct k_args *Starter)
DECL|K_sendreq|function|void K_sendreq(struct k_args *Writer)
DECL|K_sendrpl|function|void K_sendrpl(struct k_args *pCopyWriter)
