...
DECL|task_irq_alloc|function|uint32_t task_irq_alloc(kirq_t irq_obj, uint32_t irq, uint32_t priority)
DECL|task_irq_free|function|void task_irq_free(kirq_t irq_obj)
