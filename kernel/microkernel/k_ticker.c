...
DECL|_sys_clock_tick_announce_install|function|static int _sys_clock_tick_announce_install(struct device *dev)
DECL|_sys_clock_tick_announce_pre_micro_nop|function|static void _sys_clock_tick_announce_pre_micro_nop(kevent_t e)
