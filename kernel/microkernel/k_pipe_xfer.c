...
DECL|pipe_xfer_status_update|function|static void pipe_xfer_status_update(struct k_args *pActor, /* ptr to struct k_args to be used by actor */ struct k_chproc *pActorArgs, /* ptr to actor's channel process structure */ int bytesXferred /* # of bytes transferred */ )
