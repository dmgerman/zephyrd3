...
DECL|pipe_read_write|function|static void pipe_read_write(struct pipe_struct *pPipe, /* ptr to pipe structure */ struct k_args *pNewWriter, /* ptr to new writer struct k_args */ struct k_args *pNewReader /* ptr to new reader struct k_args */ )
