...
DECL|ReaderInProgressIsBlocked|function|static int ReaderInProgressIsBlocked(struct _k_pipe_struct *pipe_ptr, struct k_args *pReader)
...
DECL|move_priority_compute|function|static kpriority_t move_priority_compute(struct k_args *writer_ptr, struct k_args *pReader)
DECL|pipe_read_write|function|static void pipe_read_write(struct _k_pipe_struct *pipe_ptr, /* ptr to pipe structure */ struct k_args *pNewWriter, /* ptr to new writer struct k_args */ struct k_args *pNewReader /* ptr to new reader struct k_args */ )
...
DECL|setup_movedata|function|static void setup_movedata(struct k_args *A, struct _k_pipe_struct *pipe_ptr, XFER_TYPE xfer_type, struct k_args *writer_ptr, struct k_args *pReader, void *destination, void *source, uint32_t size, int XferID)
