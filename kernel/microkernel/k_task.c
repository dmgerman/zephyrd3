...
DECL|_k_state_bit_reset|function|void _k_state_bit_reset(struct k_task *X, /* ptr to task */ uint32_t bits /* bitmask of TF_xxx bits to reset */ )
DECL|_k_state_bit_set|function|void _k_state_bit_set(struct k_task *task_ptr, uint32_t bits /* bitmask of TF_xxx bits to set */ )
...
DECL|start_task|function|static void start_task(struct k_task *X, /* ptr to task control block */ void (*func)(void) /* entry point for task */ )
