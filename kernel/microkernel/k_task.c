...
DECL|K_taskop|function|void K_taskop(struct k_args *A)
...
DECL|set_state_bit|function|void set_state_bit(struct k_proc *X, /* ptr to task */ uint32_t bits /* bitmask of TF_xxx bits to set */ )
