DECL|_SYSCALL_HANDLER|function|_SYSCALL_HANDLER(k_queue_alloc_append, queue, data)
DECL|_SYSCALL_HANDLER|function|_SYSCALL_HANDLER(k_queue_alloc_prepend, queue, data)
DECL|_SYSCALL_HANDLER|function|_SYSCALL_HANDLER(k_queue_get, queue, timeout_p)
DECL|_SYSCALL_HANDLER|function|_SYSCALL_HANDLER(k_queue_init, queue_ptr)
