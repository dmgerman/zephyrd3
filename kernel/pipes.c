DECL|_SYSCALL_HANDLER3|function|_SYSCALL_HANDLER3(k_pipe_init, pipe, buffer, size)
DECL|_SYSCALL_HANDLER6|function|_SYSCALL_HANDLER6(k_pipe_get, pipe, data, bytes_to_read, bytes_read_p, min_xfer_p, timeout)
DECL|_SYSCALL_HANDLER6|function|_SYSCALL_HANDLER6(k_pipe_put, pipe, data, bytes_to_write, bytes_written_p, min_xfer_p, timeout)
