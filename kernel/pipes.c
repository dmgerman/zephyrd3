DECL|Z_SYSCALL_HANDLER|function|Z_SYSCALL_HANDLER(k_pipe_alloc_init, pipe, size)
DECL|Z_SYSCALL_HANDLER|function|Z_SYSCALL_HANDLER(k_pipe_get, pipe, data, bytes_to_read, bytes_read_p, min_xfer_p, timeout)
DECL|Z_SYSCALL_HANDLER|function|Z_SYSCALL_HANDLER(k_pipe_put, pipe, data, bytes_to_write, bytes_written_p, min_xfer_p, timeout)
