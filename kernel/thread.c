...
DECL|Z_SYSCALL_HANDLER|function|Z_SYSCALL_HANDLER(k_thread_name_set, thread, data)
...
DECL|_impl_k_thread_name_get|function|const char *_impl_k_thread_name_get(k_tid_t thread_id)
DECL|_impl_k_thread_name_get|function|const char *_impl_k_thread_name_get(struct k_thread *thread)
DECL|_impl_k_thread_name_set|function|void _impl_k_thread_name_set(k_tid_t thread_id, const char *value)
DECL|_impl_k_thread_name_set|function|void _impl_k_thread_name_set(struct k_thread *thread, const char *value)
...
DECL|_setup_new_thread|function|void _setup_new_thread(struct k_thread *new_thread, k_thread_stack_t *stack, size_t stack_size, k_thread_entry_t entry, void *p1, void *p2, void *p3, int prio, u32_t options, const char *name)
