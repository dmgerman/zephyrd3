DECL|_SYSCALL_HANDLER2|function|_SYSCALL_HANDLER2(k_sem_take, sem, timeout)
DECL|_SYSCALL_HANDLER3|function|_SYSCALL_HANDLER3(k_sem_init, sem, initial_count, limit)
