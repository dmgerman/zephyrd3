...
DECL|bt_bredr_hci_write_scan|function|static int bt_bredr_hci_write_scan(uint8_t scan)
DECL|bt_bredr_set_connectable|function|int bt_bredr_set_connectable(bool enable)
DECL|bt_bredr_set_discoverable|function|int bt_bredr_set_discoverable(bool enable)
...
DECL|bt_le_scan_start|function|int bt_le_scan_start(bt_le_scan_filter_dup_t filter, bt_le_scan_cb_t cb)
