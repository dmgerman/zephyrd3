...
DECL|bt_keys_clear|function|void bt_keys_clear(struct bt_keys *keys, int type)
...
DECL|bt_keys_foreach|macro|bt_keys_foreach
...
DECL|irks|variable|irks
DECL|key_pool|variable|key_pool
DECL|local_csrks|variable|local_csrks
DECL|ltks|variable|ltks
DECL|remote_csrks|variable|remote_csrks
DECL|slave_ltks|variable|slave_ltks
