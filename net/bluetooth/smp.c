...
DECL|bt_smp_recv|function|static void bt_smp_recv(struct bt_l2cap_chan *chan, struct bt_buf *buf)
...
DECL|func|member|uint8_t (*func)(struct bt_smp *smp, struct bt_buf *buf);
...
DECL|smp_encrypt_info|function|static uint8_t smp_encrypt_info(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_ident_addr_info|function|static uint8_t smp_ident_addr_info(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_ident_info|function|static uint8_t smp_ident_info(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_init|function|static int smp_init(struct bt_smp *smp)
DECL|smp_master_ident|function|static uint8_t smp_master_ident(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_pairing_confirm|function|static uint8_t smp_pairing_confirm(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_pairing_failed|function|static uint8_t smp_pairing_failed(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_pairing_random|function|static uint8_t smp_pairing_random(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_pairing_req|function|static uint8_t smp_pairing_req(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_pairing_req|function|static uint8_t smp_pairing_req(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_pairing_rsp|function|static uint8_t smp_pairing_rsp(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_pairing_rsp|function|static uint8_t smp_pairing_rsp(struct bt_smp *smp, struct bt_buf *buf)
...
DECL|smp_security_request|function|static uint8_t smp_security_request(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_security_request|function|static uint8_t smp_security_request(struct bt_smp *smp, struct bt_buf *buf)
...
DECL|smp_signing_info|function|static uint8_t smp_signing_info(struct bt_smp *smp, struct bt_buf *buf)
DECL|smp_signing_info|function|static uint8_t smp_signing_info(struct bt_smp *smp, struct bt_buf *buf)
