...
DECL|bt_gatt_attr_read_include|function|int bt_gatt_attr_read_include(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
...
DECL|bt_gatt_notify|function|void bt_gatt_notify(uint16_t handle, const void *data, uint16_t len)
...
DECL|bt_gatt_write_without_response|function|int bt_gatt_write_without_response(struct bt_conn *conn, uint16_t handle, const void *data, uint16_t length)
