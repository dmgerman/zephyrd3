...
DECL|l2cap_chan_add|function|static int l2cap_chan_add(struct bt_conn *conn, struct bt_l2cap_chan *chan)
DECL|l2cap_chan_alloc_cid|function|static void l2cap_chan_alloc_cid(struct bt_conn *conn, struct bt_l2cap_chan *chan)
DECL|l2cap_chan_create_seg|function|static struct net_buf *l2cap_chan_create_seg(struct bt_l2cap_chan *chan, struct net_buf *buf, size_t sdu_hdr_len)
...
DECL|l2cap_chan_le_send|function|static int l2cap_chan_le_send(struct bt_l2cap_chan *chan, struct net_buf *buf, uint16_t sdu_hdr_len)
DECL|l2cap_chan_recv|function|static void l2cap_chan_recv(struct bt_l2cap_chan *chan, struct net_buf *buf)
DECL|l2cap_chan_rx_give_credits|function|static void l2cap_chan_rx_give_credits(struct bt_l2cap_chan *chan, uint16_t credits)
DECL|l2cap_chan_rx_init|function|static void l2cap_chan_rx_init(struct bt_l2cap_chan *chan)
DECL|l2cap_chan_tx_give_credits|function|static void l2cap_chan_tx_give_credits(struct bt_l2cap_chan *chan, uint16_t credits)
DECL|l2cap_chan_tx_init|function|static void l2cap_chan_tx_init(struct bt_l2cap_chan *chan)
...
DECL|l2cap_le_connect|function|static int l2cap_le_connect(struct bt_conn *conn, struct bt_l2cap_chan *chan, uint16_t psm)
