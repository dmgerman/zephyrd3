...
DECL|l2cap_chan_create_seg|function|static struct net_buf *l2cap_chan_create_seg(struct bt_l2cap_chan *chan, struct net_buf *buf, bool first_packet)
...
DECL|l2cap_chan_le_send|function|static int l2cap_chan_le_send(struct bt_l2cap_chan *chan, struct net_buf *buf, bool first_packet)
