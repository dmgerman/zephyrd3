...
DECL|add_frag_to_cache|function|static inline enum net_verdict add_frag_to_cache(struct net_buf *frag, struct net_buf **buf, bool first)
...
DECL|clear_reass_cache|function|static inline void clear_reass_cache(uint16_t size, uint16_t tag, bool fail)
...
DECL|ieee802154_reassemble|function|enum net_verdict ieee802154_reassemble(struct net_buf *frag, struct net_buf **buf)
...
DECL|reass_timeout|function|static void reass_timeout(struct nano_work *work)
...
DECL|timer|member|struct nano_delayed_work timer; /* Reassemble timer */
