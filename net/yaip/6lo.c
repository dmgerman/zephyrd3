...
DECL|compress_IPHC_header|function|static inline bool compress_IPHC_header(struct net_buf *buf)
DECL|compress_ipv6_header|function|static inline bool compress_ipv6_header(struct net_buf *buf)
DECL|net_6lo_addr_16_bit_compressible|function|static inline bool net_6lo_addr_16_bit_compressible(struct in6_addr *addr)
DECL|net_6lo_compress|function|bool net_6lo_compress(struct net_buf *buf, bool iphc)
