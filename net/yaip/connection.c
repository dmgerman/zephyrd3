...
DECL|cache_check|function|static inline enum net_verdict cache_check(enum ip_protocol proto, struct net_buf *buf, uint32_t *cache_value, int32_t *pos)
...
DECL|get_conn|function|static inline int32_t get_conn(enum ip_protocol proto, sa_family_t family, struct net_buf *buf, uint32_t *cache_value)
