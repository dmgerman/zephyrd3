...
DECL|session_t|typedef|} session_t;
DECL|sin6|member|struct sockaddr_in6 sin6;
DECL|sin|member|struct sockaddr_in sin;
DECL|size|member|socklen_t size; /**< size of addr */
DECL|size|member|unsigned char size;
DECL|st|member|struct sockaddr_storage st;
