...
DECL|dao_ack_input|function|dao_ack_input(void)
DECL|dao_ack_output|function|dao_ack_output(rpl_instance_t *instance, uip_ipaddr_t *dest, uint8_t sequence)
DECL|dao_input|function|dao_input(void)
...
DECL|dio_input|function|dio_input(void)
DECL|dio_output|function|dio_output(rpl_instance_t *instance, uip_ipaddr_t *uc_addr)
DECL|dis_input|function|dis_input(void)
DECL|dis_output|function|dis_output(uip_ipaddr_t *addr)
