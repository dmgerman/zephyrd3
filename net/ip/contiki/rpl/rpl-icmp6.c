...
DECL|dao_output_target|function|dao_output_target(struct net_buf *buf, rpl_parent_t *parent, uip_ipaddr_t *prefix, uint8_t lifetime)
DECL|dao_output|function|dao_output(struct net_buf *buf, rpl_parent_t *parent, uint8_t lifetime)
DECL|dao_sequence|variable|dao_sequence
DECL|dio_input|function|dio_input(struct net_buf *buf)
DECL|dio_output|function|dio_output(struct net_buf *buf, rpl_instance_t *instance, uip_ipaddr_t *uc_addr)
