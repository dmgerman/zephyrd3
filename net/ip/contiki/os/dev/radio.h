...
DECL|send|member|int (* send)(struct net_mbuf *buf, const void *payload, unsigned short payload_len);
...
DECL|transmit|member|int (* transmit)(struct net_mbuf *buf, unsigned short transmit_len);
