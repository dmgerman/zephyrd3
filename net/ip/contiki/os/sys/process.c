...
DECL|call_process|function|call_process(struct process *p, process_event_t ev, process_data_t data)
DECL|data|member|process_data_t data;
DECL|do_event|function|do_event(void)
DECL|do_poll|function|do_poll(void)
DECL|event_data|struct|struct event_data {
DECL|events|variable|events
DECL|ev|member|process_event_t ev;
DECL|exit_process|function|exit_process(struct process *p, struct process *fromprocess)
...
DECL|process_post_synch|function|process_post_synch(struct process *p, process_event_t ev, process_data_t data)
DECL|process_post|function|process_post(struct process *p, process_event_t ev, process_data_t data)
DECL|process_run|function|process_run(void)
