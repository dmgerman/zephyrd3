DECL|TCPIP_H_|macro|TCPIP_H_
DECL|UIP_APPCALL|macro|UIP_APPCALL
DECL|UIP_ICMP6_APPCALL|macro|UIP_ICMP6_APPCALL
DECL|UIP_UDP_APPCALL|macro|UIP_UDP_APPCALL
DECL|p|member|struct process *p;
DECL|state|member|void *state;
DECL|tcp_markconn|macro|tcp_markconn
DECL|tcpip_process|variable|tcpip_process
DECL|tcpip_set_forwarding|macro|tcpip_set_forwarding
