DECL|PROCESS_THREAD|function|PROCESS_THREAD(udp_socket_process, ev, data)
...
DECL|udp_socket_sendto|function|udp_socket_sendto(struct udp_socket *c, const void *data, uint16_t datalen, const uip_ipaddr_t *to, uint16_t port)
DECL|udp_socket_send|function|udp_socket_send(struct udp_socket *c, const void *data, uint16_t datalen)
