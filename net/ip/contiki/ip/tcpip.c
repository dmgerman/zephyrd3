...
DECL|PROCESS_THREAD|function|PROCESS_THREAD(tcpip_process, ev, data)
...
DECL|check_for_tcp_syn|function|check_for_tcp_syn(void)
DECL|eventhandler|function|eventhandler(process_event_t ev, process_data_t data)
...
DECL|outputfunc|variable|outputfunc
DECL|packet_input|function|packet_input(void)
...
DECL|tcpip_input|function|tcpip_input(void)
DECL|tcpip_ipv6_output|function|tcpip_ipv6_output(void)
DECL|tcpip_is_forwarding|variable|tcpip_is_forwarding
DECL|tcpip_output|function|tcpip_output(const uip_lladdr_t *a)
...
DECL|tcpip_set_outputfunc|function|tcpip_set_outputfunc(uint8_t (*f)(const uip_lladdr_t *))
DECL|tcpip_set_outputfunc|function|tcpip_set_outputfunc(uint8_t (*f)(void))
DECL|tcpip_uipcall|function|tcpip_uipcall(void)
