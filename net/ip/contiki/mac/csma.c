...
DECL|free_packet|function|free_packet(struct net_buf *buf, struct neighbor_queue *n, struct rdc_buf_list *p)
...
DECL|packet_sent|function|packet_sent(struct net_buf *buf, void *ptr, int status, int num_transmissions)
...
DECL|transmit_packet_list|function|transmit_packet_list(struct net_buf *buf, void *ptr)
