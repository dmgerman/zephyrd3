...
DECL|echo_reply_input|function|echo_reply_input(void)
DECL|echo_request_input|function|echo_request_input(void)
...
DECL|tmp_ipaddr|variable|tmp_ipaddr
...
DECL|uip_icmp6_error_output|function|uip_icmp6_error_output(uint8_t type, uint8_t code, uint32_t param) {
DECL|uip_icmp6_init|function|uip_icmp6_init()
DECL|uip_icmp6_input|function|uip_icmp6_input(uint8_t type, uint8_t icode)
DECL|uip_icmp6_register_input_handler|function|uip_icmp6_register_input_handler(uip_icmp6_input_handler_t *handler)
DECL|uip_icmp6_send|function|uip_icmp6_send(const uip_ipaddr_t *dest, int type, int code, int payload_len)
