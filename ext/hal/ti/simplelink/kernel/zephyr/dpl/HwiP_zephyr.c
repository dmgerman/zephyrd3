...
DECL|HwiP_disableInterrupt|function|void HwiP_disableInterrupt(int interruptNum)
DECL|HwiP_disable|function|uintptr_t HwiP_disable(void)
DECL|HwiP_enableInterrupt|function|void HwiP_enableInterrupt(int interruptNum)
