...
DECL|HAL_UART_ERROR_BUSY|enumerator|HAL_UART_ERROR_BUSY = 0x20 /*!< Busy Error */
DECL|HAL_UART_ERROR_DMA|enumerator|HAL_UART_ERROR_DMA = 0x10, /*!< DMA transfer error */
DECL|HAL_UART_ERROR_FE|enumerator|HAL_UART_ERROR_FE = 0x04, /*!< frame error */
DECL|HAL_UART_ERROR_NE|enumerator|HAL_UART_ERROR_NE = 0x02, /*!< Noise error */
DECL|HAL_UART_ERROR_NONE|enumerator|HAL_UART_ERROR_NONE = 0x00, /*!< No error */
DECL|HAL_UART_ERROR_ORE|enumerator|HAL_UART_ERROR_ORE = 0x08, /*!< Overrun error */
DECL|HAL_UART_ERROR_PE|enumerator|HAL_UART_ERROR_PE = 0x01, /*!< Parity error */
DECL|HAL_UART_ErrorTypeDef|typedef|}HAL_UART_ErrorTypeDef;
...
DECL|IS_UART_4B_ADDRESS|macro|IS_UART_4B_ADDRESS
DECL|IS_UART_7B_ADDRESS|macro|IS_UART_7B_ADDRESS
...
DECL|__HAL_UART_ONE_BIT_DISABLE|macro|__HAL_UART_ONE_BIT_DISABLE
DECL|__HAL_UART_ONE_BIT_ENABLE|macro|__HAL_UART_ONE_BIT_ENABLE
...
DECL|__STM32L0xx_HAL_UART_H|macro|__STM32L0xx_HAL_UART_H
