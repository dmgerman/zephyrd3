...
DECL|LL_LPUART_GetBaudRate|function|__STATIC_INLINE uint32_t LL_LPUART_GetBaudRate(USART_TypeDef *LPUARTx, uint32_t PeriphClk)
...
DECL|LL_LPUART_SetBaudRate|function|__STATIC_INLINE void LL_LPUART_SetBaudRate(USART_TypeDef *LPUARTx, uint32_t PeriphClk, uint32_t BaudRate)
...
DECL|__STM32L0xx_LL_LPUART_H|macro|__STM32L0xx_LL_LPUART_H
