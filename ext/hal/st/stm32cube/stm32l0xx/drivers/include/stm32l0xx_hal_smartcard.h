...
DECL|AutoRetryCount|member|uint32_t AutoRetryCount; /*!< Specifies the SmartCard auto-retry count (number of retries in
DECL|BaudRate|member|uint32_t BaudRate; /*!< Configures the SmartCard communication baud rate.
DECL|BlockLength|member|uint32_t BlockLength; /*!< Specifies the SmartCard Block Length in T=1 Reception mode.
...
DECL|GuardTime|member|uint32_t GuardTime; /*!< Specifies the SmartCard Guard Time */
...
DECL|HAL_SMARTCARD_STATE_BUSY_TX_RX|enumerator|HAL_SMARTCARD_STATE_BUSY_TX_RX = 0x32U, /*!< Data Transmission and Reception process is ongoing */
DECL|HAL_SMARTCARD_STATE_BUSY_TX|enumerator|HAL_SMARTCARD_STATE_BUSY_TX = 0x12U, /*!< Data Transmission process is ongoing */
DECL|HAL_SMARTCARD_STATE_BUSY|enumerator|HAL_SMARTCARD_STATE_BUSY = 0x02U, /*!< an internal process is ongoing */
DECL|HAL_SMARTCARD_STATE_ERROR|enumerator|HAL_SMARTCARD_STATE_ERROR = 0x04U /*!< Error */
DECL|HAL_SMARTCARD_STATE_READY|enumerator|HAL_SMARTCARD_STATE_READY = 0x01U, /*!< Peripheral Initialized and ready for use */
DECL|HAL_SMARTCARD_STATE_RESET|enumerator|HAL_SMARTCARD_STATE_RESET = 0x00U, /*!< Peripheral is not yet Initialized */
DECL|HAL_SMARTCARD_STATE_TIMEOUT|enumerator|HAL_SMARTCARD_STATE_TIMEOUT = 0x03U, /*!< Timeout state */
...
DECL|NACKState|member|uint32_t NACKState; /*!< Specifies whether the SmartCard NACK transmission is enabled
DECL|OneBitSampling|member|uint32_t OneBitSampling; /*!< Specifies wether a single sample or three samples' majority vote is selected.
...
DECL|Prescaler|member|uint32_t Prescaler; /*!< Specifies the SmartCard Prescaler */
