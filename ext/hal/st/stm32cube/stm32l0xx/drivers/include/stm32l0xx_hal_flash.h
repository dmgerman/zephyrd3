...
DECL|FLASH_PROC_PAGEERASE|enumerator|FLASH_PROC_PAGEERASE,
...
DECL|Page|member|__IO uint32_t Page; /* Internal variable to define the current sector which is erasing */
