...
DECL|ErrorCode|member|__IO uint32_t ErrorCode; /*!< SMBUS Error code , see SMBUS_Error_Code */
DECL|GeneralCallMode|member|uint32_t GeneralCallMode; /*!< Specifies if general call mode is selected.
DECL|HAL_SMBUS_AddrCallback|macro|HAL_SMBUS_AddrCallback
...
DECL|HAL_SMBUS_EnableListen_IT|macro|HAL_SMBUS_EnableListen_IT
DECL|HAL_SMBUS_ListenCpltCallback|macro|HAL_SMBUS_ListenCpltCallback
...
DECL|PreviousState|member|__IO uint32_t PreviousState; /*!< SMBUS communication Previous tate */
...
DECL|__SMBUS_GENERATE_START|macro|__SMBUS_GENERATE_START
DECL|__SMBUS_GET_ADDR_MATCH|macro|__SMBUS_GET_ADDR_MATCH
DECL|__SMBUS_GET_ALERT_ENABLE|macro|__SMBUS_GET_ALERT_ENABLE
DECL|__SMBUS_GET_DIR|macro|__SMBUS_GET_DIR
DECL|__SMBUS_GET_PEC_MODE|macro|__SMBUS_GET_PEC_MODE
DECL|__SMBUS_GET_STOP_MODE|macro|__SMBUS_GET_STOP_MODE
DECL|__SMBUS_RESET_CR1|macro|__SMBUS_RESET_CR1
DECL|__SMBUS_RESET_CR2|macro|__SMBUS_RESET_CR2
