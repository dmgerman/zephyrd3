...
DECL|HSICalibrationValue|member|uint32_t HSICalibrationValue; /*!< The calibration trimming value.
...
DECL|MSICalibrationValue|member|uint32_t MSICalibrationValue; /*!< The calibration trimming value.
...
DECL|PLLDIV|member|uint32_t PLLDIV; /*!< PLLDIV: Division factor for main system clock (SYSCLK)
DECL|PLLMUL|member|uint32_t PLLMUL; /*!< PLLMUL: Multiplication factor for PLL VCO output clock
