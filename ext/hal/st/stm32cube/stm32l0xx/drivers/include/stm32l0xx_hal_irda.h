...
DECL|HAL_IRDA_STATE_BUSY_TX_RX|enumerator|HAL_IRDA_STATE_BUSY_TX_RX = 0x32U, /*!< Data Transmission and Reception process is ongoing */
DECL|HAL_IRDA_STATE_BUSY_TX|enumerator|HAL_IRDA_STATE_BUSY_TX = 0x12U, /*!< Data Transmission process is ongoing */
DECL|HAL_IRDA_STATE_BUSY|enumerator|HAL_IRDA_STATE_BUSY = 0x02U, /*!< an internal process is ongoing */
DECL|HAL_IRDA_STATE_ERROR|enumerator|HAL_IRDA_STATE_ERROR = 0x04U /*!< Error */
DECL|HAL_IRDA_STATE_READY|enumerator|HAL_IRDA_STATE_READY = 0x01U, /*!< Peripheral Initialized and ready for use */
DECL|HAL_IRDA_STATE_RESET|enumerator|HAL_IRDA_STATE_RESET = 0x00U, /*!< Peripheral is not yet Initialized */
DECL|HAL_IRDA_STATE_TIMEOUT|enumerator|HAL_IRDA_STATE_TIMEOUT = 0x03U, /*!< Timeout state */
...
DECL|Mode|member|uint16_t Mode; /*!< Specifies wether the Receive or Transmit mode is enabled or disabled.
...
DECL|__STM32L0xx_HAL_IRDA_H|macro|__STM32L0xx_HAL_IRDA_H
