...
DECL|Channel|member|uint32_t Channel; /*!< the ADC channel to configure
DECL|ClockPrescaler|member|uint32_t ClockPrescaler; /*!< Selects the ADC clock frequency.
DECL|ContinuousConvMode|member|uint32_t ContinuousConvMode; /*!< Specifies whether the conversion is performed in Continuous or Single mode.
...
DECL|DiscontinuousConvMode|member|uint32_t DiscontinuousConvMode; /*!< Specifies whether the conversion is performed
DECL|EOCSelection|member|uint32_t EOCSelection; /*!< Specifies what EOC (End Of Conversion) flag is used for conversion polling and interruption:
DECL|ErrorCode|member|__IO uint32_t ErrorCode; /*!< ADC Error code */
DECL|ExternalTrigConvEdge|member|uint32_t ExternalTrigConvEdge; /*!< Select the external trigger edge and enable the trigger.
DECL|ExternalTrigConv|member|uint32_t ExternalTrigConv; /*!< Select the external event used to trigger the start of conversion.
...
DECL|LowPowerAutoPowerOff|member|uint32_t LowPowerAutoPowerOff; /*!< When setting the AutoOff feature, the ADC is always powered off when not converting and automatically
DECL|LowPowerAutoWait|member|uint32_t LowPowerAutoWait; /*!< Specifies the usage of dynamic low power Auto Delay: new conversion start only
...
DECL|Oversample|member|ADC_OversamplingTypeDef Oversample; /*!< Specifies the Oversampling parameters
DECL|OversamplingMode|member|uint32_t OversamplingMode; /*!< Specifies whether the oversampling feature is enabled or disabled
...
DECL|Resolution|member|uint32_t Resolution; /*!< Configures the ADC resolution mode.
DECL|RightBitShift|member|uint32_t RightBitShift; /*!< Configures the division coefficient for the Oversampler.
DECL|SamplingTime|member|uint32_t SamplingTime; /*!< The sample time value to be set for all channels.
DECL|ScanConvMode|member|uint32_t ScanConvMode; /*!< The scan sequence direction.
...
DECL|WatchdogMode|member|uint32_t WatchdogMode; /*!< Configures the ADC analog watchdog mode: single/all channels.
...
DECL|__STM32L0xx_ADC_H|macro|__STM32L0xx_ADC_H
