...
DECL|HAL_WWDG_STATE_BUSY|enumerator|HAL_WWDG_STATE_BUSY = 0x02U, /*!< WWDG internal process is ongoing */
DECL|HAL_WWDG_STATE_ERROR|enumerator|HAL_WWDG_STATE_ERROR = 0x04U /*!< WWDG error state */
DECL|HAL_WWDG_STATE_READY|enumerator|HAL_WWDG_STATE_READY = 0x01U, /*!< WWDG initialized and ready for use */
DECL|HAL_WWDG_STATE_RESET|enumerator|HAL_WWDG_STATE_RESET = 0x00U, /*!< WWDG not yet initialized or disabled */
DECL|HAL_WWDG_STATE_TIMEOUT|enumerator|HAL_WWDG_STATE_TIMEOUT = 0x03U, /*!< WWDG timeout state */
...
DECL|WWDG_CFR_BASE|macro|WWDG_CFR_BASE
...
DECL|__STM32L0xx_HAL_WWDG_H|macro|__STM32L0xx_HAL_WWDG_H
