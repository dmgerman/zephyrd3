...
DECL|UART_SetConfig|function|void UART_SetConfig(UART_HandleTypeDef *huart)
DECL|UART_TIMEOUT_VALUE|macro|UART_TIMEOUT_VALUE
DECL|UART_Transmit_IT|function|static HAL_StatusTypeDef UART_Transmit_IT(UART_HandleTypeDef *huart)
DECL|UART_WaitOnFlagUntilTimeout|function|HAL_StatusTypeDef UART_WaitOnFlagUntilTimeout(UART_HandleTypeDef *huart, uint32_t Flag, FlagStatus Status, uint32_t Timeout)
