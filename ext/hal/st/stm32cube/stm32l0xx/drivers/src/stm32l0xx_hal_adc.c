DECL|ADC_ConversionStop|function|static HAL_StatusTypeDef ADC_ConversionStop(ADC_HandleTypeDef* hadc)
...
DECL|ADC_DelayMicroSecond|function|static void ADC_DelayMicroSecond(uint32_t microSecond)
