...
DECL|HAL_RTCEx_DeactivateInternalTimeStamp|function|HAL_StatusTypeDef HAL_RTCEx_DeactivateInternalTimeStamp(RTC_HandleTypeDef *hrtc)
...
DECL|HAL_RTCEx_SetInternalTimeStamp|function|HAL_StatusTypeDef HAL_RTCEx_SetInternalTimeStamp(RTC_HandleTypeDef *hrtc)
