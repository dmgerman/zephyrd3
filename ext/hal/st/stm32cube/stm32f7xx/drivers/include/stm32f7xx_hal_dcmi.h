...
DECL|SyncroCode|member|DCMI_CodesInitTypeDef SyncroCode; /*!< Specifies the code of the line/frame start delimiter and the
...
DECL|__STM32F7xx_HAL_DCMI_H|macro|__STM32F7xx_HAL_DCMI_H
