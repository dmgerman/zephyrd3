...
DECL|IS_QSPI_GET_FLAG|macro|IS_QSPI_GET_FLAG
...
DECL|IS_QSPI_IT|macro|IS_QSPI_IT
...
DECL|NbData|member|uint32_t NbData; /* Specifies the number of data to transfer.
...
DECL|__STM32F7xx_HAL_QSPI_H|macro|__STM32F7xx_HAL_QSPI_H
