...
DECL|HAL_SD_CARD_PROGRAMMING|enumerator|HAL_SD_CARD_PROGRAMMING = ((uint32_t)0x00000007U), /*!< Card is in programming state */
DECL|HAL_SD_CARD_READY|enumerator|HAL_SD_CARD_READY = ((uint32_t)0x00000001U), /*!< Card state is ready */
DECL|HAL_SD_CARD_RECEIVING|enumerator|HAL_SD_CARD_RECEIVING = ((uint32_t)0x00000006U), /*!< Card is receiving operation information */
...
DECL|HAL_SD_STATE_READY|enumerator|HAL_SD_STATE_READY = ((uint32_t)0x00000001U), /*!< SD initialized and ready for use */
DECL|HAL_SD_STATE_RECEIVING|enumerator|HAL_SD_STATE_RECEIVING = ((uint32_t)0x00000005U), /*!< SD Receinving State */
DECL|HAL_SD_STATE_RESET|enumerator|HAL_SD_STATE_RESET = ((uint32_t)0x00000000U), /*!< SD not yet initialized or disabled */
