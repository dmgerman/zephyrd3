...
DECL|HAL_MMC_CARD_DISCONNECTED|enumerator|HAL_MMC_CARD_DISCONNECTED = ((uint32_t)0x00000008U), /*!< Card is disconnected */
DECL|HAL_MMC_CARD_ERROR|enumerator|HAL_MMC_CARD_ERROR = ((uint32_t)0x000000FFU) /*!< Card response Error */
DECL|HAL_MMC_CARD_IDENTIFICATION|enumerator|HAL_MMC_CARD_IDENTIFICATION = ((uint32_t)0x00000002U), /*!< Card is in identification state */
DECL|HAL_MMC_CARD_PROGRAMMING|enumerator|HAL_MMC_CARD_PROGRAMMING = ((uint32_t)0x00000007U), /*!< Card is in programming state */
DECL|HAL_MMC_CARD_READY|enumerator|HAL_MMC_CARD_READY = ((uint32_t)0x00000001U), /*!< Card state is ready */
DECL|HAL_MMC_CARD_RECEIVING|enumerator|HAL_MMC_CARD_RECEIVING = ((uint32_t)0x00000006U), /*!< Card is receiving operation information */
DECL|HAL_MMC_CARD_SENDING|enumerator|HAL_MMC_CARD_SENDING = ((uint32_t)0x00000005U), /*!< Card is sending an operation */
DECL|HAL_MMC_CARD_STANDBY|enumerator|HAL_MMC_CARD_STANDBY = ((uint32_t)0x00000003U), /*!< Card is in standby state */
DECL|HAL_MMC_CARD_TRANSFER|enumerator|HAL_MMC_CARD_TRANSFER = ((uint32_t)0x00000004U), /*!< Card is in transfer state */
...
DECL|HAL_MMC_STATE_BUSY|enumerator|HAL_MMC_STATE_BUSY = ((uint32_t)0x00000003U), /*!< MMC process ongoing */
DECL|HAL_MMC_STATE_ERROR|enumerator|HAL_MMC_STATE_ERROR = ((uint32_t)0x0000000FU) /*!< MMC is in error state */
DECL|HAL_MMC_STATE_PROGRAMMING|enumerator|HAL_MMC_STATE_PROGRAMMING = ((uint32_t)0x00000004U), /*!< MMC Programming State */
DECL|HAL_MMC_STATE_READY|enumerator|HAL_MMC_STATE_READY = ((uint32_t)0x00000001U), /*!< MMC initialized and ready for use */
DECL|HAL_MMC_STATE_RECEIVING|enumerator|HAL_MMC_STATE_RECEIVING = ((uint32_t)0x00000005U), /*!< MMC Receinving State */
DECL|HAL_MMC_STATE_RESET|enumerator|HAL_MMC_STATE_RESET = ((uint32_t)0x00000000U), /*!< MMC not yet initialized or disabled */
DECL|HAL_MMC_STATE_TIMEOUT|enumerator|HAL_MMC_STATE_TIMEOUT = ((uint32_t)0x00000002U), /*!< MMC Timeout state */
DECL|HAL_MMC_STATE_TRANSFER|enumerator|HAL_MMC_STATE_TRANSFER = ((uint32_t)0x00000006U), /*!< MMC Transfert State */
...
DECL|__STM32F7xx_HAL_MMC_H|macro|__STM32F7xx_HAL_MMC_H
