DECL|DAC_DMAConvCpltCh1|function|void DAC_DMAConvCpltCh1(DMA_HandleTypeDef *hdma)
DECL|DAC_DMAErrorCh1|function|void DAC_DMAErrorCh1(DMA_HandleTypeDef *hdma)
DECL|DAC_DMAHalfConvCpltCh1|function|void DAC_DMAHalfConvCpltCh1(DMA_HandleTypeDef *hdma)
...
DECL|HAL_DAC_Stop_DMA|function|__weak HAL_StatusTypeDef HAL_DAC_Stop_DMA(DAC_HandleTypeDef* hdac, uint32_t Channel)
