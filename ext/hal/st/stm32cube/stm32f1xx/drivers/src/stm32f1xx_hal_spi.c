...
DECL|HAL_SPI_Init|function|__weak HAL_StatusTypeDef HAL_SPI_Init(SPI_HandleTypeDef *hspi)
...
DECL|SPI_ISCRCErrorValid|function|__weak uint8_t SPI_ISCRCErrorValid(SPI_HandleTypeDef *hspi)
