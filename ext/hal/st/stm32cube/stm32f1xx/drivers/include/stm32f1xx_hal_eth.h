...
DECL|HAL_ETH_STATE_BUSY_RD|enumerator|HAL_ETH_STATE_BUSY_RD = 0x82, /*!< Read process is ongoing */
DECL|HAL_ETH_STATE_BUSY_RX|enumerator|HAL_ETH_STATE_BUSY_RX = 0x22, /*!< Data Reception process is ongoing */
DECL|HAL_ETH_STATE_BUSY_TX_RX|enumerator|HAL_ETH_STATE_BUSY_TX_RX = 0x32, /*!< Data Transmission and Reception process is ongoing */
DECL|HAL_ETH_STATE_BUSY_TX|enumerator|HAL_ETH_STATE_BUSY_TX = 0x12, /*!< Data Transmission process is ongoing */
DECL|HAL_ETH_STATE_BUSY_WR|enumerator|HAL_ETH_STATE_BUSY_WR = 0x42, /*!< Write process is ongoing */
DECL|HAL_ETH_STATE_BUSY|enumerator|HAL_ETH_STATE_BUSY = 0x02, /*!< an internal process is ongoing */
DECL|HAL_ETH_STATE_ERROR|enumerator|HAL_ETH_STATE_ERROR = 0x04 /*!< Reception process is ongoing */
DECL|HAL_ETH_STATE_READY|enumerator|HAL_ETH_STATE_READY = 0x01, /*!< Peripheral Initialized and ready for use */
DECL|HAL_ETH_STATE_RESET|enumerator|HAL_ETH_STATE_RESET = 0x00, /*!< Peripheral not yet Initialized or disabled */
DECL|HAL_ETH_STATE_TIMEOUT|enumerator|HAL_ETH_STATE_TIMEOUT = 0x03, /*!< Timeout state */
