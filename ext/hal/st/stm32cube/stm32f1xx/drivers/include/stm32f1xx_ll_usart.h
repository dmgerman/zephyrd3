...
DECL|LL_USART_GetBaudRate|function|__STATIC_INLINE uint32_t LL_USART_GetBaudRate(USART_TypeDef *USARTx, uint32_t PeriphClk)
...
DECL|LL_USART_SetBaudRate|function|__STATIC_INLINE void LL_USART_SetBaudRate(USART_TypeDef *USARTx, uint32_t PeriphClk, uint32_t BaudRate)
...
DECL|__STM32F1xx_LL_USART_H|macro|__STM32F1xx_LL_USART_H
