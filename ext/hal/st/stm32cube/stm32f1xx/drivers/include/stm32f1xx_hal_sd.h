...
DECL|SD_CARD_DISCONNECTED|enumerator|SD_CARD_DISCONNECTED = ((uint32_t)0x00000008), /*!< Card is disconnected */
...
DECL|SD_CARD_ERROR|enumerator|SD_CARD_ERROR = ((uint32_t)0x000000FF) /*!< Card is in error state */
DECL|SD_CARD_IDENTIFICATION|enumerator|SD_CARD_IDENTIFICATION = ((uint32_t)0x00000002), /*!< Card is in identification state */
DECL|SD_CARD_PROGRAMMING|enumerator|SD_CARD_PROGRAMMING = ((uint32_t)0x00000007), /*!< Card is in programming state */
DECL|SD_CARD_READY|enumerator|SD_CARD_READY = ((uint32_t)0x00000001), /*!< Card state is ready */
DECL|SD_CARD_RECEIVING|enumerator|SD_CARD_RECEIVING = ((uint32_t)0x00000006), /*!< Card is receiving operation information */
DECL|SD_CARD_SENDING|enumerator|SD_CARD_SENDING = ((uint32_t)0x00000005), /*!< Card is sending an operation */
DECL|SD_CARD_STANDBY|enumerator|SD_CARD_STANDBY = ((uint32_t)0x00000003), /*!< Card is in standby state */
DECL|SD_CARD_TRANSFER|enumerator|SD_CARD_TRANSFER = ((uint32_t)0x00000004), /*!< Card is in transfer state */
...
DECL|SD_READ_MULTIPLE_BLOCK|enumerator|SD_READ_MULTIPLE_BLOCK = 1, /*!< Read multiple blocks operation */
DECL|SD_READ_SINGLE_BLOCK|enumerator|SD_READ_SINGLE_BLOCK = 0, /*!< Read single block operation */
...
DECL|SD_SDIO_DISABLED|enumerator|SD_SDIO_DISABLED = (30),
DECL|SD_SDIO_FUNCTION_BUSY|enumerator|SD_SDIO_FUNCTION_BUSY = (31),
DECL|SD_SDIO_FUNCTION_FAILED|enumerator|SD_SDIO_FUNCTION_FAILED = (32),
DECL|SD_SDIO_UNKNOWN_FUNCTION|enumerator|SD_SDIO_UNKNOWN_FUNCTION = (33),
...
DECL|SD_WRITE_MULTIPLE_BLOCK|enumerator|SD_WRITE_MULTIPLE_BLOCK = 3 /*!< Write multiple blocks operation */
DECL|SD_WRITE_PROT_VIOLATION|enumerator|SD_WRITE_PROT_VIOLATION = (13), /*!< Attempt to program a write protect block */
DECL|SD_WRITE_SINGLE_BLOCK|enumerator|SD_WRITE_SINGLE_BLOCK = 2, /*!< Write single block operation */
...
DECL|__STM32F1xx_HAL_SD_H|macro|__STM32F1xx_HAL_SD_H
