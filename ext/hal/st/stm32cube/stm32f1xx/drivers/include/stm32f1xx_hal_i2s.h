...
DECL|HAL_I2S_ERROR_PRESCALER|macro|HAL_I2S_ERROR_PRESCALER
...
DECL|HAL_I2S_STATE_ERROR|enumerator|HAL_I2S_STATE_ERROR = 0x07U /*!< I2S error state */
...
DECL|IrqHandlerISR|member|void (*IrqHandlerISR) (struct __I2S_HandleTypeDef *hi2s); /*!< I2S function pointer on IrqHandler */
...
DECL|__I2S_HandleTypeDef|struct|typedef struct __I2S_HandleTypeDef
