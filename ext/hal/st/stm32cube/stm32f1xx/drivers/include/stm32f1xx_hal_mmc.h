...
DECL|CID|member|uint32_t CID[4U]; /*!< MMC card identification number table */
DECL|CSDStruct|member|__IO uint8_t CSDStruct; /*!< CSD structure */
DECL|CSD_CRC|member|__IO uint8_t CSD_CRC; /*!< CSD CRC */
DECL|CSD|member|uint32_t CSD[4U]; /*!< MMC card specific data table */
...
DECL|__STM32F1xx_HAL_MMC_H|macro|__STM32F1xx_HAL_MMC_H
