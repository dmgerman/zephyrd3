...
DECL|HAL_I2C_MODE_MASTER|enumerator|HAL_I2C_MODE_MASTER = 0x10, /*!< I2C communication is in Master Mode */
DECL|HAL_I2C_MODE_MEM|enumerator|HAL_I2C_MODE_MEM = 0x40 /*!< I2C communication is in Memory Mode */
DECL|HAL_I2C_MODE_NONE|enumerator|HAL_I2C_MODE_NONE = 0x00, /*!< No I2C communication on going */
DECL|HAL_I2C_MODE_SLAVE|enumerator|HAL_I2C_MODE_SLAVE = 0x20, /*!< I2C communication is in Slave Mode */
DECL|HAL_I2C_ModeTypeDef|typedef|}HAL_I2C_ModeTypeDef;
DECL|HAL_I2C_STATE_BUSY_RX|enumerator|HAL_I2C_STATE_BUSY_RX = 0x22, /*!< Data Reception process is ongoing */
DECL|HAL_I2C_STATE_BUSY_TX|enumerator|HAL_I2C_STATE_BUSY_TX = 0x21, /*!< Data Transmission process is ongoing */
DECL|HAL_I2C_STATE_BUSY|enumerator|HAL_I2C_STATE_BUSY = 0x24, /*!< An internal process is ongoing */
DECL|HAL_I2C_STATE_ERROR|enumerator|HAL_I2C_STATE_ERROR = 0xE0 /*!< Error */
DECL|HAL_I2C_STATE_READY|enumerator|HAL_I2C_STATE_READY = 0x20, /*!< Peripheral Initialized and ready for use */
DECL|HAL_I2C_STATE_RESET|enumerator|HAL_I2C_STATE_RESET = 0x00, /*!< Peripheral is not yet Initialized */
DECL|HAL_I2C_STATE_TIMEOUT|enumerator|HAL_I2C_STATE_TIMEOUT = 0xA0, /*!< Timeout state */
...
DECL|I2C_FAST_MODE_MAX_CLK|macro|I2C_FAST_MODE_MAX_CLK
...
DECL|I2C_FREQ_RANGE|macro|I2C_FREQ_RANGE
...
DECL|I2C_STANDARD_MODE_MAX_CLK|macro|I2C_STANDARD_MODE_MAX_CLK
