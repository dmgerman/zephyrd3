...
DECL|HAL_RCC_GetOscConfig|function|__weak void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef *RCC_OscInitStruct)
...
DECL|HAL_RCC_GetSysClockFreq|function|__weak uint32_t HAL_RCC_GetSysClockFreq(void)
