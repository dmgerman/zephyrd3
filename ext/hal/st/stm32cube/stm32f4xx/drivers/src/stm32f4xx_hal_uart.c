...
DECL|HAL_MultiProcessor_EnterMuteMode|function|HAL_StatusTypeDef HAL_MultiProcessor_EnterMuteMode(UART_HandleTypeDef *huart)
DECL|HAL_MultiProcessor_ExitMuteMode|function|HAL_StatusTypeDef HAL_MultiProcessor_ExitMuteMode(UART_HandleTypeDef *huart)
...
DECL|UART_SetConfig|function|static void UART_SetConfig(UART_HandleTypeDef *huart)
DECL|UART_Transmit_IT|function|static HAL_StatusTypeDef UART_Transmit_IT(UART_HandleTypeDef *huart)
DECL|UART_WaitOnFlagUntilTimeout|function|static HAL_StatusTypeDef UART_WaitOnFlagUntilTimeout(UART_HandleTypeDef *huart, uint32_t Flag, FlagStatus Status, uint32_t Tickstart, uint32_t Timeout)
