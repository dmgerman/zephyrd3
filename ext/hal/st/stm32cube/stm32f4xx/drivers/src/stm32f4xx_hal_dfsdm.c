...
DECL|DFSDM2_CHANNEL_NUMBER|macro|DFSDM2_CHANNEL_NUMBER
...
DECL|HAL_DFSDM_BitStreamClkDistribution_Config|function|void HAL_DFSDM_BitStreamClkDistribution_Config(uint32_t source)
DECL|HAL_DFSDM_BitstreamClock_Start|function|void HAL_DFSDM_BitstreamClock_Start(void)
DECL|HAL_DFSDM_BitstreamClock_Stop|function|void HAL_DFSDM_BitstreamClock_Stop(void)
...
DECL|HAL_DFSDM_ClockIn_SourceSelection|function|void HAL_DFSDM_ClockIn_SourceSelection(uint32_t source)
DECL|HAL_DFSDM_ClockOut_SourceSelection|function|void HAL_DFSDM_ClockOut_SourceSelection(uint32_t source)
DECL|HAL_DFSDM_ConfigMultiChannelDelay|function|void HAL_DFSDM_ConfigMultiChannelDelay(DFSDM_MultiChannelConfigTypeDef* mchdlystruct)
DECL|HAL_DFSDM_DataIn0_SourceSelection|function|void HAL_DFSDM_DataIn0_SourceSelection(uint32_t source)
DECL|HAL_DFSDM_DataIn2_SourceSelection|function|void HAL_DFSDM_DataIn2_SourceSelection(uint32_t source)
DECL|HAL_DFSDM_DataIn4_SourceSelection|function|void HAL_DFSDM_DataIn4_SourceSelection(uint32_t source)
DECL|HAL_DFSDM_DataIn6_SourceSelection|function|void HAL_DFSDM_DataIn6_SourceSelection(uint32_t source)
DECL|HAL_DFSDM_DisableDelayClock|function|void HAL_DFSDM_DisableDelayClock(uint32_t MCHDLY)
DECL|HAL_DFSDM_EnableDelayClock|function|void HAL_DFSDM_EnableDelayClock(uint32_t MCHDLY)
...
DECL|a_dfsdm2ChannelHandle|variable|a_dfsdm2ChannelHandle
DECL|v_dfsdm1ChannelCounter|variable|v_dfsdm1ChannelCounter
DECL|v_dfsdm2ChannelCounter|variable|v_dfsdm2ChannelCounter
