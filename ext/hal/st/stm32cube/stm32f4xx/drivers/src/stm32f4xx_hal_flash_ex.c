...
DECL|FLASH_OB_BootConfig|function|static HAL_StatusTypeDef FLASH_OB_BootConfig(uint8_t BootConfig)
DECL|FLASH_OB_DisablePCROP|function|static HAL_StatusTypeDef FLASH_OB_DisablePCROP(uint32_t Sector)
DECL|FLASH_OB_DisablePCROP|function|static HAL_StatusTypeDef FLASH_OB_DisablePCROP(uint32_t SectorBank1, uint32_t SectorBank2, uint32_t Banks)
DECL|FLASH_OB_DisableWRP|function|static HAL_StatusTypeDef FLASH_OB_DisableWRP(uint32_t WRPSector, uint32_t Banks)
DECL|FLASH_OB_DisableWRP|function|static HAL_StatusTypeDef FLASH_OB_DisableWRP(uint32_t WRPSector, uint32_t Banks)
DECL|FLASH_OB_EnablePCROP|function|static HAL_StatusTypeDef FLASH_OB_EnablePCROP(uint32_t Sector)
DECL|FLASH_OB_EnablePCROP|function|static HAL_StatusTypeDef FLASH_OB_EnablePCROP(uint32_t SectorBank1, uint32_t SectorBank2, uint32_t Banks)
...
DECL|HAL_FLASHEx_OB_GetBank2WRP|function|uint16_t HAL_FLASHEx_OB_GetBank2WRP(void)
