...
DECL|ClockSource|member|uint32_t ClockSource; /*!< Specifies the SAI Block x Clock source.
...
DECL|HAL_SAI_STATE_ERROR|enumerator|HAL_SAI_STATE_ERROR = 0x04U /*!< SAI error state */
...
DECL|HAL_SAI_STATE_TIMEOUT|enumerator|HAL_SAI_STATE_TIMEOUT = 0x03U, /*!< SAI timeout state */
...
DECL|__STM32F4xx_HAL_SAI_H|macro|__STM32F4xx_HAL_SAI_H
