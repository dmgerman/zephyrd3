...
DECL|Init|member|FMC_PCCARD_InitTypeDef Init; /*!< PCCARD device control configuration parameters */
DECL|Instance|member|FMC_PCCARD_TypeDef *Instance; /*!< Register base address for PCCARD device */
...
DECL|__STM32F4xx_HAL_PCCARD_H|macro|__STM32F4xx_HAL_PCCARD_H
