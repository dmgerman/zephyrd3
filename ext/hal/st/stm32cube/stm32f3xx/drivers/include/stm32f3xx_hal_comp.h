...
DECL|HAL_COMP_STATE_READY_LOCKED|enumerator|HAL_COMP_STATE_READY_LOCKED = 0x11U, /*!< COMP initialized but the configuration is locked */
DECL|HAL_COMP_STATE_READY|enumerator|HAL_COMP_STATE_READY = 0x01U, /*!< COMP initialized and ready for use */
DECL|HAL_COMP_STATE_RESET|enumerator|HAL_COMP_STATE_RESET = 0x00U, /*!< COMP not yet initialized or disabled */
...
DECL|WindowMode|member|uint32_t WindowMode; /*!< Selects the window mode of the comparator X (X=2U, 4 or 6 if available).
