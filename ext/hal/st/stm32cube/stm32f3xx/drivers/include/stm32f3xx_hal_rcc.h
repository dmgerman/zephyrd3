...
DECL|CFGR_REG_INDEX|macro|CFGR_REG_INDEX
...
DECL|HSEPredivValue|member|uint32_t HSEPredivValue; /*!< The HSE predivision factor value.
...
DECL|RCC_FLAG_MCO|macro|RCC_FLAG_MCO
...
DECL|__STM32F3xx_HAL_RCC_H|macro|__STM32F3xx_HAL_RCC_H
