...
DECL|PLLDiv|member|uint32_t PLLDiv; /*!< Division factor for PLL VCO output clock.
DECL|PLLMul|member|uint32_t PLLMul; /*!< Multiplication factor for PLL VCO input clock.
DECL|Prediv|member|uint32_t Prediv; /*!< Division factor for HSE used as PLL clock source.
DECL|UID_BASE_ADDRESS|macro|UID_BASE_ADDRESS
DECL|__STM32F3xx_LL_UTILS_H|macro|__STM32F3xx_LL_UTILS_H
