...
DECL|HAL_SPI_ERROR_UNKNOW|macro|HAL_SPI_ERROR_UNKNOW
DECL|HAL_SPI_STATE_BUSY_RX|enumerator|HAL_SPI_STATE_BUSY_RX = 0x04, /*!< Data Reception process is ongoing */
DECL|HAL_SPI_STATE_BUSY_TX_RX|enumerator|HAL_SPI_STATE_BUSY_TX_RX = 0x05, /*!< Data Transmission and Reception process is ongoing */
DECL|HAL_SPI_STATE_BUSY_TX|enumerator|HAL_SPI_STATE_BUSY_TX = 0x03, /*!< Data Transmission process is ongoing */
DECL|HAL_SPI_STATE_BUSY|enumerator|HAL_SPI_STATE_BUSY = 0x02, /*!< an internal process is ongoing */
DECL|HAL_SPI_STATE_ERROR|enumerator|HAL_SPI_STATE_ERROR = 0x06 /*!< SPI error state */
DECL|HAL_SPI_STATE_READY|enumerator|HAL_SPI_STATE_READY = 0x01, /*!< Peripheral Initialized and ready for use */
DECL|HAL_SPI_STATE_RESET|enumerator|HAL_SPI_STATE_RESET = 0x00, /*!< Peripheral not Initialized */
...
DECL|RxISR|member|void (*RxISR)(struct __SPI_HandleTypeDef *hspi); /*!< function pointer on Rx IRQ handler */
...
DECL|TxISR|member|void (*TxISR)(struct __SPI_HandleTypeDef *hspi); /*!< function pointer on Tx IRQ handler */
...
DECL|__STM32F3xx_HAL_SPI_H|macro|__STM32F3xx_HAL_SPI_H
