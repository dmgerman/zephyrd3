...
DECL|HAL_I2S_STATE_PAUSE|enumerator|HAL_I2S_STATE_PAUSE = 0x06U, /*!< I2S pause state: used in case of DMA */
...
DECL|__STM32F0xx_HAL_I2S_H|macro|__STM32F0xx_HAL_I2S_H
