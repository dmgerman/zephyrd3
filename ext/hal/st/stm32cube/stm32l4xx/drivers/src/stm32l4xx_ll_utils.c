...
DECL|IS_LL_UTILS_PLLR_VALUE|macro|IS_LL_UTILS_PLLR_VALUE
...
DECL|LL_PLL_ConfigSystemClock_MSI|function|ErrorStatus LL_PLL_ConfigSystemClock_MSI(LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct, LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
