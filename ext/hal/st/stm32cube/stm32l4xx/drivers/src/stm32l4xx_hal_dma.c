DECL|DMA_CalcDMAMUXChannelBaseAndMask|function|static void DMA_CalcDMAMUXChannelBaseAndMask(DMA_HandleTypeDef *hdma)
DECL|DMA_CalcDMAMUXRequestGenBaseAndMask|function|static void DMA_CalcDMAMUXRequestGenBaseAndMask(DMA_HandleTypeDef *hdma)
