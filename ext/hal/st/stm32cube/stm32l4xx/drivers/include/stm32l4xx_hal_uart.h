...
DECL|HAL_UART_ERROR_DMA|enumerator|HAL_UART_ERROR_DMA = 0x10U /*!< DMA transfer error */
DECL|HAL_UART_ERROR_FE|enumerator|HAL_UART_ERROR_FE = 0x04U, /*!< frame error */
DECL|HAL_UART_ERROR_NE|enumerator|HAL_UART_ERROR_NE = 0x02U, /*!< Noise error */
DECL|HAL_UART_ERROR_NONE|enumerator|HAL_UART_ERROR_NONE = 0x00U, /*!< No error */
DECL|HAL_UART_ERROR_ORE|enumerator|HAL_UART_ERROR_ORE = 0x08U, /*!< Overrun error */
DECL|HAL_UART_ERROR_PE|enumerator|HAL_UART_ERROR_PE = 0x01U, /*!< Parity error */
...
DECL|UARTPrescTable|variable|UARTPrescTable
