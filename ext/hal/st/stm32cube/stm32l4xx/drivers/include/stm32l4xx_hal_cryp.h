...
DECL|HAL_CRYP_PHASE_FINAL_OVER|enumerator|HAL_CRYP_PHASE_FINAL_OVER = 0x07, /*!< GCM/GMAC/CMAC final phase has been carried out */
DECL|HAL_CRYP_PHASE_HEADER_OVER|enumerator|HAL_CRYP_PHASE_HEADER_OVER = 0x05, /*!< GCM/GMAC/CMAC header phase has been carried out */
DECL|HAL_CRYP_PHASE_HEADER_SUSPENDED|enumerator|HAL_CRYP_PHASE_HEADER_SUSPENDED = 0x08, /*!< GCM/GMAC/CMAC header phase has been suspended */
DECL|HAL_CRYP_PHASE_INIT_OVER|enumerator|HAL_CRYP_PHASE_INIT_OVER = 0x04, /*!< GCM/GMAC/CMAC init phase has been carried out */
DECL|HAL_CRYP_PHASE_NOT_USED|enumerator|HAL_CRYP_PHASE_NOT_USED = 0x0a /*!< Phase is irrelevant to the current chaining mode */
DECL|HAL_CRYP_PHASE_PAYLOAD_OVER|enumerator|HAL_CRYP_PHASE_PAYLOAD_OVER = 0x06, /*!< GCM/GMAC/CMAC payload phase has been carried out */
DECL|HAL_CRYP_PHASE_PAYLOAD_SUSPENDED|enumerator|HAL_CRYP_PHASE_PAYLOAD_SUSPENDED = 0x09, /*!< GCM/GMAC payload phase has been suspended */
...
DECL|HAL_CRYP_PHASE_START|enumerator|HAL_CRYP_PHASE_START = 0x03, /*!< CRYP peripheral has been initialized but GCM/GMAC/CMAC
...
DECL|Header|member|uint8_t* Header; /*!< Header used in GCM/GMAC and CMAC modes */
...
DECL|Phase|member|HAL_PhaseTypeDef Phase; /*!< CRYP peripheral processing phase for GCM, GMAC or CMAC modes.
...
DECL|pInitVect|member|uint8_t* pInitVect; /*!< Initialization Vector used for CTR, CBC, GCM/GMAC and CMAC modes */
