...
DECL|CLOCK_SetRmii0Clock|function|static inline void CLOCK_SetRmii0Clock(uint32_t src)
DECL|CLOCK_SetRtcClkOutClock|function|static inline void CLOCK_SetRtcClkOutClock(uint32_t src)
DECL|CLOCK_SetSdhc0Clock|function|static inline void CLOCK_SetSdhc0Clock(uint32_t src)
...
DECL|DSPI2_CLK_SRC|macro|DSPI2_CLK_SRC
...
DECL|I2C2_CLK_SRC|macro|I2C2_CLK_SRC
...
DECL|UART3_CLK_SRC|macro|UART3_CLK_SRC
DECL|UART4_CLK_SRC|macro|UART4_CLK_SRC
DECL|UART5_CLK_SRC|macro|UART5_CLK_SRC
...
DECL|kCLOCK_Adc1|enumerator|kCLOCK_Adc1 = CLK_GATE_DEFINE(0x1030U, 27U),
...
DECL|kCLOCK_Cmp2|enumerator|kCLOCK_Cmp2 = CLK_GATE_DEFINE(0x1034U, 19U),
...
DECL|kCLOCK_Dac0|enumerator|kCLOCK_Dac0 = CLK_GATE_DEFINE(0x102CU, 12U),
DECL|kCLOCK_Dac1|enumerator|kCLOCK_Dac1 = CLK_GATE_DEFINE(0x102CU, 13U),
...
DECL|kCLOCK_Enet0|enumerator|kCLOCK_Enet0 = CLK_GATE_DEFINE(0x102CU, 0U),
...
DECL|kCLOCK_FastPeriphClk|enumerator|kCLOCK_FastPeriphClk, /*!< Fast peripheral clock */
...
DECL|kCLOCK_Flexbus0|enumerator|kCLOCK_Flexbus0 = CLK_GATE_DEFINE(0x1040U, 0U),
DECL|kCLOCK_Flexcan0|enumerator|kCLOCK_Flexcan0 = CLK_GATE_DEFINE(0x103CU, 4U),
...
DECL|kCLOCK_Ftm3|enumerator|kCLOCK_Ftm3 = CLK_GATE_DEFINE(0x1030U, 25U),
...
DECL|kCLOCK_I2c2|enumerator|kCLOCK_I2c2 = CLK_GATE_DEFINE(0x1028U, 6U),
...
DECL|kCLOCK_McgIrc48MClk|enumerator|kCLOCK_McgIrc48MClk, /*!< MCG IRC48M clock */
...
DECL|kCLOCK_Sdhc0|enumerator|kCLOCK_Sdhc0 = CLK_GATE_DEFINE(0x1030U, 17U),
...
DECL|kCLOCK_Uart3|enumerator|kCLOCK_Uart3 = CLK_GATE_DEFINE(0x1034U, 13U),
DECL|kCLOCK_Uart4|enumerator|kCLOCK_Uart4 = CLK_GATE_DEFINE(0x1028U, 10U),
DECL|kCLOCK_Uart5|enumerator|kCLOCK_Uart5 = CLK_GATE_DEFINE(0x1028U, 11U),
DECL|kCLOCK_UsbSrcExt|enumerator|kCLOCK_UsbSrcExt = SIM_SOPT2_USBSRC(0U) /*!< Use USB_CLKIN. */
DECL|kCLOCK_UsbSrcIrc48M|enumerator|kCLOCK_UsbSrcIrc48M = SIM_SOPT2_USBSRC(1U) | SIM_SOPT2_PLLFLLSEL(3U), /*!< Use IRC48M. */
...
DECL|kMCG_OscselIrc|enumerator|kMCG_OscselIrc /*!< Selects 48 MHz IRC Oscillator */
