...
DECL|addressingMode|member|i2c_slave_address_mode_t addressingMode; /*!< Addressing mode configuration of i2c_slave_address_mode_config_t. */
...
DECL|completionCallback|member|i2c_master_transfer_callback_t completionCallback; /*!< Callback function called when transfer finished. */
...
DECL|flags|member|uint32_t flags; /*!< Transfer flag which controls the transfer. */
...
DECL|kI2C_Read|enumerator|kI2C_Read = 0x1U, /*!< Master receive from slave. */
...
DECL|kI2C_SlaveRepeatedStartEvent|enumerator|kI2C_SlaveRepeatedStartEvent = 0x10U, /*!< A repeated start was detected. */
DECL|kI2C_SlaveTransmitAckEvent|enumerator|kI2C_SlaveTransmitAckEvent = 0x08U, /*!< Callback needs to either transmit an ACK or NACK. */
...
DECL|kI2C_TransferDefaultFlag|enumerator|kI2C_TransferDefaultFlag = 0x0U, /*!< Transfer starts with a start signal, stops with a stop signal. */
DECL|kI2C_TransferDirectionFlag|enumerator|kI2C_TransferDirectionFlag = I2C_S_SRW_MASK, /*!< I2C transfer direction flag. */
DECL|kI2C_TransferNoStartFlag|enumerator|kI2C_TransferNoStartFlag = 0x1U, /*!< Transfer starts without a start signal. */
DECL|kI2C_TransferNoStopFlag|enumerator|kI2C_TransferNoStopFlag = 0x4U, /*!< Transfer ends without a stop signal. */
DECL|kI2C_TransferRepeatedStartFlag|enumerator|kI2C_TransferRepeatedStartFlag = 0x2U, /*!< Transfer starts with a repeated start signal. */
DECL|kI2C_Write|enumerator|kI2C_Write = 0x0U, /*!< Master transmit to slave. */
...
DECL|slaveAddress|member|uint16_t slaveAddress; /*!< Slave address configuration. */
...
DECL|upperAddress|member|uint16_t upperAddress; /*!< Maximum boundary slave address used in range matching mode. */
