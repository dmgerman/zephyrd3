...
DECL|kFLEXCAN_ErrorFlag|enumerator|kFLEXCAN_ErrorFlag = CAN_ESR1_BIT1ERR_MASK | /*!< All FlexCAN Error Status. */
...
DECL|preDivider|member|uint8_t preDivider; /*!< Clock Pre-scaler Division Factor. */
