...
DECL|kPORT_OpenDrainDisable|enumerator|kPORT_OpenDrainDisable = 0U, /*!< internal pull-down resistor is disabled. */
DECL|kPORT_OpenDrainEnable|enumerator|kPORT_OpenDrainEnable = 1U, /*!< internal pull-up resistor is enabled. */
DECL|kPORT_PassiveFilterDisable|enumerator|kPORT_PassiveFilterDisable = 0U, /*!< fast slew rate is configured. */
DECL|kPORT_PassiveFilterEnable|enumerator|kPORT_PassiveFilterEnable = 1U, /*!< slow slew rate is configured. */
