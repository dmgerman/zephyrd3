...
DECL|GPT_Init|function|void GPT_Init(GPT_Type *base, const gpt_config_t *initConfig)
DECL|s_gptBases|variable|s_gptBases
DECL|s_gptClocks|variable|s_gptClocks
