...
DECL|kENET_ControlVLANTagEnable|enumerator|kENET_ControlVLANTagEnable = 0x0200U /*!< Enable VLAN tag frame. */
...
DECL|kENET_RmiiMode|enumerator|kENET_RmiiMode /*!< RMII mode for data interface. */
...
DECL|kStatus_ENET_TxFrameBusy|enumerator|kStatus_ENET_TxFrameBusy =
DECL|kStatus_ENET_TxFrameFail|enumerator|kStatus_ENET_TxFrameFail = MAKE_STATUS(kStatusGroup_ENET, 4U) /*!< Transmit frame fail. */
...
DECL|txBdBase|member|volatile enet_tx_bd_struct_t *txBdBase; /*!< Transmit buffer descriptor base address pointer. */
DECL|txBdCurrent|member|volatile enet_tx_bd_struct_t *txBdCurrent; /*!< The current available transmit buffer descriptor pointer. */
DECL|txBdDirtyStatic|member|volatile enet_tx_bd_struct_t *txBdDirtyStatic; /*!< The dirty transmit buffer descriptor for error static update. */
DECL|txBdDirtyTime|member|volatile enet_tx_bd_struct_t *txBdDirtyTime; /*!< The dirty transmit buffer descriptor for time stamp update. */
DECL|txBdNumber|member|uint16_t txBdNumber; /*!< Transmit buffer descriptor number. */
DECL|txBdStartAddrAlign|member|volatile enet_tx_bd_struct_t *txBdStartAddrAlign; /*!< Aligned transmit buffer descriptor start address. */
