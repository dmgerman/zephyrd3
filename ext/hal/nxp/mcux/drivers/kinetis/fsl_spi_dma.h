...
DECL|SPI_SlaveTransferCreateHandleDMA|function|static inline void SPI_SlaveTransferCreateHandleDMA(SPI_Type *base, spi_dma_handle_t *handle, spi_dma_callback_t callback, void *userData, dma_handle_t *txHandle,
...
DECL|rxInProgress|member|bool rxInProgress; /*!< Receive transfer finished */
...
DECL|txInProgress|member|bool txInProgress; /*!< Send transfer finished */
