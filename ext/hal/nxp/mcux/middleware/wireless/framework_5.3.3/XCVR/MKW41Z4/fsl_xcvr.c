...
DECL|RF_OSCILLATOR_READY|macro|RF_OSCILLATOR_READY
DECL|RF_OSCILLATOR_STAYS_ON|macro|RF_OSCILLATOR_STAYS_ON
...
DECL|XCVR_CoexistenceSaveRestoreTimings|function|xcvrStatus_t XCVR_CoexistenceSaveRestoreTimings(uint8_t saveTimings)
...
DECL|XCVR_Configure|function|xcvrStatus_t XCVR_Configure(const xcvr_common_config_t *com_config, const xcvr_mode_config_t *mode_config, const xcvr_mode_datarate_config_t *mode_datarate_config, const xcvr_datarate_config_t *datarate_config, int16_t tempDegC,
...
DECL|XCVR_GetBSM_NTW_Address|function|uint32_t XCVR_GetBSM_NTW_Address(void)
DECL|XCVR_GetCurrentConfig|function|xcvrStatus_t XCVR_GetCurrentConfig(xcvr_currConfig_t * curr_config)
DECL|XCVR_GetDefaultConfig|function|xcvrStatus_t XCVR_GetDefaultConfig(radio_mode_t radio_mode, data_rate_t data_rate, const xcvr_common_config_t ** com_config, const xcvr_mode_config_t ** mode_config, const xcvr_mode_datarate_config_t ** mode_datarate_config,
...
DECL|XCVR_SetBSM_NTW_Address|function|void XCVR_SetBSM_NTW_Address(uint32_t bsm_ntw_address)
...
DECL|mode_configs_dr_2mbps|variable|mode_configs_dr_2mbps
DECL|mode_configs_dr_500kbps|variable|mode_configs_dr_500kbps
DECL|numerator|member|unsigned int numerator;
DECL|rf_osc_shutdown|function|void rf_osc_shutdown(void)
DECL|rf_osc_startup|function|void rf_osc_startup(void)
