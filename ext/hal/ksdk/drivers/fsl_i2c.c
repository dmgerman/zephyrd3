...
DECL|I2C_MasterReadBlocking|function|status_t I2C_MasterReadBlocking(I2C_Type *base, uint8_t *rxBuff, size_t rxSize)
...
DECL|I2C_MasterWriteBlocking|function|status_t I2C_MasterWriteBlocking(I2C_Type *base, const uint8_t *txBuff, size_t txSize)
...
DECL|I2C_SlaveInit|function|void I2C_SlaveInit(I2C_Type *base, const i2c_slave_config_t *slaveConfig)
