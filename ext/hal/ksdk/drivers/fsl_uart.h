...
DECL|kUART_RxActiveEdgeFlag|enumerator|kUART_RxActiveEdgeFlag = (UART_S2_RXEDGIF_MASK << 8), /*!< RX pin active edge interrupt flag,
...
DECL|kUART_RxActiveFlag|enumerator|kUART_RxActiveFlag = (UART_S2_RAF_MASK << 8), /*!< Receiver Active Flag (RAF),
...
DECL|kUART_RxFifoOverflowInterruptEnable|enumerator|kUART_RxFifoOverflowInterruptEnable = (UART_CFIFO_TXOFE_MASK << 24), /*!< TX FIFO overflow interrupt. */
...
DECL|kUART_TxFifoOverflowInterruptEnable|enumerator|kUART_TxFifoOverflowInterruptEnable = (UART_CFIFO_RXUFE_MASK << 24), /*!< RX FIFO underflow interrupt. */
