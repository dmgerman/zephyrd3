...
DECL|CLOCK_BootToFeiMode|function|status_t CLOCK_BootToFeiMode(mcg_drs_t drs, void (*fllStableDelay)(void))
...
DECL|CLOCK_GetFlexBusClkFreq|function|uint32_t CLOCK_GetFlexBusClkFreq(void)
...
DECL|CLOCK_SetFbiMode|function|status_t CLOCK_SetFbiMode(mcg_drs_t drs, void (*fllStableDelay)(void))
...
DECL|CLOCK_SetFeiMode|function|status_t CLOCK_SetFeiMode(mcg_drs_t drs, void (*fllStableDelay)(void))
...
DECL|SIM_CLKDIV1_OUTDIV3_VAL|macro|SIM_CLKDIV1_OUTDIV3_VAL
