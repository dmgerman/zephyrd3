DECL|qm_flash_check_otp_locked|function|static __inline__ bool qm_flash_check_otp_locked(const uint32_t flash_stts)
...
DECL|qm_flash_restore_context|function|int qm_flash_restore_context(const qm_flash_t flash, const qm_flash_context_t *const ctx)
DECL|qm_flash_restore_context|function|int qm_flash_restore_context(const qm_flash_t flash, const qm_flash_context_t *const ctx)
DECL|qm_flash_save_context|function|int qm_flash_save_context(const qm_flash_t flash, qm_flash_context_t *const ctx)
DECL|qm_flash_save_context|function|int qm_flash_save_context(const qm_flash_t flash, qm_flash_context_t *const ctx)
