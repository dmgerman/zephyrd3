...
DECL|QM_ISR_DECLARE|function|QM_ISR_DECLARE(qm_ss_spi_0_error_isr)
DECL|QM_ISR_DECLARE|function|QM_ISR_DECLARE(qm_ss_spi_0_rx_avail_isr)
DECL|QM_ISR_DECLARE|function|QM_ISR_DECLARE(qm_ss_spi_0_tx_req_isr)
DECL|QM_ISR_DECLARE|function|QM_ISR_DECLARE(qm_ss_spi_1_error_isr)
DECL|QM_ISR_DECLARE|function|QM_ISR_DECLARE(qm_ss_spi_1_rx_avail_isr)
DECL|QM_ISR_DECLARE|function|QM_ISR_DECLARE(qm_ss_spi_1_tx_req_isr)
...
DECL|qm_ss_spi_irq_transfer_terminate|function|int qm_ss_spi_irq_transfer_terminate(const qm_ss_spi_t spi)
...
DECL|qm_ss_spi_restore_context|function|int qm_ss_spi_restore_context(const qm_ss_spi_t spi, const qm_ss_spi_context_t *const ctx)
DECL|qm_ss_spi_restore_context|function|int qm_ss_spi_restore_context(const qm_ss_spi_t spi, const qm_ss_spi_context_t *const ctx)
DECL|qm_ss_spi_save_context|function|int qm_ss_spi_save_context(const qm_ss_spi_t spi, qm_ss_spi_context_t *const ctx)
DECL|qm_ss_spi_save_context|function|int qm_ss_spi_save_context(const qm_ss_spi_t spi, qm_ss_spi_context_t *const ctx)
