...
DECL|qm_ss_irq_enable|function|void qm_ss_irq_enable(void)
DECL|qm_ss_irq_mask|function|void qm_ss_irq_mask(uint32_t irq)
DECL|qm_ss_irq_request|function|void qm_ss_irq_request(uint32_t irq, qm_ss_isr_t isr)
DECL|qm_ss_irq_unmask|function|void qm_ss_irq_unmask(uint32_t irq)
