...
DECL|QM_SPI_RX_FULL|enumerator|QM_SPI_RX_FULL, /**< Appl. Rx buffer full (slave only). */
...
DECL|QM_SPI_TX_EMPTY|enumerator|QM_SPI_TX_EMPTY /**< Appl. Tx buffer empty (slave only) . */
DECL|QM_SPI_UPDATE_RX|enumerator|QM_SPI_UPDATE_RX = BIT(0), /* Update RX. */
DECL|QM_SPI_UPDATE_TX|enumerator|QM_SPI_UPDATE_TX = BIT(1), /* Update TX. */
...
DECL|keep_enabled|member|bool keep_enabled; /**< Keep device on once transfer is done. */
...
DECL|qm_spi_update_t|typedef|} qm_spi_update_t;
