...
DECL|CCSIDR_SETS|macro|CCSIDR_SETS
DECL|CCSIDR_WAYS|macro|CCSIDR_WAYS
...
DECL|ID_AFR|member|__IM uint32_t ID_AFR; /*!< Offset: 0x04C (R/ ) Auxiliary Feature Register */
DECL|ID_DFR|member|__IM uint32_t ID_DFR; /*!< Offset: 0x048 (R/ ) Debug Feature Register */
DECL|ID_ISAR|member|__IM uint32_t ID_ISAR[5U]; /*!< Offset: 0x060 (R/ ) Instruction Set Attributes Register */
DECL|ID_MFR|member|__IM uint32_t ID_MFR[4U]; /*!< Offset: 0x050 (R/ ) Memory Model Feature Register */
...
DECL|LAR|member|__OM uint32_t LAR; /*!< Offset: 0xFB0 ( W) Lock Access Register */
...
DECL|MVFR2|member|__IM uint32_t MVFR2; /*!< Offset: 0x018 (R/ ) Media and FP Feature Register 2 */
...
DECL|RESERVED3|member|uint32_t RESERVED3[93U];
DECL|RESERVED3|member|uint32_t RESERVED3[981U];
...
DECL|SCB_CleanDCache_by_Addr|function|__STATIC_INLINE void SCB_CleanDCache_by_Addr (uint32_t *addr, int32_t dsize)
DECL|SCB_CleanDCache|function|__STATIC_INLINE void SCB_CleanDCache (void)
DECL|SCB_CleanInvalidateDCache_by_Addr|function|__STATIC_INLINE void SCB_CleanInvalidateDCache_by_Addr (uint32_t *addr, int32_t dsize)
DECL|SCB_CleanInvalidateDCache|function|__STATIC_INLINE void SCB_CleanInvalidateDCache (void)
...
DECL|SCB_DisableDCache|function|__STATIC_INLINE void SCB_DisableDCache (void)
DECL|SCB_DisableICache|function|__STATIC_INLINE void SCB_DisableICache (void)
DECL|SCB_EnableDCache|function|__STATIC_INLINE void SCB_EnableDCache (void)
DECL|SCB_EnableICache|function|__STATIC_INLINE void SCB_EnableICache (void)
...
DECL|SCB_InvalidateDCache_by_Addr|function|__STATIC_INLINE void SCB_InvalidateDCache_by_Addr (uint32_t *addr, int32_t dsize)
DECL|SCB_InvalidateDCache|function|__STATIC_INLINE void SCB_InvalidateDCache (void)
DECL|SCB_InvalidateICache|function|__STATIC_INLINE void SCB_InvalidateICache (void)
...
DECL|SCnSCB_ACTLR_DISITMATBFLUSH_Msk|macro|SCnSCB_ACTLR_DISITMATBFLUSH_Msk
DECL|SCnSCB_ACTLR_DISITMATBFLUSH_Pos|macro|SCnSCB_ACTLR_DISITMATBFLUSH_Pos
...
DECL|SCnSCB_ACTLR_DISRAMODE_Msk|macro|SCnSCB_ACTLR_DISRAMODE_Msk
DECL|SCnSCB_ACTLR_DISRAMODE_Pos|macro|SCnSCB_ACTLR_DISRAMODE_Pos
DECL|SCnSCB_ACTLR_FPEXCODIS_Msk|macro|SCnSCB_ACTLR_FPEXCODIS_Msk
DECL|SCnSCB_ACTLR_FPEXCODIS_Pos|macro|SCnSCB_ACTLR_FPEXCODIS_Pos
...
DECL|__CM7_CMSIS_VERSION_MAIN|macro|__CM7_CMSIS_VERSION_MAIN
DECL|__CM7_CMSIS_VERSION_SUB|macro|__CM7_CMSIS_VERSION_SUB
DECL|__CM7_CMSIS_VERSION|macro|__CM7_CMSIS_VERSION
DECL|__CM7_REV|macro|__CM7_REV
DECL|__CORE_CM7_H_DEPENDANT|macro|__CORE_CM7_H_DEPENDANT
DECL|__CORE_CM7_H_GENERIC|macro|__CORE_CM7_H_GENERIC
