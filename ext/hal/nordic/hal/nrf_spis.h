...
DECL|nrf_spis_rx_amount_get|function|__STATIC_INLINE uint8_t nrf_spis_rx_amount_get(NRF_SPIS_Type const * p_reg)
DECL|nrf_spis_rx_buffer_set|function|__STATIC_INLINE void nrf_spis_rx_buffer_set(NRF_SPIS_Type * p_reg, uint8_t * p_buffer, uint8_t length)
...
DECL|nrf_spis_tx_amount_get|function|__STATIC_INLINE uint8_t nrf_spis_tx_amount_get(NRF_SPIS_Type const * p_reg)
DECL|nrf_spis_tx_buffer_set|function|__STATIC_INLINE void nrf_spis_tx_buffer_set(NRF_SPIS_Type * p_reg, uint8_t const * p_buffer, uint8_t length)
