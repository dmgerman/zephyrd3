...
DECL|NRF_UARTE_INT_NCTSRX_MASK|enumerator|NRF_UARTE_INT_NCTSRX_MASK = UARTE_INTENSET_NCTS_Msk, ///< Interrupt on NCTS event.
...
DECL|nrf_uarte_rx_buffer_set|function|__STATIC_INLINE void nrf_uarte_rx_buffer_set(NRF_UARTE_Type * p_reg, uint8_t * p_buffer, uint8_t length)
...
DECL|nrf_uarte_tx_buffer_set|function|__STATIC_INLINE void nrf_uarte_tx_buffer_set(NRF_UARTE_Type * p_reg, uint8_t const * p_buffer, uint8_t length)
