...
DECL|NRF_TWIM_INT_SUSPENDED_MASK|enumerator|NRF_TWIM_INT_SUSPENDED_MASK = (1 << 18), ///< Interrupt on SUSPENDED event.
...
DECL|nrf_twim_rx_buffer_set|function|__STATIC_INLINE void nrf_twim_rx_buffer_set(NRF_TWIM_Type * p_reg, uint8_t * p_buffer, uint8_t length)
...
DECL|nrf_twim_rxd_amount_get|function|__STATIC_INLINE uint32_t nrf_twim_rxd_amount_get(NRF_TWIM_Type * p_reg)
...
DECL|nrf_twim_tx_buffer_set|function|__STATIC_INLINE void nrf_twim_tx_buffer_set(NRF_TWIM_Type * p_reg, uint8_t const * p_buffer, uint8_t length)
...
DECL|nrf_twim_txd_amount_get|function|__STATIC_INLINE uint32_t nrf_twim_txd_amount_get(NRF_TWIM_Type * p_reg)
