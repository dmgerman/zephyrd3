...
DECL|CONFIG2|member|__IO uint32_t CONFIG2; /*!< Block protect configuration register 2 */
DECL|CONFIG3|member|__IO uint32_t CONFIG3; /*!< Block protect configuration register 3 */
...
DECL|DISABLEINDEBUG|member|__IO uint32_t DISABLEINDEBUG; /*!< Disable protection mechanism in debug interface mode */
...
DECL|EVENTS_ERROR|member|__IO uint32_t EVENTS_ERROR; /*!< CCM error event */
...
DECL|EVENTS_READY|member|__IO uint32_t EVENTS_READY; /*!< The NFC peripheral is ready to receive and send frames */
...
DECL|EVENTS_RXFRAMEEND|member|__IO uint32_t EVENTS_RXFRAMEEND; /*!< Received data have been checked (CRC, parity) and transferred
...
DECL|FREQUENCY|member|__IO uint32_t FREQUENCY; /*!< TWI frequency */
DECL|FREQUENCY|member|__IO uint32_t FREQUENCY; /*!< TWI frequency */
...
DECL|ISOURCE|member|__IO uint32_t ISOURCE; /*!< Current source select on analog input */
...
DECL|MAXLEN|member|__IO uint32_t MAXLEN; /*!< Size of allocated for TXD and RXD data storage buffer in Data
...
DECL|MISO|member|__IO uint32_t MISO; /*!< Pin select for MISO */
...
DECL|MOSI|member|__IO uint32_t MOSI; /*!< Pin select for MOSI */
...
DECL|RESERVED10|member|__I uint32_t RESERVED10[8];
DECL|RESERVED10|member|__I uint32_t RESERVED10[8];
...
DECL|RESERVED11|member|__I uint32_t RESERVED11[225];
...
DECL|RESERVED6|member|__I uint32_t RESERVED6[4];
DECL|RESERVED6|member|__I uint32_t RESERVED6[53];
...
DECL|RESERVED7|member|__I uint32_t RESERVED7[8];
...
DECL|RESERVED9|member|__I uint32_t RESERVED9[11];
...
DECL|RX|member|__IO uint32_t RX; /*!< Result of last incoming frames */
...
DECL|TASKS_ACTIVATE|member|__O uint32_t TASKS_ACTIVATE; /*!< Activate NFC peripheral for incoming and outgoing frames, change
...
DECL|TASKS_DISABLE|member|__O uint32_t TASKS_DISABLE; /*!< Disable NFC peripheral */
...
DECL|TASKS_STARTTX|member|__O uint32_t TASKS_STARTTX; /*!< Start UART transmitter */
DECL|TASKS_STARTTX|member|__O uint32_t TASKS_STARTTX; /*!< Start transmission of a outgoing frame, change state to transmit */
