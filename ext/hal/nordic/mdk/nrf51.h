DECL|AAR|member|__IO uint32_t AAR; /*!< Configurable priority configuration register for AAR. */
...
DECL|CCM|member|__IO uint32_t CCM; /*!< Configurable priority configuration register for CCM. */
...
DECL|CPU0|member|__IO uint32_t CPU0; /*!< Configurable priority configuration register for CPU0. */
...
DECL|ECB|member|__IO uint32_t ECB; /*!< Configurable priority configuration register for ECB. */
...
DECL|RADIO|member|__IO uint32_t RADIO; /*!< Configurable priority configuration register for RADIO. */
...
DECL|SPIS1|member|__IO uint32_t SPIS1; /*!< Configurable priority configuration register for SPIS1. */
