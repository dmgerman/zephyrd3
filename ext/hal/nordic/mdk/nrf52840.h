...
DECL|DISABLEINDEBUG|member|__IO uint32_t DISABLEINDEBUG; /*!< Disable all ACL protection mechanisms for regions while in debug
...
DECL|ENABLE|member|__IO uint32_t ENABLE; /*!< Control power and clock for ARM CryptoCell subsystem */
...
DECL|EXTREFSEL|member|__IO uint32_t EXTREFSEL; /*!< External reference select */
DECL|EXTSUPPLY|member|__IO uint32_t EXTSUPPLY; /*!< Enable external circuitry to be supplied from VDD pin. Applicable
...
DECL|ISOOUT|member|__IO uint32_t ISOOUT; /*!< Amount of bytes received last on this iso OUT data endpoint */
...
DECL|RESERVED0|member|__I uint32_t RESERVED0[3];
DECL|RESERVED0|member|__I uint32_t RESERVED0[449];
...
DECL|RESERVED11|member|__I uint32_t RESERVED11[39];
...
DECL|RESERVED14|member|__I uint32_t RESERVED14[611];
DECL|RESERVED15|member|__I uint32_t RESERVED15;
DECL|RESERVED15|member|__I uint32_t RESERVED15[22];
...
DECL|RESERVED1|member|__I uint32_t RESERVED1[61];
DECL|RESERVED1|member|__I uint32_t RESERVED1[62];
...
DECL|RESERVED3|member|__I uint32_t RESERVED3[40];
...
DECL|RESERVED7|member|__I uint32_t RESERVED7[11];
...
DECL|RESERVED9|member|__I uint32_t RESERVED9[3];
...
DECL|SPIM3_IRQn|enumerator|SPIM3_IRQn = 43, /*!< 43 SPIM3 */
...
DECL|STATUS|member|__I uint32_t STATUS; /*!< Timer status */
