...
DECL|CRC|member|uint8_t CRC:1; /*!< bit: 2 32-bit Cyclic Redundancy Check */
...
DECL|DIE|member|uint32_t DIE:4; /*!< bit: 12..15 Die Identification */
...
DECL|DSU_ENTRY_ADDOFF_Msk|macro|DSU_ENTRY_ADDOFF_Msk
DECL|DSU_ENTRY_ADDOFF_Pos|macro|DSU_ENTRY_ADDOFF_Pos
DECL|DSU_ENTRY_ADDOFF|macro|DSU_ENTRY_ADDOFF
DECL|DSU_ENTRY_EPRES_Pos|macro|DSU_ENTRY_EPRES_Pos
DECL|DSU_ENTRY_EPRES|macro|DSU_ENTRY_EPRES
DECL|DSU_ENTRY_FMT_Pos|macro|DSU_ENTRY_FMT_Pos
DECL|DSU_ENTRY_FMT|macro|DSU_ENTRY_FMT
DECL|DSU_ENTRY_MASK|macro|DSU_ENTRY_MASK
DECL|DSU_ENTRY_OFFSET|macro|DSU_ENTRY_OFFSET
DECL|DSU_ENTRY_RESETVALUE|macro|DSU_ENTRY_RESETVALUE
DECL|DSU_ENTRY_Type|typedef|} DSU_ENTRY_Type;
...
DECL|ENTRY|member|__I DSU_ENTRY_Type ENTRY[2]; /**< \brief Offset: 0x1000 (R/ 32) Coresight ROM Table Entry n */
DECL|EPRES|member|uint32_t EPRES:1; /*!< bit: 0 Entry Present */
DECL|FAIL_|member|uint8_t FAIL_:1; /*!< bit: 3 Failure */
DECL|FAMILY|member|uint32_t FAMILY:5; /*!< bit: 23..27 Product Family */
...
DECL|REVISION|member|uint32_t REVISION:4; /*!< bit: 8..11 Revision */
DECL|REV_DSU|macro|REV_DSU
DECL|Reserved1|member|RoReg8 Reserved1[0x1];
DECL|Reserved2|member|RoReg8 Reserved2[0xFE4];
DECL|Reserved3|member|RoReg8 Reserved3[0xFC0];
DECL|Reserved4|member|RoReg8 Reserved4[0xC];
DECL|SERIES|member|uint32_t SERIES:6; /*!< bit: 16..21 Product Series */
...
DECL|_SAMD21_DSU_COMPONENT_|macro|_SAMD21_DSU_COMPONENT_
