...
DECL|COUNT|member|uint16_t COUNT:16; /*!< bit: 0..15 Count Value */
DECL|COUNT|member|uint32_t COUNT:32; /*!< bit: 0..31 Count Value */
...
DECL|_SAMD21_TC_COMPONENT_|macro|_SAMD21_TC_COMPONENT_
