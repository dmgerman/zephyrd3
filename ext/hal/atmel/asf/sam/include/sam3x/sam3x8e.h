DECL|ADC_IRQn|enumerator|ADC_IRQn = 37, /**< 37 SAM3X8E ADC Controller (ADC) */
DECL|ADC|macro|ADC
DECL|ADC|macro|ADC
DECL|BusFault_IRQn|enumerator|BusFault_IRQn = -11, /**< 5 Cortex-M3 Bus Fault Interrupt */
DECL|CAN0_IRQn|enumerator|CAN0_IRQn = 43, /**< 43 SAM3X8E CAN Controller 0 (CAN0) */
DECL|CAN0|macro|CAN0
DECL|CAN0|macro|CAN0
DECL|CAN1_IRQn|enumerator|CAN1_IRQn = 44, /**< 44 SAM3X8E CAN Controller 1 (CAN1) */
...
DECL|DACC_IRQn|enumerator|DACC_IRQn = 38, /**< 38 SAM3X8E DAC Controller (DACC) */
DECL|DACC|macro|DACC
DECL|DACC|macro|DACC
DECL|DMAC_IRQn|enumerator|DMAC_IRQn = 39, /**< 39 SAM3X8E DMA Controller (DMAC) */
...
DECL|EFC0_IRQn|enumerator|EFC0_IRQn = 6, /**< 6 SAM3X8E Enhanced Flash Controller 0 (EFC0) */
DECL|EFC0|macro|EFC0
DECL|EFC0|macro|EFC0
DECL|EFC1_IRQn|enumerator|EFC1_IRQn = 7, /**< 7 SAM3X8E Enhanced Flash Controller 1 (EFC1) */
DECL|EFC1|macro|EFC1
DECL|EFC1|macro|EFC1
DECL|EMAC_IRQn|enumerator|EMAC_IRQn = 42, /**< 42 SAM3X8E Ethernet MAC (EMAC) */
DECL|EMAC|macro|EMAC
DECL|EMAC|macro|EMAC
DECL|GPBR|macro|GPBR
DECL|GPBR|macro|GPBR
DECL|HSMCI_IRQn|enumerator|HSMCI_IRQn = 21, /**< 21 SAM3X8E Multimedia Card Interface (HSMCI) */
...
DECL|PIOA_IRQn|enumerator|PIOA_IRQn = 11, /**< 11 SAM3X8E Parallel I/O Controller A, (PIOA) */
DECL|PIOA|macro|PIOA
DECL|PIOA|macro|PIOA
DECL|PIOB_IRQn|enumerator|PIOB_IRQn = 12, /**< 12 SAM3X8E Parallel I/O Controller B (PIOB) */
DECL|PIOB|macro|PIOB
DECL|PIOB|macro|PIOB
DECL|PIOC_IRQn|enumerator|PIOC_IRQn = 13, /**< 13 SAM3X8E Parallel I/O Controller C (PIOC) */
DECL|PIOC|macro|PIOC
DECL|PIOC|macro|PIOC
DECL|PIOD_IRQn|enumerator|PIOD_IRQn = 14, /**< 14 SAM3X8E Parallel I/O Controller D (PIOD) */
DECL|PIOD|macro|PIOD
DECL|PIOD|macro|PIOD
DECL|PMC_IRQn|enumerator|PMC_IRQn = 5, /**< 5 SAM3X8E Power Management Controller (PMC) */
DECL|PMC|macro|PMC
DECL|PMC|macro|PMC
DECL|PWM_IRQn|enumerator|PWM_IRQn = 36, /**< 36 SAM3X8E Pulse Width Modulation Controller (PWM) */
DECL|PWM|macro|PWM
DECL|PWM|macro|PWM
DECL|PendSV_IRQn|enumerator|PendSV_IRQn = -2, /**< 14 Cortex-M3 Pend SV Interrupt */
DECL|RSTC_IRQn|enumerator|RSTC_IRQn = 1, /**< 1 SAM3X8E Reset Controller (RSTC) */
DECL|RSTC|macro|RSTC
DECL|RSTC|macro|RSTC
DECL|RTC_IRQn|enumerator|RTC_IRQn = 2, /**< 2 SAM3X8E Real Time Clock (RTC) */
DECL|RTC|macro|RTC
DECL|RTC|macro|RTC
DECL|RTT_IRQn|enumerator|RTT_IRQn = 3, /**< 3 SAM3X8E Real Time Timer (RTT) */
DECL|RTT|macro|RTT
DECL|RTT|macro|RTT
DECL|SMC_IRQn|enumerator|SMC_IRQn = 9, /**< 9 SAM3X8E Static Memory Controller (SMC) */
DECL|SMC|macro|SMC
DECL|SMC|macro|SMC
DECL|SPI0_IRQn|enumerator|SPI0_IRQn = 24, /**< 24 SAM3X8E Serial Peripheral Interface (SPI0) */
DECL|SPI0|macro|SPI0
DECL|SPI0|macro|SPI0
DECL|SSC_IRQn|enumerator|SSC_IRQn = 26, /**< 26 SAM3X8E Synchronous Serial Controller (SSC) */
DECL|SSC|macro|SSC
DECL|SSC|macro|SSC
DECL|SUPC_IRQn|enumerator|SUPC_IRQn = 0, /**< 0 SAM3X8E Supply Controller (SUPC) */
...
DECL|TC0_IRQn|enumerator|TC0_IRQn = 27, /**< 27 SAM3X8E Timer Counter 0 (TC0) */
DECL|TC0|macro|TC0
DECL|TC0|macro|TC0
DECL|TC1_IRQn|enumerator|TC1_IRQn = 28, /**< 28 SAM3X8E Timer Counter 1 (TC1) */
DECL|TC1|macro|TC1
DECL|TC1|macro|TC1
DECL|TC2_IRQn|enumerator|TC2_IRQn = 29, /**< 29 SAM3X8E Timer Counter 2 (TC2) */
DECL|TC2|macro|TC2
DECL|TC2|macro|TC2
DECL|TC3_IRQn|enumerator|TC3_IRQn = 30, /**< 30 SAM3X8E Timer Counter 3 (TC3) */
DECL|TC4_IRQn|enumerator|TC4_IRQn = 31, /**< 31 SAM3X8E Timer Counter 4 (TC4) */
DECL|TC5_IRQn|enumerator|TC5_IRQn = 32, /**< 32 SAM3X8E Timer Counter 5 (TC5) */
DECL|TC6_IRQn|enumerator|TC6_IRQn = 33, /**< 33 SAM3X8E Timer Counter 6 (TC6) */
DECL|TC7_IRQn|enumerator|TC7_IRQn = 34, /**< 34 SAM3X8E Timer Counter 7 (TC7) */
DECL|TC8_IRQn|enumerator|TC8_IRQn = 35, /**< 35 SAM3X8E Timer Counter 8 (TC8) */
DECL|TRNG_IRQn|enumerator|TRNG_IRQn = 41, /**< 41 SAM3X8E True Random Number Generator (TRNG) */
DECL|TRNG|macro|TRNG
DECL|TRNG|macro|TRNG
DECL|TWI0_IRQn|enumerator|TWI0_IRQn = 22, /**< 22 SAM3X8E Two-Wire Interface 0 (TWI0) */
DECL|TWI0|macro|TWI0
DECL|TWI0|macro|TWI0
DECL|TWI1_IRQn|enumerator|TWI1_IRQn = 23, /**< 23 SAM3X8E Two-Wire Interface 1 (TWI1) */
DECL|TWI1|macro|TWI1
DECL|TWI1|macro|TWI1
DECL|UART_IRQn|enumerator|UART_IRQn = 8, /**< 8 SAM3X8E Universal Asynchronous Receiver Transceiver (UART) */
DECL|UART|macro|UART
DECL|UART|macro|UART
DECL|UOTGHS_IRQn|enumerator|UOTGHS_IRQn = 40, /**< 40 SAM3X8E USB OTG High Speed (UOTGHS) */
DECL|UOTGHS_RAM_ADDR|macro|UOTGHS_RAM_ADDR
DECL|UOTGHS|macro|UOTGHS
DECL|UOTGHS|macro|UOTGHS
DECL|USART0_IRQn|enumerator|USART0_IRQn = 17, /**< 17 SAM3X8E USART 0 (USART0) */
DECL|USART0|macro|USART0
DECL|USART0|macro|USART0
DECL|USART1_IRQn|enumerator|USART1_IRQn = 18, /**< 18 SAM3X8E USART 1 (USART1) */
DECL|USART1|macro|USART1
DECL|USART1|macro|USART1
DECL|USART2_IRQn|enumerator|USART2_IRQn = 19, /**< 19 SAM3X8E USART 2 (USART2) */
DECL|USART2|macro|USART2
DECL|USART2|macro|USART2
DECL|USART3_IRQn|enumerator|USART3_IRQn = 20, /**< 20 SAM3X8E USART 3 (USART3) */
...
DECL|WDT_IRQn|enumerator|WDT_IRQn = 4, /**< 4 SAM3X8E Watchdog Timer (WDT) */
DECL|WDT|macro|WDT
DECL|WDT|macro|WDT
DECL|_DeviceVectors|struct|typedef struct _DeviceVectors
DECL|_SAM3X8E_|macro|_SAM3X8E_
