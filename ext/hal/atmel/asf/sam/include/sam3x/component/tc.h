...
DECL|TC_BMR_FILTER|macro|TC_BMR_FILTER
...
DECL|TC_BMR_TC2XC2S_TIOA2|macro|TC_BMR_TC2XC2S_TIOA2
...
DECL|TC_WPMR|member|__IO uint32_t TC_WPMR; /**< \brief (Tc Offset: 0xE4) Write Protect Mode Register */
DECL|TcChannel|typedef|} TcChannel;
DECL|Tc|typedef|} Tc;
DECL|_SAM3XA_TC_COMPONENT_|macro|_SAM3XA_TC_COMPONENT_
