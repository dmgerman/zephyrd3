...
DECL|CKGR_MCFR|member|__I uint32_t CKGR_MCFR; /**< \brief (Pmc Offset: 0x0024) Main Clock Frequency Register */
...
DECL|CKGR_UCKR|member|__IO uint32_t CKGR_UCKR; /**< \brief (Pmc Offset: 0x001C) UTMI Clock Register */
...
DECL|PMC_FSMR|member|__IO uint32_t PMC_FSMR; /**< \brief (Pmc Offset: 0x0070) Fast Start-up Mode Register */
...
DECL|PMC_FSPR|member|__IO uint32_t PMC_FSPR; /**< \brief (Pmc Offset: 0x0074) Fast Start-up Polarity Register */
...
DECL|PMC_PCDR1_PID36|macro|PMC_PCDR1_PID36
DECL|PMC_PCDR1_PID37|macro|PMC_PCDR1_PID37
DECL|PMC_PCDR1_PID38|macro|PMC_PCDR1_PID38
...
DECL|PMC_PCER1_PID36|macro|PMC_PCER1_PID36
DECL|PMC_PCER1_PID37|macro|PMC_PCER1_PID37
DECL|PMC_PCER1_PID38|macro|PMC_PCER1_PID38
...
DECL|PMC_PCR_DIV_Msk|macro|PMC_PCR_DIV_Msk
DECL|PMC_PCR_DIV_PERIPH_DIV2_MCK|macro|PMC_PCR_DIV_PERIPH_DIV2_MCK
DECL|PMC_PCR_DIV_PERIPH_DIV4_MCK|macro|PMC_PCR_DIV_PERIPH_DIV4_MCK
DECL|PMC_PCR_DIV_PERIPH_DIV_MCK|macro|PMC_PCR_DIV_PERIPH_DIV_MCK
DECL|PMC_PCR_DIV_Pos|macro|PMC_PCR_DIV_Pos
...
DECL|PMC_PCR|member|__IO uint32_t PMC_PCR; /**< \brief (Pmc Offset: 0x010C) Peripheral Control Register */
...
DECL|PMC_PCSR1_PID36|macro|PMC_PCSR1_PID36
DECL|PMC_PCSR1_PID37|macro|PMC_PCSR1_PID37
DECL|PMC_PCSR1_PID38|macro|PMC_PCSR1_PID38
...
DECL|PMC_SCDR_UOTGCLK|macro|PMC_SCDR_UOTGCLK
...
DECL|PMC_SCER_UOTGCLK|macro|PMC_SCER_UOTGCLK
...
DECL|PMC_SCSR_UOTGCLK|macro|PMC_SCSR_UOTGCLK
...
DECL|PMC_WPMR|member|__IO uint32_t PMC_WPMR; /**< \brief (Pmc Offset: 0x00E4) Write Protect Mode Register */
...
DECL|PMC_WPSR|member|__I uint32_t PMC_WPSR; /**< \brief (Pmc Offset: 0x00E8) Write Protect Status Register */
...
DECL|_SAM3XA_PMC_COMPONENT_|macro|_SAM3XA_PMC_COMPONENT_
