...
DECL|ACC_IRQn|enumerator|ACC_IRQn = 33, /**< 33 SAM4S4A Analog Comparator (ACC) */
DECL|ACC|macro|ACC
DECL|ACC|macro|ACC
DECL|ADC_IRQn|enumerator|ADC_IRQn = 29, /**< 29 SAM4S4A Analog To Digital Converter (ADC) */
DECL|ADC|macro|ADC
DECL|ADC|macro|ADC
...
DECL|CRCCU_IRQn|enumerator|CRCCU_IRQn = 32, /**< 32 SAM4S4A CRC Calculation Unit (CRCCU) */
...
DECL|EFC0_IRQn|enumerator|EFC0_IRQn = 6, /**< 6 SAM4S4A Enhanced Embedded Flash Controller 0 (EFC0) */
...
DECL|PIOA_IRQn|enumerator|PIOA_IRQn = 11, /**< 11 SAM4S4A Parallel I/O Controller A (PIOA) */
DECL|PIOA|macro|PIOA
DECL|PIOA|macro|PIOA
DECL|PIOB_IRQn|enumerator|PIOB_IRQn = 12, /**< 12 SAM4S4A Parallel I/O Controller B (PIOB) */
DECL|PIOB|macro|PIOB
DECL|PIOB|macro|PIOB
DECL|PMC_IRQn|enumerator|PMC_IRQn = 5, /**< 5 SAM4S4A Power Management Controller (PMC) */
DECL|PMC|macro|PMC
DECL|PMC|macro|PMC
DECL|PWM_IRQn|enumerator|PWM_IRQn = 31, /**< 31 SAM4S4A Pulse Width Modulation (PWM) */
DECL|PWM|macro|PWM
DECL|PWM|macro|PWM
DECL|PendSV_IRQn|enumerator|PendSV_IRQn = -2, /**< 14 Cortex-M4 Pend SV Interrupt */
DECL|RSTC_IRQn|enumerator|RSTC_IRQn = 1, /**< 1 SAM4S4A Reset Controller (RSTC) */
DECL|RSTC|macro|RSTC
DECL|RSTC|macro|RSTC
DECL|RTC_IRQn|enumerator|RTC_IRQn = 2, /**< 2 SAM4S4A Real Time Clock (RTC) */
DECL|RTC|macro|RTC
DECL|RTC|macro|RTC
DECL|RTT_IRQn|enumerator|RTT_IRQn = 3, /**< 3 SAM4S4A Real Time Timer (RTT) */
DECL|RTT|macro|RTT
DECL|RTT|macro|RTT
DECL|SPI_IRQn|enumerator|SPI_IRQn = 21, /**< 21 SAM4S4A Serial Peripheral Interface (SPI) */
DECL|SPI|macro|SPI
DECL|SPI|macro|SPI
DECL|SSC_IRQn|enumerator|SSC_IRQn = 22, /**< 22 SAM4S4A Synchronous Serial Controller (SSC) */
DECL|SSC|macro|SSC
DECL|SSC|macro|SSC
DECL|SUPC_IRQn|enumerator|SUPC_IRQn = 0, /**< 0 SAM4S4A Supply Controller (SUPC) */
...
DECL|TC0_IRQn|enumerator|TC0_IRQn = 23, /**< 23 SAM4S4A Timer/Counter 0 (TC0) */
DECL|TC0|macro|TC0
DECL|TC0|macro|TC0
DECL|TC1_IRQn|enumerator|TC1_IRQn = 24, /**< 24 SAM4S4A Timer/Counter 1 (TC1) */
DECL|TC2_IRQn|enumerator|TC2_IRQn = 25, /**< 25 SAM4S4A Timer/Counter 2 (TC2) */
DECL|TWI0_IRQn|enumerator|TWI0_IRQn = 19, /**< 19 SAM4S4A Two Wire Interface 0 (TWI0) */
DECL|TWI0|macro|TWI0
DECL|TWI0|macro|TWI0
DECL|TWI1_IRQn|enumerator|TWI1_IRQn = 20, /**< 20 SAM4S4A Two Wire Interface 1 (TWI1) */
DECL|TWI1|macro|TWI1
DECL|TWI1|macro|TWI1
DECL|UART0_IRQn|enumerator|UART0_IRQn = 8, /**< 8 SAM4S4A UART 0 (UART0) */
DECL|UART0|macro|UART0
DECL|UART0|macro|UART0
DECL|UART1_IRQn|enumerator|UART1_IRQn = 9, /**< 9 SAM4S4A UART 1 (UART1) */
DECL|UART1|macro|UART1
DECL|UART1|macro|UART1
DECL|UDP_IRQn|enumerator|UDP_IRQn = 34, /**< 34 SAM4S4A USB Device Port (UDP) */
DECL|UDP|macro|UDP
DECL|UDP|macro|UDP
DECL|USART0_IRQn|enumerator|USART0_IRQn = 14, /**< 14 SAM4S4A USART 0 (USART0) */
...
DECL|WDT_IRQn|enumerator|WDT_IRQn = 4, /**< 4 SAM4S4A Watchdog Timer (WDT) */
DECL|WDT|macro|WDT
DECL|WDT|macro|WDT
DECL|_DeviceVectors|struct|typedef struct _DeviceVectors
DECL|_SAM4S4A_|macro|_SAM4S4A_
