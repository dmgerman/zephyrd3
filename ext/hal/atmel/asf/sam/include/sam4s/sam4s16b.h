...
DECL|ACC_IRQn|enumerator|ACC_IRQn = 33, /**< 33 SAM4S16B Analog Comparator (ACC) */
DECL|ACC|macro|ACC
DECL|ACC|macro|ACC
DECL|ADC_IRQn|enumerator|ADC_IRQn = 29, /**< 29 SAM4S16B Analog To Digital Converter (ADC) */
DECL|ADC|macro|ADC
DECL|ADC|macro|ADC
...
DECL|CRCCU_IRQn|enumerator|CRCCU_IRQn = 32, /**< 32 SAM4S16B CRC Calculation Unit (CRCCU) */
DECL|CRCCU|macro|CRCCU
DECL|CRCCU|macro|CRCCU
DECL|DACC_IRQn|enumerator|DACC_IRQn = 30, /**< 30 SAM4S16B Digital To Analog Converter (DACC) */
...
DECL|EFC0_IRQn|enumerator|EFC0_IRQn = 6, /**< 6 SAM4S16B Enhanced Embedded Flash Controller 0 (EFC0) */
DECL|EFC0|macro|EFC0
DECL|EFC0|macro|EFC0
DECL|GPBR|macro|GPBR
DECL|GPBR|macro|GPBR
DECL|HSMCI_IRQn|enumerator|HSMCI_IRQn = 18, /**< 18 SAM4S16B Multimedia Card Interface (HSMCI) */
...
DECL|PIOA_IRQn|enumerator|PIOA_IRQn = 11, /**< 11 SAM4S16B Parallel I/O Controller A (PIOA) */
DECL|PIOA|macro|PIOA
DECL|PIOA|macro|PIOA
DECL|PIOB_IRQn|enumerator|PIOB_IRQn = 12, /**< 12 SAM4S16B Parallel I/O Controller B (PIOB) */
DECL|PIOB|macro|PIOB
DECL|PIOB|macro|PIOB
DECL|PMC_IRQn|enumerator|PMC_IRQn = 5, /**< 5 SAM4S16B Power Management Controller (PMC) */
DECL|PMC|macro|PMC
DECL|PMC|macro|PMC
DECL|PWM_IRQn|enumerator|PWM_IRQn = 31, /**< 31 SAM4S16B Pulse Width Modulation (PWM) */
DECL|PWM|macro|PWM
DECL|PWM|macro|PWM
DECL|PendSV_IRQn|enumerator|PendSV_IRQn = -2, /**< 14 Cortex-M4 Pend SV Interrupt */
DECL|RSTC_IRQn|enumerator|RSTC_IRQn = 1, /**< 1 SAM4S16B Reset Controller (RSTC) */
DECL|RSTC|macro|RSTC
DECL|RSTC|macro|RSTC
DECL|RTC_IRQn|enumerator|RTC_IRQn = 2, /**< 2 SAM4S16B Real Time Clock (RTC) */
DECL|RTC|macro|RTC
DECL|RTC|macro|RTC
DECL|RTT_IRQn|enumerator|RTT_IRQn = 3, /**< 3 SAM4S16B Real Time Timer (RTT) */
DECL|RTT|macro|RTT
DECL|RTT|macro|RTT
DECL|SPI_IRQn|enumerator|SPI_IRQn = 21, /**< 21 SAM4S16B Serial Peripheral Interface (SPI) */
DECL|SPI|macro|SPI
DECL|SPI|macro|SPI
DECL|SSC_IRQn|enumerator|SSC_IRQn = 22, /**< 22 SAM4S16B Synchronous Serial Controller (SSC) */
DECL|SSC|macro|SSC
DECL|SSC|macro|SSC
DECL|SUPC_IRQn|enumerator|SUPC_IRQn = 0, /**< 0 SAM4S16B Supply Controller (SUPC) */
...
DECL|TC0_IRQn|enumerator|TC0_IRQn = 23, /**< 23 SAM4S16B Timer/Counter 0 (TC0) */
DECL|TC0|macro|TC0
DECL|TC0|macro|TC0
DECL|TC1_IRQn|enumerator|TC1_IRQn = 24, /**< 24 SAM4S16B Timer/Counter 1 (TC1) */
DECL|TC2_IRQn|enumerator|TC2_IRQn = 25, /**< 25 SAM4S16B Timer/Counter 2 (TC2) */
DECL|TWI0_IRQn|enumerator|TWI0_IRQn = 19, /**< 19 SAM4S16B Two Wire Interface 0 (TWI0) */
DECL|TWI0|macro|TWI0
DECL|TWI0|macro|TWI0
DECL|TWI1_IRQn|enumerator|TWI1_IRQn = 20, /**< 20 SAM4S16B Two Wire Interface 1 (TWI1) */
DECL|TWI1|macro|TWI1
DECL|TWI1|macro|TWI1
DECL|UART0_IRQn|enumerator|UART0_IRQn = 8, /**< 8 SAM4S16B UART 0 (UART0) */
DECL|UART0|macro|UART0
DECL|UART0|macro|UART0
DECL|UART1_IRQn|enumerator|UART1_IRQn = 9, /**< 9 SAM4S16B UART 1 (UART1) */
DECL|UART1|macro|UART1
DECL|UART1|macro|UART1
DECL|UDP_IRQn|enumerator|UDP_IRQn = 34, /**< 34 SAM4S16B USB Device Port (UDP) */
DECL|UDP|macro|UDP
DECL|UDP|macro|UDP
DECL|USART0_IRQn|enumerator|USART0_IRQn = 14, /**< 14 SAM4S16B USART 0 (USART0) */
DECL|USART0|macro|USART0
DECL|USART0|macro|USART0
DECL|USART1_IRQn|enumerator|USART1_IRQn = 15, /**< 15 SAM4S16B USART 1 (USART1) */
...
DECL|WDT_IRQn|enumerator|WDT_IRQn = 4, /**< 4 SAM4S16B Watchdog Timer (WDT) */
DECL|WDT|macro|WDT
DECL|WDT|macro|WDT
DECL|_DeviceVectors|struct|typedef struct _DeviceVectors
DECL|_SAM4S16B_|macro|_SAM4S16B_
