...
DECL|PWM_CH_NUM|member|PwmCh_num PWM_CH_NUM[PWMCH_NUM_NUMBER]; /**< \brief (Pwm Offset: 0x200) ch_num = 0 .. 3 */
...
DECL|PWM_FPE|member|__IO uint32_t PWM_FPE; /**< \brief (Pwm Offset: 0x6C) PWM Fault Protection Enable Register */
...
DECL|PWM_WPCR|member|__O uint32_t PWM_WPCR; /**< \brief (Pwm Offset: 0xE4) PWM Write Protection Control Register */
...
DECL|PWM_WPSR|member|__I uint32_t PWM_WPSR; /**< \brief (Pwm Offset: 0xE8) PWM Write Protection Status Register */
...
DECL|_SAM4S_PWM_COMPONENT_|macro|_SAM4S_PWM_COMPONENT_
