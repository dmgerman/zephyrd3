...
DECL|SSC_IDR_ENDRX|macro|SSC_IDR_ENDRX
DECL|SSC_IDR_ENDTX|macro|SSC_IDR_ENDTX
DECL|SSC_IDR_OVRUN|macro|SSC_IDR_OVRUN
DECL|SSC_IDR_RXBUFF|macro|SSC_IDR_RXBUFF
DECL|SSC_IDR_RXRDY|macro|SSC_IDR_RXRDY
DECL|SSC_IDR_RXSYN|macro|SSC_IDR_RXSYN
DECL|SSC_IDR_TXBUFE|macro|SSC_IDR_TXBUFE
...
DECL|SSC_IER_ENDRX|macro|SSC_IER_ENDRX
DECL|SSC_IER_ENDTX|macro|SSC_IER_ENDTX
DECL|SSC_IER_OVRUN|macro|SSC_IER_OVRUN
DECL|SSC_IER_RXBUFF|macro|SSC_IER_RXBUFF
DECL|SSC_IER_RXRDY|macro|SSC_IER_RXRDY
DECL|SSC_IER_RXSYN|macro|SSC_IER_RXSYN
DECL|SSC_IER_TXBUFE|macro|SSC_IER_TXBUFE
...
DECL|SSC_IMR_ENDRX|macro|SSC_IMR_ENDRX
DECL|SSC_IMR_ENDTX|macro|SSC_IMR_ENDTX
DECL|SSC_IMR_OVRUN|macro|SSC_IMR_OVRUN
DECL|SSC_IMR_RXBUFF|macro|SSC_IMR_RXBUFF
DECL|SSC_IMR_RXRDY|macro|SSC_IMR_RXRDY
DECL|SSC_IMR_RXSYN|macro|SSC_IMR_RXSYN
DECL|SSC_IMR_TXBUFE|macro|SSC_IMR_TXBUFE
...
DECL|SSC_PTCR_RXTDIS|macro|SSC_PTCR_RXTDIS
DECL|SSC_PTCR_RXTEN|macro|SSC_PTCR_RXTEN
DECL|SSC_PTCR_TXTDIS|macro|SSC_PTCR_TXTDIS
DECL|SSC_PTCR_TXTEN|macro|SSC_PTCR_TXTEN
DECL|SSC_PTCR|member|__O uint32_t SSC_PTCR; /**< \brief (Ssc Offset: 0x120) Transfer Control Register */
DECL|SSC_PTSR_RXTEN|macro|SSC_PTSR_RXTEN
DECL|SSC_PTSR_TXTEN|macro|SSC_PTSR_TXTEN
DECL|SSC_PTSR|member|__I uint32_t SSC_PTSR; /**< \brief (Ssc Offset: 0x124) Transfer Status Register */
...
DECL|SSC_RCR_RXCTR_Msk|macro|SSC_RCR_RXCTR_Msk
DECL|SSC_RCR_RXCTR_Pos|macro|SSC_RCR_RXCTR_Pos
DECL|SSC_RCR_RXCTR|macro|SSC_RCR_RXCTR
DECL|SSC_RCR|member|__IO uint32_t SSC_RCR; /**< \brief (Ssc Offset: 0x104) Receive Counter Register */
...
DECL|SSC_RNCR_RXNCTR_Msk|macro|SSC_RNCR_RXNCTR_Msk
DECL|SSC_RNCR_RXNCTR_Pos|macro|SSC_RNCR_RXNCTR_Pos
DECL|SSC_RNCR_RXNCTR|macro|SSC_RNCR_RXNCTR
DECL|SSC_RNCR|member|__IO uint32_t SSC_RNCR; /**< \brief (Ssc Offset: 0x114) Receive Next Counter Register */
DECL|SSC_RNPR_RXNPTR_Msk|macro|SSC_RNPR_RXNPTR_Msk
DECL|SSC_RNPR_RXNPTR_Pos|macro|SSC_RNPR_RXNPTR_Pos
DECL|SSC_RNPR_RXNPTR|macro|SSC_RNPR_RXNPTR
DECL|SSC_RNPR|member|__IO uint32_t SSC_RNPR; /**< \brief (Ssc Offset: 0x110) Receive Next Pointer Register */
DECL|SSC_RPR_RXPTR_Msk|macro|SSC_RPR_RXPTR_Msk
DECL|SSC_RPR_RXPTR_Pos|macro|SSC_RPR_RXPTR_Pos
DECL|SSC_RPR_RXPTR|macro|SSC_RPR_RXPTR
DECL|SSC_RPR|member|__IO uint32_t SSC_RPR; /**< \brief (Ssc Offset: 0x100) Receive Pointer Register */
...
DECL|SSC_SR_ENDRX|macro|SSC_SR_ENDRX
DECL|SSC_SR_ENDTX|macro|SSC_SR_ENDTX
DECL|SSC_SR_OVRUN|macro|SSC_SR_OVRUN
DECL|SSC_SR_RXBUFF|macro|SSC_SR_RXBUFF
DECL|SSC_SR_RXEN|macro|SSC_SR_RXEN
DECL|SSC_SR_RXRDY|macro|SSC_SR_RXRDY
DECL|SSC_SR_RXSYN|macro|SSC_SR_RXSYN
DECL|SSC_SR_TXBUFE|macro|SSC_SR_TXBUFE
...
DECL|SSC_TCR_TXCTR_Msk|macro|SSC_TCR_TXCTR_Msk
DECL|SSC_TCR_TXCTR_Pos|macro|SSC_TCR_TXCTR_Pos
DECL|SSC_TCR_TXCTR|macro|SSC_TCR_TXCTR
DECL|SSC_TCR|member|__IO uint32_t SSC_TCR; /**< \brief (Ssc Offset: 0x10C) Transmit Counter Register */
...
DECL|SSC_TNCR_TXNCTR_Msk|macro|SSC_TNCR_TXNCTR_Msk
DECL|SSC_TNCR_TXNCTR_Pos|macro|SSC_TNCR_TXNCTR_Pos
DECL|SSC_TNCR_TXNCTR|macro|SSC_TNCR_TXNCTR
DECL|SSC_TNCR|member|__IO uint32_t SSC_TNCR; /**< \brief (Ssc Offset: 0x11C) Transmit Next Counter Register */
DECL|SSC_TNPR_TXNPTR_Msk|macro|SSC_TNPR_TXNPTR_Msk
DECL|SSC_TNPR_TXNPTR_Pos|macro|SSC_TNPR_TXNPTR_Pos
DECL|SSC_TNPR_TXNPTR|macro|SSC_TNPR_TXNPTR
DECL|SSC_TNPR|member|__IO uint32_t SSC_TNPR; /**< \brief (Ssc Offset: 0x118) Transmit Next Pointer Register */
DECL|SSC_TPR_TXPTR_Msk|macro|SSC_TPR_TXPTR_Msk
DECL|SSC_TPR_TXPTR_Pos|macro|SSC_TPR_TXPTR_Pos
DECL|SSC_TPR_TXPTR|macro|SSC_TPR_TXPTR
DECL|SSC_TPR|member|__IO uint32_t SSC_TPR; /**< \brief (Ssc Offset: 0x108) Transmit Pointer Register */
...
DECL|SSC_WPMR|member|__IO uint32_t SSC_WPMR; /**< \brief (Ssc Offset: 0xE4) Write Protection Mode Register */
...
DECL|SSC_WPSR|member|__I uint32_t SSC_WPSR; /**< \brief (Ssc Offset: 0xE8) Write Protection Status Register */
DECL|Ssc|typedef|} Ssc;
DECL|_SAM4S_SSC_COMPONENT_|macro|_SAM4S_SSC_COMPONENT_
