...
DECL|MBEDTLS_SSL_COMPRESSION_ADD|macro|MBEDTLS_SSL_COMPRESSION_ADD
DECL|MBEDTLS_SSL_COMPRESS_BUFFER_LEN|macro|MBEDTLS_SSL_COMPRESS_BUFFER_LEN
...
DECL|MBEDTLS_SSL_IN_BUFFER_LEN|macro|MBEDTLS_SSL_IN_BUFFER_LEN
DECL|MBEDTLS_SSL_IN_PAYLOAD_LEN|macro|MBEDTLS_SSL_IN_PAYLOAD_LEN
...
DECL|MBEDTLS_SSL_OUT_BUFFER_LEN|macro|MBEDTLS_SSL_OUT_BUFFER_LEN
DECL|MBEDTLS_SSL_OUT_PAYLOAD_LEN|macro|MBEDTLS_SSL_OUT_PAYLOAD_LEN
DECL|MBEDTLS_SSL_PADDING_ADD|macro|MBEDTLS_SSL_PADDING_ADD
DECL|MBEDTLS_SSL_PADDING_ADD|macro|MBEDTLS_SSL_PADDING_ADD
DECL|MBEDTLS_SSL_PAYLOAD_OVERHEAD|macro|MBEDTLS_SSL_PAYLOAD_OVERHEAD
...
DECL|MBEDTLS_TLS_EXT_ADV_CONTENT_LEN|macro|MBEDTLS_TLS_EXT_ADV_CONTENT_LEN
...
DECL|async_in_progress|member|unsigned int async_in_progress : 1; /*!< an asynchronous operation is in progress */
...
DECL|user_async_ctx|member|void *user_async_ctx;
