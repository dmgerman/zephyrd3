...
DECL|digest_func|member|void (*digest_func)( const unsigned char *input, size_t ilen,
DECL|finish_func|member|void (*finish_func)( void *ctx, unsigned char *output );
DECL|mbedtls_md_info_t|struct|struct mbedtls_md_info_t
DECL|name|member|const char * name;
DECL|process_func|member|void (*process_func)( void *ctx, const unsigned char *input );
DECL|size|member|int size;
DECL|starts_func|member|void (*starts_func)( void *ctx );
DECL|type|member|mbedtls_md_type_t type;
DECL|update_func|member|void (*update_func)( void *ctx, const unsigned char *input, size_t ilen );
