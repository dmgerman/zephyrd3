...
DECL|aes_ctx|member|mbedtls_aes_context aes_ctx; /*!< AES context */
DECL|counter|member|unsigned char counter[16]; /*!< counter (V) */
DECL|entropy_len|member|size_t entropy_len; /*!< amount of entropy grabbed on each
