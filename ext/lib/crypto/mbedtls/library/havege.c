DECL|ONE_ITERATION|macro|ONE_ITERATION
DECL|SWAP|macro|SWAP
DECL|TST1_ENTER|macro|TST1_ENTER
DECL|TST1_LEAVE|macro|TST1_LEAVE
DECL|TST2_ENTER|macro|TST2_ENTER
DECL|TST2_LEAVE|macro|TST2_LEAVE
DECL|havege_fill|function|static void havege_fill( mbedtls_havege_state *hs )
