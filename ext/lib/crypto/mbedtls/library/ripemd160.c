...
DECL|P|macro|P
DECL|S|macro|S
DECL|TESTS|macro|TESTS
DECL|mbedtls_internal_ripemd160_process|function|int mbedtls_internal_ripemd160_process( mbedtls_ripemd160_context *ctx, const unsigned char data[64] )
...
DECL|ripemd160_test_str|variable|ripemd160_test_str
