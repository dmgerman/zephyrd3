DECL|EccPointJacobi|struct|typedef struct EccPointJacobi {
DECL|EccPointJacobi|typedef|} EccPointJacobi;
DECL|EccPoint|struct|typedef struct EccPoint {
...
DECL|__TC_ECC_H__|macro|__TC_ECC_H__
DECL|x|member|uint32_t x[NUM_ECC_DIGITS];
DECL|y|member|uint32_t y[NUM_ECC_DIGITS];
