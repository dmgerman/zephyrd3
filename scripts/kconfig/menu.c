...
DECL|get_prompt_str|function|static void get_prompt_str(struct gstr *r, struct property *prop, struct list_head *head)
DECL|get_relations_str|function|struct gstr get_relations_str(struct symbol **sym_arr, struct list_head *head)
DECL|get_symbol_prop|function|static struct property *get_symbol_prop(struct symbol *sym)
DECL|get_symbol_str|function|void get_symbol_str(struct gstr *r, struct symbol *sym, struct list_head *head)
...
DECL|menu_add_visibility|function|void menu_add_visibility(struct expr *expr)
DECL|menu_check_dep|function|static struct expr *menu_check_dep(struct expr *e)
...
DECL|menu_get_ext_help|function|void menu_get_ext_help(struct menu *menu, struct gstr *help)
...
DECL|menu_has_prompt|function|bool menu_has_prompt(struct menu *menu)
DECL|menu_is_empty|function|bool menu_is_empty(struct menu *menu)
...
DECL|menu_validate_number|function|static int menu_validate_number(struct symbol *sym, struct symbol *sym2)
DECL|menu_warn|function|void menu_warn(struct menu *menu, const char *fmt, ...)
DECL|nohelp_text|variable|nohelp_text
DECL|prop_warn|function|static void prop_warn(struct property *prop, const char *fmt, ...)
DECL|rootmenu|variable|rootmenu
DECL|sym_check_prop|function|static void sym_check_prop(struct symbol *sym)
