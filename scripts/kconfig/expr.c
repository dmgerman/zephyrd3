...
DECL|expr_copy|function|struct expr *expr_copy(const struct expr *org)
...
DECL|expr_get_leftmost_symbol|function|expr_get_leftmost_symbol(const struct expr *e)
DECL|expr_gstr_print|function|void expr_gstr_print(struct expr *e, struct gstr *gs)
DECL|expr_join_and|function|static struct expr *expr_join_and(struct expr *e1, struct expr *e2)
DECL|expr_join_or|function|static struct expr *expr_join_or(struct expr *e1, struct expr *e2)
...
DECL|expr_simplify_unmet_dep|function|struct expr *expr_simplify_unmet_dep(struct expr *e1, struct expr *e2)
