...
DECL|thread_options|member|u32_t thread_options;
...
DECL|ztest_user_unit_test_setup_teardown|macro|ztest_user_unit_test_setup_teardown
DECL|ztest_user_unit_test|macro|ztest_user_unit_test
