...
DECL|test_recvfrom|function|static void test_recvfrom(int sock, struct sockaddr *addr, socklen_t *addrlen)
DECL|test_recv|function|static void test_recv(int sock)
