...
DECL|server_resource_1_get|function|static int server_resource_1_get(struct zoap_resource *resource, struct zoap_packet *request, const struct sockaddr *from)
