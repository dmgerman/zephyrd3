...
DECL|test_nbr_lookup_fail|function|static void test_nbr_lookup_fail(void)
DECL|test_nbr_lookup_ok|function|static void test_nbr_lookup_ok(void)
DECL|test_prefix_timeout_long|function|static void test_prefix_timeout_long(void)
