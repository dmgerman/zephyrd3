...
DECL|dest_addresses|variable|dest_addresses
...
DECL|populate_nbr_cache|function|static void populate_nbr_cache(void)
DECL|recipient|variable|recipient
DECL|route_add_many|function|static void route_add_many(void)
DECL|route_add|function|static void route_add(void)
DECL|route_del_again|function|static void route_del_again(void)
DECL|route_del_many|function|static void route_del_many(void)
DECL|route_del_nexthop_again|function|static void route_del_nexthop_again(void)
DECL|route_del_nexthop|function|static void route_del_nexthop(void)
DECL|route_del|function|static void route_del(void)
DECL|route_get_nexthop|function|static void route_get_nexthop(void)
DECL|route_lookup_fail|function|static void route_lookup_fail(void)
DECL|route_lookup_ok|function|static void route_lookup_ok(void)
DECL|route_update|function|static void route_update(void)
