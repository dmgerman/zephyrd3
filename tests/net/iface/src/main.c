...
DECL|check_promisc_mode_off|function|static void check_promisc_mode_off(void)
DECL|check_promisc_mode_on|function|static void check_promisc_mode_on(void)
...
DECL|iface3|variable|iface3
DECL|iface4|variable|iface4
...
DECL|net_iface3_data|variable|net_iface3_data
