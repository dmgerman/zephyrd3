...
DECL|fake_set_channel|function|static int fake_set_channel(struct device *dev, uint16_t channel)
DECL|fake_set_ieee_addr|function|static int fake_set_ieee_addr(struct device *dev, const uint8_t *ieee_addr)
DECL|fake_set_pan_id|function|static int fake_set_pan_id(struct device *dev, uint16_t pan_id)
DECL|fake_set_short_addr|function|static int fake_set_short_addr(struct device *dev, uint16_t short_addr)
