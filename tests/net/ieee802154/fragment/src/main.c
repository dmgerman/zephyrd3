...
DECL|net_fragment_data|struct|struct net_fragment_data {
DECL|net_fragment_dev_init|function|int net_fragment_dev_init(struct device *dev)
DECL|net_fragment_if_api|variable|net_fragment_if_api
DECL|net_fragment_iface_init|function|static void net_fragment_iface_init(struct net_if *iface)
