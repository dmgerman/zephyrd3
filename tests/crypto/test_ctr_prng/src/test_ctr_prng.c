...
DECL|test_prng_vector|function|int test_prng_vector(struct prng_vector *v)
DECL|test_reseed|function|int test_reseed(void)
DECL|test_robustness|function|int test_robustness(void)
DECL|test_uninstantiate|function|int test_uninstantiate(void)
