...
DECL|fsutil_read_file|function|int fsutil_read_file(const char *path, off_t offset, size_t len, void *dst, size_t *out_len)
DECL|fsutil_write_file|function|int fsutil_write_file(const char *path, const void *data, size_t len)
DECL|settings_test_file_strstr|function|int settings_test_file_strstr(const char *fname, char *string)
