...
DECL|nffs_test_util_create_file_blocks|function|void nffs_test_util_create_file_blocks(const char *filename, const struct nffs_test_block_desc *blks, int num_blocks)
