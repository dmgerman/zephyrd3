DECL|ALIGN_MS_BOUNDARY|macro|ALIGN_MS_BOUNDARY
DECL|ALIGN_MS_BOUNDARY|macro|ALIGN_MS_BOUNDARY
DECL|CONFIG_TICKLESS_IDLE_THRESH|macro|CONFIG_TICKLESS_IDLE_THRESH
DECL|MSEC_PER_TICK|macro|MSEC_PER_TICK
DECL|NUM_THREAD|macro|NUM_THREAD
DECL|SLEEP_TICKFUL|macro|SLEEP_TICKFUL
DECL|SLEEP_TICKLESS|macro|SLEEP_TICKLESS
