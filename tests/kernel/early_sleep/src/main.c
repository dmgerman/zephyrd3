DECL|TEST_TICKS_TO_SLEEP|macro|TEST_TICKS_TO_SLEEP
DECL|THREAD_STACK|macro|THREAD_STACK
DECL|actual_app_sleep_ticks|variable|actual_app_sleep_ticks
DECL|actual_post_kernel_sleep_ticks|variable|actual_post_kernel_sleep_ticks
DECL|actual_sleep_ticks|variable|actual_sleep_ticks
DECL|helper_tdata|variable|helper_tdata
DECL|helper_thread|function|static void helper_thread(void *p1, void *p2, void *p3)
