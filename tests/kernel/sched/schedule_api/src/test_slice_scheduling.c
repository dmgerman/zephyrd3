DECL|BASE_PRIORITY|macro|BASE_PRIORITY
DECL|BUSY_MS|macro|BUSY_MS
DECL|ITRERATION_COUNT|macro|ITRERATION_COUNT
...
DECL|test_slice_scheduling|function|void test_slice_scheduling(void)
