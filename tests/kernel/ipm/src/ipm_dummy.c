...
DECL|ipm_dummy_max_id_val_get|function|static u32_t ipm_dummy_max_id_val_get(struct device *d)
...
DECL|ipm_dummy_send|function|static int ipm_dummy_send(struct device *d, int wait, u32_t id, const void *data, int size)
