...
DECL|thread_body|function|void thread_body(void)
DECL|umode_enter_func|function|static void umode_enter_func(void)
DECL|user_mode_enter|function|static void user_mode_enter(void)
DECL|uthread_body|function|static void uthread_body(void)
